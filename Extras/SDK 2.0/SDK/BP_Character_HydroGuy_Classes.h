...
namespace CG
{
	 ...
	 * Size -> 0x014A (FullSize[0x06D0] - InheritedSize[0x0586])
	 */
	class ABP_Character_HydroGuy_C : public ABP_GameCharacter_C
	{
	public:
		unsigned char                                              UnknownData_5C7K[0x2];                                   // 0x0586(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_1VZK[0x4];                                   // 0x0644(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SRWE[0x4];                                   // 0x069C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_DHQJ[0x4];                                   // 0x06B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
