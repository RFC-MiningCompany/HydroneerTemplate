...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_ConstructionHammer.BP_ConstructionHammer_C.LMBDownWhileCarrying
	 */
	struct ABP_ConstructionHammer_C_LMBDownWhileCarrying_Params
	{
	public:
	...
	/**
	 * Function BP_ConstructionHammer.BP_ConstructionHammer_C.ExecuteUbergraph_BP_ConstructionHammer
	 */
	struct ABP_ConstructionHammer_C_ExecuteUbergraph_BP_ConstructionHammer_Params
	{
	public:
