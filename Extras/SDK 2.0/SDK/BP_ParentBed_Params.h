...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_ParentBed.BP_ParentBed_C.FadeEyesOut
	 */
	struct ABP_ParentBed_C_FadeEyesOut_Params
	{
	};

	/**
	 * Function BP_ParentBed.BP_ParentBed_C.Deactivated
	 */
	struct ABP_ParentBed_C_Deactivated_Params
	{
	public:
	...
	/**
	 * Function BP_ParentBed.BP_ParentBed_C.LMBDownIsTarget
	 */
	struct ABP_ParentBed_C_LMBDownIsTarget_Params
	{
	public:
	...
	/**
	 * Function BP_ParentBed.BP_ParentBed_C.ExecuteUbergraph_BP_ParentBed
	 */
	struct ABP_ParentBed_C_ExecuteUbergraph_BP_ParentBed_Params
	{
	public:
