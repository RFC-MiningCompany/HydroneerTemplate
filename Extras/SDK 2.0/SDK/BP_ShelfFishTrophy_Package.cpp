...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BP_ShelfFishTrophy.BP_ShelfFishTrophy_C.UserConstructionScript");
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_ShelfFishTrophy.BP_ShelfFishTrophy_C");
		return ptr;
	}
