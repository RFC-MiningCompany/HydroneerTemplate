...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_0FOF[0x90];                                  // 0x0000(0x0090) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_2BSP[0x68];                                  // 0x0000(0x0068) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_BRRT[0x30];                                  // 0x0000(0x0030) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_RCF9[0x38];                                  // 0x0000(0x0038) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_TO6F[0x28];                                  // 0x0000(0x0028) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_KTQK[0x80];                                  // 0x0000(0x0080) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_FEH2[0x20];                                  // 0x0000(0x0020) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_761L[0x50];                                  // 0x0000(0x0050) MISSED OFFSET (PADDING)
	};
