...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_PTEJ[0x7];                                   // 0x0349(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_BP_BlacksmithHammer(int32_t EntryPoint);
