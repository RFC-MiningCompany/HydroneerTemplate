...
namespace CG
{
	...
	void ABP_HydroTruck_C::CB_StorageDetach()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HydroTruck.BP_HydroTruck_C.CB_StorageDetach");
	...
	void ABP_HydroTruck_C::CB_StorageAttach()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HydroTruck.BP_HydroTruck_C.CB_StorageAttach");
	...
	void ABP_HydroTruck_C::ItemDetachedFromStorage()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HydroTruck.BP_HydroTruck_C.ItemDetachedFromStorage");
	...
	void ABP_HydroTruck_C::ItemAttachedToStorage()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_HydroTruck.BP_HydroTruck_C.ItemAttachedToStorage");
