...
namespace CG
{
	...
	public:
		...
		Engine_ETimelineDirection                                  Timeline_1__Direction_57A53BA042C5E263D5C22CBF1D8B8EAA;  // 0x03BC(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_4ORT[0x3];                                   // 0x03BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		Engine_ETimelineDirection                                  Timeline_0__Direction_D9E9CE0D445A7192AE7F4A820EFDA114;  // 0x03CC(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_246B[0x3];                                   // 0x03CD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
