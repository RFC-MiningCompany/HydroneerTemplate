...
namespace CG
{
	...
	public:
		...
		Engine_ETimelineDirection                                  Timeline_1__Direction_94E748E74C0F968A13398B83E95E002C;  // 0x0414(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_2FF9[0x3];                                   // 0x0415(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		Engine_ETimelineDirection                                  Timeline_0__Direction_09EEB7DC4D40DA927DF839A36F849DCE;  // 0x0424(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_DA65[0x3];                                   // 0x0425(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		E_MetalType_E_MetalType                                    CurrentLiquidType;                                       // 0x0430(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, SaveGame, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_QLZU[0x3];                                   // 0x0431(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		E_LogicSmelterStages_E_LogicSmelterStages                  SmelterStage;                                            // 0x0448(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_QJ20[0x7];                                   // 0x0449(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void SetNewLiquidType(E_MetalType_E_MetalType InputPin);
		void FindLiquidClass(class ABP_ParentResource_C* NewParam, E_MetalType_E_MetalType* Type);
