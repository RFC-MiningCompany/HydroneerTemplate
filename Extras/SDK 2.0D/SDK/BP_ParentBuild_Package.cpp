...
namespace CG
{
	 ...
	 * 		struct FVector                                     HitLocation                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABP_ParentBuild_C::LMBDownWhileCarrying(class ABP_GameController_C* Controller, class AActor* HitActor, const struct FVector& HitLocation)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * Function:
	 * 		Offset -> 0x00000000
	 * 		Name   -> Function BP_ParentBuild.BP_ParentBuild_C.ActorLoaded
	 * 		Flags  -> ()
	 */
	void ABP_ParentBuild_C::ActorLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_ParentBuild.BP_ParentBuild_C.ActorLoaded");
