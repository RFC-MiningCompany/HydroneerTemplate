...
namespace CG
{
	 ...
	 * Size -> 0x03F8 (FullSize[0x0678] - InheritedSize[0x0280])
	 */
	...
	public:
		...
		class UStaticMeshComponent*                                Step;                                                    // 0x0288(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
		class UBoxComponent*                                       RefuelBox;                                               // 0x0290(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
		class UAC_Highlight_C*                                     AC_Highlight;                                            // 0x0298(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
		...
		Engine_ETimelineDirection                                  Fuel_Light_Bleep__Direction_04ADEAC54F4882E7F34D7C91084AF6BB; // 0x039C(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_RXFS[0x3];                                   // 0x039D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		Engine_ETimelineDirection                                  CamTransition__Direction_B2F62E0F484C3C136FDFBBA19151F19B; // 0x03AC(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_GYV2[0x3];                                   // 0x03AD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		Engine_ETimelineDirection                                  BlendFuelSFX__Direction_18BDD7304D1E08455C822E9595B17EF8; // 0x03BC(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_BX9O[0x3];                                   // 0x03BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		Engine_ETimelineDirection                                  TurnOnHeadlights__Direction_30864BD34CB7D4A5FAC9B0886E0EB265; // 0x03D0(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_ZZ8N[0x7];                                   // 0x03D1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_B111[0x3];                                   // 0x04B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_QM3O[0x2];                                   // 0x04C2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_GJCQ[0x3];                                   // 0x04CD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Y41P[0x3];                                   // 0x04D9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_4C1K[0x1];                                   // 0x04E3(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Y9HB[0x7];                                   // 0x04E9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TMap<class UPrimitiveComponent*, Engine_ECollisionEnabled> PawnCollisionComponents;                                 // 0x04F0(0x0050) Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference
		...
		TMap<E_CargoType_E_CargoType, int32_t>                     DefaultCargoPoints;                                      // 0x05E0(0x0050) Edit, BlueprintVisible, DisableEditOnInstance
		TArray<E_CargoType_E_CargoType>                            CurrentCargo;                                            // 0x0630(0x0010) Edit, BlueprintVisible, DisableEditOnInstance
		...
		unsigned char                                              UnknownData_OZNS[0x3];                                   // 0x0649(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void RemoveCargo(E_CargoType_E_CargoType Cargo_Type, int32_t Amount);
		void AddCargo(E_CargoType_E_CargoType Cargo_Type, int32_t Amount);
		void OnLand();
		...
		void BndEvt__BP_ParentVehicle_AC_Highlight_K2Node_ComponentBoundEvent_0_OnHighlighted__DelegateSignature(class ABP_GameController_C* Controller);
		void BndEvt__BP_ParentVehicle_AC_Highlight_K2Node_ComponentBoundEvent_1_OnUnhighlighted__DelegateSignature(class ABP_GameController_C* Controller);
