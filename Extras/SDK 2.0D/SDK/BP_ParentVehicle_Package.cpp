...
namespace CG
{
	...
	void ABP_ParentVehicle_C::InpAxisEvt_MoveForward_K2Node_InputAxisEvent_1(float AxisValue)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_ParentVehicle.BP_ParentVehicle_C.InpAxisEvt_MoveForward_K2Node_InputAxisEvent_1");
	 ...
	 * Function:
	 * 		Offset -> 0x00000000
	 * 		Name   -> Function BP_ParentVehicle.BP_ParentVehicle_C.BndEvt__BP_ParentVehicle_AC_Highlight_K2Node_ComponentBoundEvent_0_OnHighlighted__DelegateSignature
	 * 		Flags  -> ()
	 * Parameters:
	 * 		class ABP_GameController_C*                        Controller                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABP_ParentVehicle_C::BndEvt__BP_ParentVehicle_AC_Highlight_K2Node_ComponentBoundEvent_0_OnHighlighted__DelegateSignature(class ABP_GameController_C* Controller)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_ParentVehicle.BP_ParentVehicle_C.BndEvt__BP_ParentVehicle_AC_Highlight_K2Node_ComponentBoundEvent_0_OnHighlighted__DelegateSignature");
	 ...
	 * Function:
	 * 		Offset -> 0x00000000
	 * 		Name   -> Function BP_ParentVehicle.BP_ParentVehicle_C.BndEvt__BP_ParentVehicle_AC_Highlight_K2Node_ComponentBoundEvent_1_OnUnhighlighted__DelegateSignature
	 * 		Flags  -> ()
	 * Parameters:
	 * 		class ABP_GameController_C*                        Controller                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABP_ParentVehicle_C::BndEvt__BP_ParentVehicle_AC_Highlight_K2Node_ComponentBoundEvent_1_OnUnhighlighted__DelegateSignature(class ABP_GameController_C* Controller)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function BP_ParentVehicle.BP_ParentVehicle_C.BndEvt__BP_ParentVehicle_AC_Highlight_K2Node_ComponentBoundEvent_1_OnUnhighlighted__DelegateSignature");
