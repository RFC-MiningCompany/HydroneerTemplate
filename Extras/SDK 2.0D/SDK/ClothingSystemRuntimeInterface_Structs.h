...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_FTL0[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_JAVR[0x4];                                   // 0x0024(0x0004) MISSED OFFSET (PADDING)
