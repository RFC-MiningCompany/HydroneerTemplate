...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_1JWV[0x90];                                  // 0x0000(0x0090) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_2KCY[0x68];                                  // 0x0000(0x0068) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_RV9O[0x30];                                  // 0x0000(0x0030) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_A444[0x38];                                  // 0x0000(0x0038) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_PKKI[0x28];                                  // 0x0000(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_LHLF[0x80];                                  // 0x0000(0x0080) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_Z448[0x20];                                  // 0x0000(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_DS6C[0x50];                                  // 0x0000(0x0050) MISSED OFFSET (PADDING)
