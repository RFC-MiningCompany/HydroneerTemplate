...
namespace CG
{
	...
	public:
		...
		void SetTrackingOrigin(HeadMountedDisplay_EHMDTrackingOrigin Origin);
		...
		void ResetOrientationAndPosition(float Yaw, HeadMountedDisplay_EOrientPositionSelector Options);
		...
		HeadMountedDisplay_EHMDTrackingOrigin GetTrackingOrigin();
		...
		HeadMountedDisplay_EHMDWornState GetHMDWornState();
		...
		TArray<struct FXRDeviceId> EnumerateTrackedDevices(const class FName& SystemId, HeadMountedDisplay_EXRTrackedDeviceType DeviceType);
		void EnableLowPersistenceMode(bool bEnable);
		bool EnableHMD(bool bEnable);
		void DisconnectRemoteXRDevice();
		HeadMountedDisplay_EXRDeviceConnectionResult ConnectRemoteXRDevice(const class FString& Ipaddress, int32_t BitRate);
	...
	public:
		...
		unsigned char                                              UnknownData_OQ7Q[0x3];                                   // 0x0445(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_I9US[0x3];                                   // 0x0451(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_GGHQ[0x2];                                   // 0x0456(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Z2B6[0x68];                                  // 0x0478(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_AKM7[0x18];                                  // 0x04E8(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		bool IsMotionTrackingEnabledForDevice(int32_t PlayerIndex, InputCore_EControllerHand Hand);
		...
		bool EnableMotionTrackingOfDevice(int32_t PlayerIndex, InputCore_EControllerHand Hand);
		...
		void DisableMotionTrackingOfDevice(int32_t PlayerIndex, InputCore_EControllerHand Hand);
	...
	public:
		...
		unsigned char                                              UnknownData_D7XM[0x8];                                   // 0x0050(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
