...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_DJ50[0x7];                                   // 0x0059(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		void IsFileReadOnly(const class FString& File, LowEntryFileManager_ELowEntryFileManagerYesNo* Branch);
		bool IsFileEmptyBool(const class FString& File);
		void IsFileEmpty(const class FString& File, LowEntryFileManager_ELowEntryFileManagerYesNo* Branch);
		bool IsDirectoryEmptyBool(const class FString& Directory);
		void IsDirectoryEmpty(const class FString& Directory, LowEntryFileManager_ELowEntryFileManagerYesNo* Branch);
		bool HasDiskPathsBool();
		void HasDiskPaths(LowEntryFileManager_ELowEntryFileManagerYesNo* Branch);
		...
		void FileExists(const class FString& File, LowEntryFileManager_ELowEntryFileManagerYesNo* Branch);
		...
		void DirectoryExists(const class FString& Directory, LowEntryFileManager_ELowEntryFileManagerYesNo* Branch);
