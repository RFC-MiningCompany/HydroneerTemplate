...
namespace CG
{
	 ...
	 * Size -> 0x01B0 (FullSize[0x03B0] - InheritedSize[0x0200])
	 */
	...
	public:
		...
		unsigned char                                              UnknownData_ER6I[0x2];                                   // 0x020E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SSJH[0xF0];                                  // 0x02C0(0x00F0) MISSED OFFSET (PADDING)
	...
	public:
		...
		MagicLeapARPin_EMagicLeapPassableWorldError SetGlobalQueryFilter(const struct FMagicLeapARPinQuery& InGlobalFilter);
		void SetContentBindingSaveGameUserIndex(int32_t UserIndex);
		MagicLeapARPin_EMagicLeapPassableWorldError QueryARPins(const struct FMagicLeapARPinQuery& Query, TArray<struct FGuid>* Pins);
		bool ParseStringToARPinId(const class FString& PinIdString, struct FGuid* ARPinId);
		bool IsTrackerValid();
		MagicLeapARPin_EMagicLeapPassableWorldError GetNumAvailableARPins(int32_t* Count);
		MagicLeapARPin_EMagicLeapPassableWorldError GetGlobalQueryFilter(struct FMagicLeapARPinQuery* CurrentGlobalFilter);
		int32_t GetContentBindingSaveGameUserIndex();
		MagicLeapARPin_EMagicLeapPassableWorldError GetClosestARPin(const struct FVector& SearchPoint, struct FGuid* PinId);
		MagicLeapARPin_EMagicLeapPassableWorldError GetAvailableARPins(int32_t NumRequested, TArray<struct FGuid>* Pins);
		class FString GetARPinStateToString(const struct FMagicLeapARPinState& State);
		MagicLeapARPin_EMagicLeapPassableWorldError GetARPinState(const struct FGuid& PinId, struct FMagicLeapARPinState* State);
		...
		MagicLeapARPin_EMagicLeapPassableWorldError DestroyTracker();
		MagicLeapARPin_EMagicLeapPassableWorldError CreateTracker();
	...
	public:
		...
		unsigned char                                              UnknownData_KAFL[0x7];                                   // 0x0231(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_5T4F[0x7];                                   // 0x0221(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TMap<struct FGuid, class AMagicLeapARPinInfoActorBase*>    AllInfoActors;                                           // 0x0228(0x0050) NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_W5T2[0x8];                                   // 0x0278(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_1FOY[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_43OD[0xF];                                   // 0x00A1(0x000F) MISSED OFFSET (PADDING)
