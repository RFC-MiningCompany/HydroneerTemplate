...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_3KPF[0x3];                                   // 0x001D(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_K76O[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_HZ7G[0x4];                                   // 0x009C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_SIA7[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_9N1M[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8XBP[0x4];                                   // 0x002C(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_FQ3A[0x18];                                  // 0x00C8(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_YIJJ[0x10];                                  // 0x0760(0x0010) MISSED OFFSET (PADDING)
