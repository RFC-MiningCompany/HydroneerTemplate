...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_PPJU[0x18];                                  // 0x0030(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_RHTR[0x18];                                  // 0x0040(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_RTED[0x6];                                   // 0x0042(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JBKB[0x4];                                   // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_75PS[0x7];                                   // 0x0071(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		void FindJsonStrings(const class FString& JsonString, const class FString& Key, TArray<class FString>* Values, SteamCoreWeb_ESteamJsonResult* Result);
		void FindJsonString(const class FString& JsonString, const class FString& Key, class FString* Value, SteamCoreWeb_ESteamJsonResult* Result);
		void FindJsonNumbers(const class FString& JsonString, const class FString& Key, TArray<int32_t>* Values, SteamCoreWeb_ESteamJsonResult* Result);
		void FindJsonNumber(const class FString& JsonString, const class FString& Key, int32_t* Value, SteamCoreWeb_ESteamJsonResult* Result);
		void FindJsonBools(const class FString& JsonString, const class FString& Key, TArray<bool>* bValues, SteamCoreWeb_ESteamJsonResult* Result);
		void FindJsonBool(const class FString& JsonString, const class FString& Key, bool* bValue, SteamCoreWeb_ESteamJsonResult* Result);
		static UClass* StaticClass();
	};
	...
	public:
		...
		void CreateLobby(const class FScriptDelegate& Callback, const class FString& Key, int32_t AppID, int32_t MaxMembers, SteamCoreWeb_ESteamCoreWebLobbyType LobbyType, const class FString& LobbyName, const class FString& InputJson, TArray<class FString> SteamIdInvitedMembers, const class FString& LobbyMetaData);
		static UClass* StaticClass();
	};
	...
	{
	public:
		void ResolveVanityURL(const class FScriptDelegate& Callback, const class FString& Key, const class FString& VanityURL, SteamCoreWeb_EVanityUrlType URLType);
	...
	{
	public:
		class USteamCoreWebAsyncActionResolveVanityURL* ResolveVanityURLAsync(class UObject* WorldContextObject, const class FString& Key, const class FString& VanityURL, SteamCoreWeb_EVanityUrlType URLType);
		static UClass* StaticClass();
	};
