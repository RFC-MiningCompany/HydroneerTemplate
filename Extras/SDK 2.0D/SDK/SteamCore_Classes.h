...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_D70M[0x18];                                  // 0x0030(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_8PXD[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_VEYG[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_VX12[0x4];                                   // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_4B3Q[0x1E0];                                 // 0x0138(0x01E0) MISSED OFFSET (PADDING)
	...
	public:
		...
		bool HasFriend(const struct FSteamID& SteamIDFriend, TArray<SteamCore_ESteamFriendFlags> Flags);
		TArray<SteamCore_ESteamUserRestriction> GetUserRestrictions();
		...
		SteamCore_ESteamPersonaState GetPersonaState_Pure();
		SteamCore_ESteamPersonaState GetPersonaState();
		...
		SteamCore_ESteamFriendRelationship GetFriendRelationship(const struct FSteamID& SteamIDFriend);
		SteamCore_ESteamPersonaState GetFriendPersonaState(const struct FSteamID& SteamIDFriend);
		...
		int32_t GetFriendMessage(const struct FSteamID& SteamIDFriend, int32_t MessageID, class FString* Text, SteamCore_ESteamChatEntryType* ChatEntryType);
		...
		int32_t GetFriendCount(TArray<SteamCore_ESteamFriendFlags> Flags);
		...
		struct FSteamID GetFriendByIndex(int32_t Ifriend, TArray<SteamCore_ESteamFriendFlags> Flags);
		...
		int32_t GetClanChatMessage(const struct FSteamID& SteamIDClanChat, int32_t MessageID, class FString* Text, SteamCore_ESteamChatEntryType* ChatEntryType, struct FSteamID* SteamIDChatter);
		...
		void ActivateGameOverlayToWebPage(const class FString& URL, SteamCore_ESteamActivateGameOverlayToWebPageMode Mode);
		void ActivateGameOverlayToUser(const class FString& Dialog, const struct FSteamID& SteamID);
		void ActivateGameOverlayToStore(int32_t AppID, SteamCore_ESteamOverlayToStoreFlag Flag);
	...
	public:
		class FScriptMulticastDelegate                             OnCallback;                                              // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_G2S1[0x30];                                  // 0x0048(0x0030) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_2LTV[0xE0];                                  // 0x00B8(0x00E0) MISSED OFFSET (PADDING)

	public:
		SteamCore_ESteamGameSearchErrorCode SubmitPlayerResult(const class FString& UniqueGameID, const struct FSteamID& SteamIDPlayer, SteamCore_ESteamPlayerResult PlayerResult);
		SteamCore_ESteamGameSearchErrorCode SetGameHostParams(const class FString& Key, TArray<class FString> Values);
		SteamCore_ESteamGameSearchErrorCode SetConnectionDetails(const class FString& ConnectionDetails);
		SteamCore_ESteamGameSearchErrorCode SearchForGameWithLobby(const struct FSteamID& SteamIDLobby, int32_t PlayerMin, int32_t PlayerMax);
		SteamCore_ESteamGameSearchErrorCode SearchForGameSolo(int32_t PlayerMin, int32_t PlayerMax);
		SteamCore_ESteamGameSearchErrorCode RetrieveConnectionDetails(const struct FSteamID& SteamIDHost, class FString* ConnectionDetails, int32_t NumConnectionDetails);
		SteamCore_ESteamGameSearchErrorCode RequestPlayersForGame(int32_t PlayerMin, int32_t PlayerMax, int32_t MaxTeamSize);
		SteamCore_ESteamGameSearchErrorCode HostConfirmGameStart(const class FString& UniqueGameID);
		SteamCore_ESteamGameSearchErrorCode EndGameSearch();
		SteamCore_ESteamGameSearchErrorCode EndGame(const class FString& UniqueGameID);
		SteamCore_ESteamGameSearchErrorCode DeclineGame();
		SteamCore_ESteamGameSearchErrorCode CancelRequestPlayersForGame();
		SteamCore_ESteamGameSearchErrorCode AddGameSearchParams(const class FString& KeyToFind, TArray<class FString> ValuesToFind);
	...
	public:
		...
		unsigned char                                              UnknownData_4YES[0xA0];                                  // 0x0098(0x00A0) MISSED OFFSET (PADDING)

	public:
		bool WasRestartRequested();
		SteamCore_ESteamUserHasLicenseForAppResult UserHasLicenseForApp(const struct FSteamID& SteamID, int32_t AppID);
	...
	public:
		...
		unsigned char                                              UnknownData_D1NB[0x20];                                  // 0x0058(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		...
		bool Init();
		class FString GetStringForXboxOrigin(SteamCore_ESteamCoreXboxOrigin Origin);
		class FString GetStringForActionOrigin(SteamCore_ESteamCoreInputActionOrigin Origin);
		...
		class FString GetGlyphForXboxOrigin(SteamCore_ESteamCoreXboxOrigin Origin);
		class FString GetGlyphForActionOrigin(SteamCore_ESteamCoreInputActionOrigin Origin);
		int32_t GetGamepadIndexForController(const struct FInputHandle& Handle);
		int32_t GetDigitalActionOrigins(const struct FInputHandle& Handle, const struct FInputActionSetHandle& ActionSetHandle, const struct FInputDigitalActionHandle& DigitalActionHandle, TArray<SteamCore_ESteamCoreInputActionOrigin>* OriginsOut);
		...
		int32_t GetAnalogActionOrigins(const struct FInputHandle& Handle, const struct FInputActionSetHandle& ActionSetHandle, const struct FInputAnalogActionHandle& AnalogActionHandle, TArray<SteamCore_ESteamCoreInputActionOrigin>* OriginsOut);
	...
	public:
		...
		unsigned char                                              UnknownData_TIRA[0xC0];                                  // 0x00A8(0x00C0) MISSED OFFSET (PADDING)
	...
	public:
		...
		SteamCore_ESteamResult GetResultStatus(const struct FSteamInventoryResult& Handle);
	...
	public:
		...
		unsigned char                                              UnknownData_CZQ3[0x120];                                 // 0x00D8(0x0120) MISSED OFFSET (PADDING)

	public:
		bool SetLobbyType(const struct FSteamID& SteamIDLobby, SteamCore_ESteamLobbyType LobbyType);
		...
		bool RemoveFavoriteGame(int32_t AppID, const class FString& IP, int32_t ConnectionPort, int32_t QueryPort, TArray<SteamCore_ESteamFavoriteFlags> Flags);
		...
		int32_t GetLobbyChatEntry(const struct FSteamID& SteamIDLobby, int32_t MessageID, struct FSteamID* SteamIDUser, class FString* Message, SteamCore_ESteamChatEntryType* ChatEntryType);
		struct FSteamID GetLobbyByIndex(int32_t Lobby);
		int32_t GetFavoriteGameCount();
		bool GetFavoriteGame(int32_t Game, int32_t* AppID, class FString* IP, int32_t* ConnectionPort, int32_t* QueryPort, TArray<SteamCore_ESteamFavoriteFlags>* Flags, int32_t* TimeLastPlayedOnServer);
		bool DeleteLobbyData(const struct FSteamID& SteamIDLobby, const class FString& Key);
		void CreateLobby(const class FScriptDelegate& Callback, SteamCore_ESteamLobbyType LobbyType, int32_t MaxMembers);
		void AddRequestLobbyListStringFilter(const class FString& KeyToMatch, const class FString& ValueToMatch, SteamCore_ESteamLobbyComparison ComparisonType);
		void AddRequestLobbyListResultCountFilter(int32_t MaxResults);
		void AddRequestLobbyListNumericalFilter(const class FString& KeyToMatch, int32_t ValueToMatch, SteamCore_ESteamLobbyComparison ComparisonType);
		...
		void AddRequestLobbyListDistanceFilter(SteamCore_ESteamLobbyDistanceFilter LobbyDistanceFilter);
		void AddRequestLobbyListCompatibleMembersFilter(const struct FSteamID& SteamIDLobby);
		int32_t AddFavoriteGame(int32_t AppID, const class FString& IP, int32_t ConnectionPort, int32_t QueryPort, TArray<SteamCore_ESteamFavoriteFlags> Flags, int32_t TimeLastPlayedOnServer);
		static UClass* StaticClass();
	};
	...
	public:
		...
		class USteamCoreMatchmakingAsyncActionCreateLobby* CreateLobbyAsync(class UObject* WorldContextObject, SteamCore_ESteamLobbyType LobbyType, int32_t MaxMembers, float Timeout);
		static UClass* StaticClass();
	};
	...
	public:
		...
		unsigned char                                              UnknownData_1CRI[0xE8];                                  // 0x0058(0x00E8) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnCallback;                                              // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_GC7D[0x90];                                  // 0x0048(0x0090) MISSED OFFSET (PADDING)

	public:
		void OnCompleted(bool bSuccessful);
		class USteamCoreFindSession* FindSteamCoreSessions(class UObject* WorldContextObject, TMap<class FString, struct FSteamSessionSearchSetting> SearchSettings, int32_t MaxResults, bool bUseLAN, SteamCore_ESteamSessionFindType ServerType, bool bEmptyServersOnly, bool bSecureServersOnly, float Timeout);
		static UClass* StaticClass();
	};
	...
	public:
		class FScriptMulticastDelegate                             OnSuccess;                                               // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		class FScriptMulticastDelegate                             OnFailure;                                               // 0x0048(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_2IOJ[0x20];                                  // 0x0058(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnCallback;                                              // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_6NNZ[0xE0];                                  // 0x0048(0x00E0) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_UUB2[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_C8P5[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_9K72[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)

	public:
		bool SendP2PPacket(const struct FSteamID& SteamIDRemote, TArray<unsigned char> Data, SteamCore_ESteamP2PSend P2PSendType, int32_t Channel);
	...
	public:
		...
		unsigned char                                              UnknownData_JZI7[0xC0];                                  // 0x00A8(0x00C0) MISSED OFFSET (PADDING)
	...
	public:
		...
		bool GetBeaconLocationData(const struct FSteamPartyBeaconLocation& BeaconLocation, SteamCore_ESteamPartiesBeaconLocationData EData, class FString* PCHDataStringOut);
	...
	public:
		...
		unsigned char                                              UnknownData_LSEK[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		SteamCore_ESteamCoreDeviceFormFactor GetSessionClientFormFactor(int32_t SessionID);
	...
	public:
		...
		unsigned char                                              UnknownData_77Z7[0x80];                                  // 0x0088(0x0080) MISSED OFFSET (PADDING)

	public:
		int32_t UGCRead(const struct FSteamUGCHandle& Content, TArray<unsigned char>* OutData, int32_t DataToRead, int32_t Offset, SteamCore_ESteamUGCReadAction Action);
		...
		bool SetSyncPlatforms(const class FString& File, SteamCore_ESteamRemoteStoragePlatform RemoteStoragePlatform);
		...
		SteamCore_ESteamRemoteStoragePlatform GetSyncPlatforms(const class FString& File);
	...
	public:
		...
		unsigned char                                              UnknownData_MX8U[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		struct FScreenshotHandle AddVRScreenshotToLibrary(SteamCore_ESteamVRScreenshotType EType, const class FString& Filename, const class FString& VRFileName);
	...
	public:
		...
		unsigned char                                              UnknownData_S691[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		bool SetItemVisibility(const struct FUGCUpdateHandle& Handle, SteamCore_ESteamRemoteStoragePublishedFileVisibility Visibility);
		...
		bool GetQueryUGCStatistic(const struct FUGCQueryHandle& Handle, int32_t Index, SteamCore_ESteamItemStatistic StatType, class FString* StatValue);
		...
		bool GetQueryUGCAdditionalPreview(const struct FUGCQueryHandle& Handle, int32_t Index, int32_t PreviewIndex, class FString* URLOrVideoID, class FString* OriginalFileName, SteamCore_ESteamItemPreviewType* PreviewType);
		int32_t GetNumSubscribedItems();
		SteamCore_ESteamItemUpdateStatus GetItemUpdateProgress(const struct FUGCUpdateHandle& Handle, int32_t* BytesProcessed, int32_t* BytesTotal);
		int32_t GetItemState(const struct FPublishedFileID& PublishedFileID, TArray<SteamCore_ESteamItemState>* States);
		...
		struct FUGCQueryHandle CreateQueryUserUGCRequest(const struct FSteamID& SteamID, SteamCore_ESteamUserUGCList ListType, SteamCore_ESteamUGCMatchingUGCType MatchingUGCType, SteamCore_ESteamUserUGCListSortOrder SortOrder, int32_t CreatorAppID, int32_t ConsumerAppID, int32_t Page);
		struct FUGCQueryHandle CreateQueryUGCDetailsRequest(TArray<struct FPublishedFileID> PublishedFileIDs);
		struct FUGCQueryHandle CreateQueryAllUGCRequest(SteamCore_ESteamUGCQuery QueryType, SteamCore_ESteamUGCMatchingUGCType FileType, int32_t CreatorAppID, int32_t ConsumerAppID, int32_t Page);
		void CreateItem(const class FScriptDelegate& Callback, int32_t ConsumerAppID, SteamCore_ESteamWorkshopFileType FileType);
		...
		bool AddItemPreviewFile(const struct FUGCUpdateHandle& Handle, const class FString& PreviewFile, SteamCore_ESteamItemPreviewType Type);
	...
	public:
		...
		class USteamCoreUGCAsyncActionCreateItem* CreateItemAsync(class UObject* WorldContextObject, int32_t ConsumerAppID, SteamCore_ESteamWorkshopFileType FileType, float Timeout);
		static UClass* StaticClass();
	};
	...
	public:
		...
		unsigned char                                              UnknownData_UXSF[0x160];                                 // 0x00F8(0x0160) MISSED OFFSET (PADDING)
	...
	public:
		...
		SteamCore_ESteamVoiceResult GetVoice(TArray<unsigned char>* DestBuffer, int32_t* BytesWritten);
		...
		SteamCore_ESteamVoiceResult GetAvailableVoice(int32_t* CompressedBytes, int32_t* UncompressedBytes, int32_t UncompressedVoiceDesiredSampleRate);
		struct FSteamTicketHandle GetAuthSessionTicket(TArray<unsigned char>* Ticket);
		void EndAuthSession(const struct FSteamID& SteamID);
		SteamCore_ESteamVoiceResult DecompressVoice(TArray<unsigned char> CompressedBuffer, int32_t DesiredSampleRate, TArray<unsigned char>* DestBuffer);
		void CancelAuthTicket(const struct FSteamTicketHandle& TicketHandle);
		bool BLoggedOn();
	...
	public:
		...
		unsigned char                                              UnknownData_OCZB[0xA0];                                  // 0x0098(0x00A0) MISSED OFFSET (PADDING)

	public:
		void UploadLeaderboardScore(const class FScriptDelegate& Callback, const struct FSteamLeaderboard& SteamLeaderboard, SteamCore_ESteamLeaderboardUploadScoreMethod UploadScoreMethod, int32_t Score, TArray<int32_t> ScoreDetails);
		...
		SteamCore_ESteamLeaderboardSortMethod GetLeaderboardSortMethod(const struct FSteamLeaderboard& SteamLeaderboard);
		...
		SteamCore_ESteamLeaderboardDisplayType GetLeaderboardDisplayType(const struct FSteamLeaderboard& SteamLeaderboard);
		...
		void FindOrCreateLeaderboard(const class FScriptDelegate& Callback, const class FString& LeaderboardName, SteamCore_ESteamLeaderboardSortMethod SortMethod, SteamCore_ESteamLeaderboardDisplayType DisplayType);
		...
		void DownloadLeaderboardEntries(const class FScriptDelegate& Callback, const struct FSteamLeaderboard& SteamLeaderboard, SteamCore_ESteamLeaderboardDataRequest DataRequest, int32_t RangeStart, int32_t RangeEnd);
	...
	public:
		...
		class USteamCoreUserStatsAsyncActionDownloadLeaderboardEntries* DownloadLeaderboardEntriesAsync(class UObject* WorldContextObject, const struct FSteamLeaderboard& SteamLeaderboard, SteamCore_ESteamLeaderboardDataRequest Request, int32_t RangeStart, int32_t RangeEnd, float Timeout);
		static UClass* StaticClass();
	};
	...
	public:
		class USteamCoreUserStatsAsyncActionUploadLeaderboardScore* UploadLeaderboardScoreAsync(class UObject* WorldContextObject, const struct FSteamLeaderboard& SteamLeaderboard, SteamCore_ESteamLeaderboardUploadScoreMethod UploadScoreMethod, int32_t Score, TArray<int32_t> ScoreDetails, float Timeout);
	...
	public:
		...
		class USteamCoreUserStatsAsyncActionFindOrCreateLeaderboard* FindOrCreateLeaderboardAsync(class UObject* WorldContextObject, const class FString& LeaderboardName, SteamCore_ESteamLeaderboardSortMethod SortMethod, SteamCore_ESteamLeaderboardDisplayType DisplayType, float Timeout);
		static UClass* StaticClass();
	};
	...
	public:
		...
		void SteamItemInstanceID_Equals_Exec(const struct FSteamItemInstanceID& A, const struct FSteamItemInstanceID& B, SteamCore_ESteamCoreIdentical* Result);
		...
		void PublishedFileID_Equals_Exec(const struct FPublishedFileID& A, const struct FPublishedFileID& B, SteamCore_ESteamCoreIdentical* Result);
		...
		struct FSteamSessionSearchSetting MakeSearchInteger(SteamCore_ESteamComparisonOp ComparisonOperator, int32_t Value);
		...
		void IsUGCHandleValid_Exec(const struct FSteamUGCHandle& Handle, SteamCore_ESteamCoreValid* Result);
		bool IsUGCHandleValid(const struct FSteamUGCHandle& Handle);
		void IsSteamTicketHandleValid_Exec(const struct FSteamTicketHandle& Handle, SteamCore_ESteamCoreValid* Result);
		bool IsSteamTicketHandleValid(const struct FSteamTicketHandle& Handle);
		bool IsSteamServerInitialized();
		void IsSteamInventoryUpdateHandleValid_Exec(const struct FSteamInventoryUpdateHandle& Handle, SteamCore_ESteamCoreValid* Result);
		bool IsSteamInventoryUpdateHandleValid(const struct FSteamInventoryUpdateHandle& Handle);
		void IsSteamIDValid_Exec(const struct FSteamID& SteamID, SteamCore_ESteamCoreValid* Result);
		bool IsSteamAvailable();
		bool IsRecalculatingPing();
		void IsPublishedFileIDValid_Exec(const struct FPublishedFileID& Handle, SteamCore_ESteamCoreValid* Result);
		bool IsPublishedFileIDValid(const struct FPublishedFileID& PublishedFileID);
		bool IsLobby(const struct FSteamID& SteamID);
		void IsGameIDValid_Exec(const struct FSteamGameID& GameID, SteamCore_ESteamCoreValid* Result);
		...
		SteamCore_ESteamAccountType GetAccountType(const struct FSteamID& SteamID);
		struct FDateTime FromUnixTimestamp(const class FString& Timestamp);
		void Equal_Exec(const struct FSteamID& A, const struct FSteamID& B, SteamCore_ESteamCoreIdentical* Result);
	...
	public:
		...
		unsigned char                                              UnknownData_AL1X[0xA0];                                  // 0x0098(0x00A0) MISSED OFFSET (PADDING)

	public:
		void StartVRDashboard();
		bool ShowGamepadTextInput(SteamCore_ESteamGamepadTextInputMode InputMode, SteamCore_ESteamGamepadTextInputLineMode LineInputMode, const class FString& Description, int32_t CharMax, const class FString& ExistingText);
		void SetVRHeadsetStreamingEnabled(bool bEnabled);
		void SetOverlayNotificationPosition(SteamCore_ESteamNotificationPosition NotificationPosition);
		...
		SteamCore_ESteamUniverse GetConnectedUniverse();
	...
	public:
		...
		unsigned char                                              UnknownData_YYS4[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
