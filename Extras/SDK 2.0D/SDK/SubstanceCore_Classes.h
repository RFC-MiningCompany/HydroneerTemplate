...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_T72O[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_IZNK[0x1F];                                  // 0x0159(0x001F) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_V58C[0x18];                                  // 0x0038(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		SubstanceCore_ESubstanceGenerationMode                     GenerationMode;                                          // 0x0080(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_YKQH[0x7];                                   // 0x0081(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		SubstanceCore_ESubstanceEngineType                         SubstanceEngine;                                         // 0x0038(0x0001) Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		SubstanceCore_EDefaultSubstanceTextureSize                 DefaultSubstanceOutputSizeX;                             // 0x0039(0x0001) Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		SubstanceCore_EDefaultSubstanceTextureSize                 DefaultSubstanceOutputSizeY;                             // 0x003A(0x0001) Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_M9XI[0x5];                                   // 0x003B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_Z1V9[0x30];                                  // 0x00F0(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		Engine_ETextureAddress                                     AddressX;                                                // 0x0128(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic
		Engine_ETextureAddress                                     AddressY;                                                // 0x0129(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic
		bool                                                       bCooked;                                                 // 0x012A(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_NX27[0x1D];                                  // 0x012B(0x001D) MISSED OFFSET (PADDING)
	...
	public:
		...
		void SetGraphInstanceOutputSize(class USubstanceGraphInstance* GraphInstance, SubstanceCore_ESubstanceTextureSize Width, SubstanceCore_ESubstanceTextureSize Height);
