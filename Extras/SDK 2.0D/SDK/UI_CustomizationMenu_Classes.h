...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_OA1E[0x8];                                   // 0x0308(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ULUL[0x4];                                   // 0x038C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		void SetDummyVisibility(UMG_ESlateVisibility Visibility);
