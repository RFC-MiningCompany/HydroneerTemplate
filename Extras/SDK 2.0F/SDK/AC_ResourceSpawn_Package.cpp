...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_ResourceSpawn.AC_ResourceSpawn_C.BalanceResources"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_ResourceSpawn.AC_ResourceSpawn_C.GetDirtDepth"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_ResourceSpawn.AC_ResourceSpawn_C.SpawnActorDontUsethis"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_ResourceSpawn.AC_ResourceSpawn_C.CalcDQA"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_ResourceSpawn.AC_ResourceSpawn_C.SpawnFish"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_ResourceSpawn.AC_ResourceSpawn_C.SpawnResource"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass AC_ResourceSpawn.AC_ResourceSpawn_C"));
		return ptr;
	}
