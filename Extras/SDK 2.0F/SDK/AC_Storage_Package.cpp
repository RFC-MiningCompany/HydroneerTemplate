...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_Storage.AC_Storage_C.ReturnAllContents"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_Storage.AC_Storage_C.ItemStored"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_Storage.AC_Storage_C.StoredItemPickedUp"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_Storage.AC_Storage_C.AddItemToStorage"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_Storage.AC_Storage_C.StorageTimer"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_Storage.AC_Storage_C.ItemIsAttached"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_Storage.AC_Storage_C.LockAllIn"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_Storage.AC_Storage_C.RemoveItemFromStorage"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_Storage.AC_Storage_C.ItemLeftStorageZone"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_Storage.AC_Storage_C.DetachStorageItem"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_Storage.AC_Storage_C.ExecuteUbergraph_AC_Storage"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_Storage.AC_Storage_C.ItemDetached__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_Storage.AC_Storage_C.ItemAttached__DelegateSignature"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass AC_Storage.AC_Storage_C"));
		return ptr;
	}
