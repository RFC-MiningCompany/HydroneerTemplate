...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_StoreFunctions.AC_StoreFunctions_C.CalcWeight"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_StoreFunctions.AC_StoreFunctions_C.CalcPrice"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_StoreFunctions.AC_StoreFunctions_C.CalculateCraftedPrice"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_StoreFunctions.AC_StoreFunctions_C.CalculateFishPrice"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_StoreFunctions.AC_StoreFunctions_C.ReplaceCoinsWithNewValue"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_StoreFunctions.AC_StoreFunctions_C.GetTotalCoinValue"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass AC_StoreFunctions.AC_StoreFunctions_C"));
		return ptr;
	}
