...
namespace CG
{
	 ...
	 */
	class USoundWave* UAudioMixerBlueprintLibrary::StopRecordingOutput(class UObject* WorldContextObject, Engine_EAudioRecordingExportType ExportType, const class FString& Name, const class FString& Path, class USoundSubmix* SubmixToRecord, class USoundWave* ExistingSoundWaveToOverwrite)
	{
		...
		struct
		{
			...
			Engine_EAudioRecordingExportType                   ExportType;
			class FString                                      Name;
			class FString                                      Path;
	...
	void UAudioMixerBlueprintLibrary::StartAnalyzingOutput(class UObject* WorldContextObject, class USoundSubmix* SubmixToAnalyze, Engine_EFFTSize FFTSize, Engine_EFFTPeakInterpolationMethod InterpolationMethod, Engine_EFFTWindowType WindowType, float HopSize, Engine_EAudioSpectrumType SpectrumType)
	{
		...
		struct
		{
			...
			Engine_EFFTSize                                    FFTSize;
			Engine_EFFTPeakInterpolationMethod                 InterpolationMethod;
			Engine_EFFTWindowType                              WindowType;
			float                                              HopSize;
			Engine_EAudioSpectrumType                          SpectrumType;
		} params;
		params.WorldContextObject = WorldContextObject;
	 ...
	 */
	TArray<struct FSoundSubmixSpectralAnalysisBandSettings> UAudioMixerBlueprintLibrary::MakePresetSpectralAnalysisBandSettings(Engine_EAudioSpectrumBandPresetType InBandPresetType, int32_t InNumBands, int32_t InAttackTimeMsec, int32_t InReleaseTimeMsec)
	{
		...
		struct
		{
			Engine_EAudioSpectrumBandPresetType                InBandPresetType;
			int32_t                                            InNumBands;
	 ...
	 * 		int32_t                                            InReleaseTimeMsec                                          (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	TArray<struct FSoundSubmixSpectralAnalysisBandSettings> UAudioMixerBlueprintLibrary::MakeMusicalSpectralAnalysisBandSettings(int32_t InNumSemitones, AudioMixer_EMusicalNoteName InStartingMusicalNote, int32_t InStartingOctave, int32_t InAttackTimeMsec, int32_t InReleaseTimeMsec)
	{
		...
		struct
		{
			...
			AudioMixer_EMusicalNoteName                        InStartingMusicalNote;
	...
	void UQuartzClockHandle::UnsubscribeFromTimeDivision(class UObject* WorldContextObject, Engine_EQuartzCommandQuantization InQuantizationBoundary)
	{
		...
		{
			class UObject*                                     WorldContextObject;
			Engine_EQuartzCommandQuantization                  InQuantizationBoundary;
		} params;
		params.WorldContextObject = WorldContextObject;
	 ...
	 */
	void UQuartzClockHandle::SubscribeToQuantizationEvent(class UObject* WorldContextObject, Engine_EQuartzCommandQuantization InQuantizationBoundary, const class FScriptDelegate& OnQuantizationEvent)
	{
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AudioMixer.QuartzClockHandle"));
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AudioMixer.QuartzSubsystem"));
		return ptr;
	}
