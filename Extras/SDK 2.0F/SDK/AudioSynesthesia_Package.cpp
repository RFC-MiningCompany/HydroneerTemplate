...
namespace CG
{
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AudioSynesthesia.AudioSynesthesiaNRTSettings"));
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AudioSynesthesia.AudioSynesthesiaNRT"));
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AudioSynesthesia.ConstantQNRTSettings"));
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AudioSynesthesia.ConstantQNRT"));
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AudioSynesthesia.LoudnessNRTSettings"));
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AudioSynesthesia.LoudnessNRT"));
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AudioSynesthesia.OnsetNRTSettings"));
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class AudioSynesthesia.OnsetNRT"));
		return ptr;
	}
