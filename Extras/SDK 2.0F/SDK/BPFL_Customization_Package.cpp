...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BPFL_Customization.BPFL_Customization_C.GetRelevantCustomizationOptions"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BPFL_Customization.BPFL_Customization_C.GetCustomizationOptions"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BPFL_Customization.BPFL_Customization_C"));
		return ptr;
	}
