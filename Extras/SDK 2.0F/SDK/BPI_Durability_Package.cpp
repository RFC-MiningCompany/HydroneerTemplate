...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BPI_Durability.BPI_Durability_C.ReturnDurability"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BPI_Durability.BPI_Durability_C.FindDurability"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BPI_Durability.BPI_Durability_C.DoneRepair"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BPI_Durability.BPI_Durability_C.TryRepair"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BPI_Durability.BPI_Durability_C"));
		return ptr;
	}
