...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Anvil.BP_Anvil_C.FindRotationForCraftedItem"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Anvil.BP_Anvil_C.TryCraftItem"));
		
		struct
		{
			E_AnvilType_E_AnvilType                            Item_To_Craft;
		} params;
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Anvil.BP_Anvil_C.HammerHit"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Anvil.BP_Anvil_C.BndEvt__AnvilFace_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Anvil.BP_Anvil_C.BndEvt__AnvilFace_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Anvil.BP_Anvil_C.OverridePickedup"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Anvil.BP_Anvil_C.LMBDownIsTarget"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Anvil.BP_Anvil_C.RMBDownIsTarget"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Anvil.BP_Anvil_C.ExecuteUbergraph_BP_Anvil"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_Anvil.BP_Anvil_C"));
		return ptr;
	}
