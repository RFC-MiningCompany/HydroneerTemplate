...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_BuildCottageDoorway.BP_BuildCottageDoorway_C.LMBDownIsTarget"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_BuildCottageDoorway.BP_BuildCottageDoorway_C.ExecuteUbergraph_BP_BuildCottageDoorway"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_BuildCottageDoorway.BP_BuildCottageDoorway_C"));
		return ptr;
	}
