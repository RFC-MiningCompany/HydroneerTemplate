...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_BuildWoodDoorway.BP_BuildWoodDoorway_C.LMBDownIsTarget"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_BuildWoodDoorway.BP_BuildWoodDoorway_C.ExecuteUbergraph_BP_BuildWoodDoorway"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_BuildWoodDoorway.BP_BuildWoodDoorway_C"));
		return ptr;
	}
