...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_CaughtFish.BP_CaughtFish_C.UserConstructionScript"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_CaughtFish.BP_CaughtFish_C.InFire"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_CaughtFish.BP_CaughtFish_C.OutOfFire"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_CaughtFish.BP_CaughtFish_C.FullHeat"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_CaughtFish.BP_CaughtFish_C.HeatUpdated"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_CaughtFish.BP_CaughtFish_C.ActorLoaded"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_CaughtFish.BP_CaughtFish_C.LoadFishType"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_CaughtFish.BP_CaughtFish_C.ExecuteUbergraph_BP_CaughtFish"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_CaughtFish.BP_CaughtFish_C"));
		return ptr;
	}
