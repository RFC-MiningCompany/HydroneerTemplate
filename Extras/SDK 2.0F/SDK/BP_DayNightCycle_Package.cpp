...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.ComponentsToSave"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.SetDayModePostLoad"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.SetDayMode"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.ActorSaved"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.ReceiveBeginPlay"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.ActorPreSave"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.SpeedUpToSunrise"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.SunRiseTimerCheck"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.SetNewRate"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.Update"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.ActorLoaded"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.ExecuteUbergraph_BP_DayNightCycle"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_DayNightCycle.BP_DayNightCycle_C"));
		return ptr;
	}
