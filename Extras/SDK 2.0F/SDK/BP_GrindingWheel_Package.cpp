...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_GrindingWheel.BP_GrindingWheel_C.GrindGem"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_GrindingWheel.BP_GrindingWheel_C.SpinWheel"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_GrindingWheel.BP_GrindingWheel_C.LMBDownIsTarget"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_GrindingWheel.BP_GrindingWheel_C.ExecuteUbergraph_BP_GrindingWheel"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_GrindingWheel.BP_GrindingWheel_C"));
		return ptr;
	}
