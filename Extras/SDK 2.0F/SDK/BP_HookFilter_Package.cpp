...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookFilter.BP_HookFilter_C.ComponentsToSave"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookFilter.BP_HookFilter_C.HookFunctionality"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookFilter.BP_HookFilter_C.ReturnDurability"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookFilter.BP_HookFilter_C.TryRepair"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookFilter.BP_HookFilter_C.DoneRepair"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookFilter.BP_HookFilter_C.FindDurability"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookFilter.BP_HookFilter_C.ExecuteUbergraph_BP_HookFilter"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_HookFilter.BP_HookFilter_C"));
		return ptr;
	}
