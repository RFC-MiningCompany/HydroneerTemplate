...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_74X9[0x7];                                   // 0x0349(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		Engine_ETimelineDirection                                  Timeline_1__Direction_00491F854B0649577EAED7B7FFAF6AED;  // 0x0364(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_EEDA[0x3];                                   // 0x0365(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
