...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.TurnOffLight"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.HookFunctionality"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.UserConstructionScript"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.Timeline_0__FinishedFunc"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.Timeline_0__UpdateFunc"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.Timeline_1__FinishedFunc"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.Timeline_1__UpdateFunc"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.OverrideLoaded"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.RaiseBrightness"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.ChangeColor"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.NewLogicInput"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.OverridePickedup"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.ExecuteUbergraph_BP_LogicHookLight"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_LogicHookLight.BP_LogicHookLight_C"));
		return ptr;
	}
