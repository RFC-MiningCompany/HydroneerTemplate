...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBuildSeedBag.BP_ParentBuildSeedBag_C.OverridePlacedDown"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBuildSeedBag.BP_ParentBuildSeedBag_C.ExecuteUbergraph_BP_ParentBuildSeedBag"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentBuildSeedBag.BP_ParentBuildSeedBag_C"));
		return ptr;
	}
