...
namespace CG
{
	 ...
	 */
	void ABP_ParentItem_C::SetMeshPhysicalReaction(E_PhyReact_E_PhyReact New_Reaction, class UStaticMeshComponent* Mesh)
	{
	 ...
	 * 		E_PhyReact_E_PhyReact                              New_Reaction                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void ABP_ParentItem_C::Set_Item_Physical_Reactions(E_PhyReact_E_PhyReact New_Reaction)
	{
	 ...
	 */
	void ABP_ParentItem_C::SetAllResponseToChannel(Engine_ECollisionResponse NewResponse, Engine_ECollisionChannel Channel)
	{
