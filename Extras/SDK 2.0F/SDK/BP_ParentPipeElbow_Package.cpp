...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPipeElbow.BP_ParentPipeElbow_C.OverrideWaterIn"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPipeElbow.BP_ParentPipeElbow_C.ExecuteUbergraph_BP_ParentPipeElbow"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentPipeElbow.BP_ParentPipeElbow_C"));
		return ptr;
	}
