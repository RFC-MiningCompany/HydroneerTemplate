...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.CreateBar"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.SetLiquidHeight"));
	 ...
	 */
	void ABP_Smelter_C::SetNewLiquidType(E_MetalType_E_MetalType Type, float OreContent)
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.SetNewLiquidType"));
	 ...
	 */
	void ABP_Smelter_C::FindLiquidClass(class ABP_ParentResource_C* Resource, E_MetalType_E_MetalType* Type)
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.FindLiquidClass"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.OverridePickedup"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.OverrideLoaded"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.NewItemInPot"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.BndEvt__Cylinder_K2Node_ComponentBoundEvent_2_ComponentBeginOverlapSignature__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.SpawnBar"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.PlayPourAnim"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.LMBDownIsTarget"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.OverridePlacedDown"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.OverrideDroppedItem"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.ExecuteUbergraph_BP_Smelter"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_Smelter.BP_Smelter_C"));
		return ptr;
	}
