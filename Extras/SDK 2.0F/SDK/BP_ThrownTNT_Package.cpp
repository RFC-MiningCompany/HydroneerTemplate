...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ThrownTNT.BP_ThrownTNT_C.LMBDownWhileCarrying"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ThrownTNT.BP_ThrownTNT_C.UserConstructionScript"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ThrownTNT.BP_ThrownTNT_C.Explode Timer"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ThrownTNT.BP_ThrownTNT_C.Throw"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ThrownTNT.BP_ThrownTNT_C.ExecuteUbergraph_BP_ThrownTNT"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ThrownTNT.BP_ThrownTNT_C"));
		return ptr;
	}
