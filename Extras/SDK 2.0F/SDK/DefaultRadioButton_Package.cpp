...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function DefaultRadioButton.DefaultRadioButton_C.GetTextColor"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function DefaultRadioButton.DefaultRadioButton_C.BndEvt__MainButton_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function DefaultRadioButton.DefaultRadioButton_C.ExecuteUbergraph_DefaultRadioButton"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function DefaultRadioButton.DefaultRadioButton_C.Clicked__DelegateSignature"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass DefaultRadioButton.DefaultRadioButton_C"));
		return ptr;
	}
