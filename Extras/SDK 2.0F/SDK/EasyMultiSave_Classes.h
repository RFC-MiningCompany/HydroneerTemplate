...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_N5DR[0x38];                                  // 0x0040(0x0038) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnCompleted;                                             // 0x0030(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_YVAJ[0x20];                                  // 0x0040(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnCompleted;                                             // 0x0030(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_H0N9[0x18];                                  // 0x0040(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_D8HB[0x7];                                   // 0x0039(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_MX8I[0x108];                                 // 0x00C8(0x0108) MISSED OFFSET (PADDING)

	public:
		void OuterActorEndPlay(class AActor* Actor, Engine_EEndPlayReason EndPlayReason);
		static UClass* StaticClass();
	};
	...
	public:
		...
		EasyMultiSave_ELoadMethod                                  LoadMethod;                                              // 0x0056(0x0001) Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		EasyMultiSave_EFileSaveMethod                              FileNamingType;                                          // 0x0057(0x0001) Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_J4M2[0x7];                                   // 0x0059(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
