...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_3R1U[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_M7VV[0x10];                                  // 0x0448(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              SupportedSolvers[0x10];                                  // 0x0448(0x0010) UNKNOWN PROPERTY: ArrayProperty
		unsigned char                                              UnknownData_NDSE[0x18];                                  // 0x0468(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		void ApplyPhysicsField(bool Enabled, Chaos_EFieldPhysicsType Target, class UFieldSystemMetaData* MetaData, class UFieldNodeBase* Field);
		void ApplyLinearForce(bool Enabled, const struct FVector& Direction, float Magnitude);
		void AddFieldCommand(bool Enabled, Chaos_EFieldPhysicsType Target, class UFieldSystemMetaData* MetaData, class UFieldNodeBase* Field);
		static UClass* StaticClass();
	};
	...
	public:
		...
		unsigned char                                              UnknownData_REQO[0x4];                                   // 0x00B4(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		Chaos_EFieldResolutionType                                 ResolutionType;                                          // 0x00B0(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_1E4C[0x7];                                   // 0x00B1(0x0007) MISSED OFFSET (PADDING)

	public:
		class UFieldSystemMetaDataProcessingResolution* SetMetaDataaProcessingResolutionType(Chaos_EFieldResolutionType ResolutionType);
		static UClass* StaticClass();
	};
	...
	public:
		...
		unsigned char                                              UnknownData_XPKL[0x4];                                   // 0x00B4(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		Chaos_ESetMaskConditionType                                SetMaskCondition;                                        // 0x00C8(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_XYFQ[0x7];                                   // 0x00C9(0x0007) MISSED OFFSET (PADDING)

	public:
		class URadialIntMask* SetRadialIntMask(float Radius, const struct FVector& Position, int32_t InteriorValue, int32_t ExteriorValue, Chaos_ESetMaskConditionType SetMaskConditionIn);
		static UClass* StaticClass();
	};
	...
	public:
		...
		unsigned char                                              UnknownData_5T0H[0x4];                                   // 0x00B4(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		Chaos_EFieldFalloffType                                    Falloff;                                                 // 0x00D0(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_7QZP[0x7];                                   // 0x00D1(0x0007) MISSED OFFSET (PADDING)

	public:
		class URadialFalloff* SetRadialFalloff(float Magnitude, float MinRange, float MaxRange, float Default, float Radius, const struct FVector& Position, Chaos_EFieldFalloffType Falloff);
		static UClass* StaticClass();
	};
	...
	public:
		...
		Chaos_EFieldFalloffType                                    Falloff;                                                 // 0x00DC(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_Q8N5[0x3];                                   // 0x00DD(0x0003) MISSED OFFSET (PADDING)

	public:
		class UPlaneFalloff* SetPlaneFalloff(float Magnitude, float MinRange, float MaxRange, float Default, float Distance, const struct FVector& Position, const struct FVector& Normal, Chaos_EFieldFalloffType Falloff);
		static UClass* StaticClass();
	};
	...
	public:
		...
		Chaos_EFieldFalloffType                                    Falloff;                                                 // 0x00F0(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_SYEN[0xF];                                   // 0x00F1(0x000F) MISSED OFFSET (PADDING)

	public:
		class UBoxFalloff* SetBoxFalloff(float Magnitude, float MinRange, float MaxRange, float Default, const struct FTransform& Transform, Chaos_EFieldFalloffType Falloff);
		static UClass* StaticClass();
	};
	...
	public:
		...
		unsigned char                                              UnknownData_MZV5[0x8];                                   // 0x00B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FTransform                                          Transform;                                               // 0x00C0(0x0030) Edit, BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
	...
	public:
		float                                                      Magnitude;                                               // 0x00B0(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_KEO4[0x4];                                   // 0x00B4(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		float                                                      Magnitude;                                               // 0x00B0(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_X6K6[0x4];                                   // 0x00B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		Chaos_EFieldOperationType                                  Operation;                                               // 0x00C8(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_QSFZ[0x7];                                   // 0x00C9(0x0007) MISSED OFFSET (PADDING)

	public:
		class UOperatorField* SetOperatorField(float Magnitude, class UFieldNodeBase* RightField, class UFieldNodeBase* LeftField, Chaos_EFieldOperationType Operation);
		static UClass* StaticClass();
	};
	...
	public:
		...
		Chaos_EFieldCullingOperationType                           Operation;                                               // 0x00C0(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_GWBX[0x7];                                   // 0x00C1(0x0007) MISSED OFFSET (PADDING)

	public:
		class UCullingField* SetCullingField(class UFieldNodeBase* Culling, class UFieldNodeBase* Field, Chaos_EFieldCullingOperationType Operation);
		static UClass* StaticClass();
	};
