...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_STKI[0x8];                                   // 0x01A8(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_31F5[0x7];                                   // 0x0039(0x0007) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_XTC7[0x10];                                  // 0x0500(0x0010) MISSED OFFSET (PADDING)
