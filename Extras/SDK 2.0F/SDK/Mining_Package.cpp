...
namespace CG
{
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Mining.CGameEngine"));
		return ptr;
	}
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CGameInstance.DiscordRunCallbacks"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Mining.CGameInstance"));
		return ptr;
	}
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerLibrary.StringToClassRef"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerLibrary.SanitizeString"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerLibrary.RenameSave"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerLibrary.ReloadInput"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerLibrary.GetSaveDirectory"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerLibrary.GetSaveBackupNames"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerLibrary.GetHighestCurrentSaveIndex"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerLibrary.GetAppdataLocalDir"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerLibrary.FindFolders"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerLibrary.CopyOverDirectory"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerLibrary.BackupSave"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Mining.CHydroneerLibrary"));
		return ptr;
	}
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerProjectSettings.Get"));
		
		struct
		{
			class UCHydroneerProjectSettings*                  ReturnValue;
		} params;
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Mining.CHydroneerProjectSettings"));
		return ptr;
	}
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CModdingSubsystem.UnloadMod"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CModdingSubsystem.UninstallUnsubscribedMods"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CModdingSubsystem.LoadMod"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CModdingSubsystem.InstallAllPending"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CModdingSubsystem.GetModdingSubsystem"));
		
		struct
		{
			class UCModdingSubsystem*                          ReturnValue;
		} params;
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CModdingSubsystem.GetLoadedMods"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CModdingSubsystem.GetInstalledMods"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CModdingSubsystem.GetAllSubscribedMods"));
		
		struct
		{
			TArray<struct FPublishedFileID>                    ReturnValue;
		} params;
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Mining.CModdingSubsystem"));
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Mining.LocalCableComponent"));
		return ptr;
	}
