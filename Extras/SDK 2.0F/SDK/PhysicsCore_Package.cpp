...
namespace CG
{
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class PhysicsCore.BodySetupCore"));
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class PhysicsCore.ChaosPhysicalMaterial"));
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class PhysicsCore.PhysicalMaterial"));
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class PhysicsCore.PhysicalMaterialPropertyBase"));
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class PhysicsCore.PhysicsSettingsCore"));
		return ptr;
	}
