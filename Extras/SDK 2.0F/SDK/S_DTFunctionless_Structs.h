...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_7KDC[0x4];                                   // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FText                                                URL_12_BDEBE72747BFD50FEFDAE89565A18D38;                 // 0x0038(0x0018) Edit, BlueprintVisible
		E_PlacementType_E_PlacementType                            PlacementType_21_B2C702A846D4FE4D7F584D9AB4CEB3D9;       // 0x0050(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_PYH2[0x6];                                   // 0x0052(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
