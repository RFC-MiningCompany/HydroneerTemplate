...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_4XLT[0x8];                                   // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		E_PaintTruck_E_PaintTruck                                  PaintType_8_EDBD4AE642ABBE1A3F2EF0A819CA1BB3;            // 0x0044(0x0001) Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor, HasGetValueTypeHash
