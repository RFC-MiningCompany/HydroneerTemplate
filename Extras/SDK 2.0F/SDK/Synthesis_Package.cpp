...
namespace CG
{
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Synthesis.SubmixEffectMultibandCompressorPreset"));
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Synthesis.SubmixEffectStereoDelayPreset"));
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Synthesis.SynthComponentToneGenerator"));
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Synthesis.SynthesisUtilitiesBlueprintFunctionLibrary"));
		return ptr;
	}
