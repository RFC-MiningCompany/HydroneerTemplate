...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_MapPlayerLocation.UI_MapPlayerLocation_C.UpdateSelection"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_MapPlayerLocation.UI_MapPlayerLocation_C.PreConstruct"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_MapPlayerLocation.UI_MapPlayerLocation_C.ExecuteUbergraph_UI_MapPlayerLocation"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass UI_MapPlayerLocation.UI_MapPlayerLocation_C"));
		return ptr;
	}
