...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_NewGame.UI_Menu_NewGame_C.BndEvt__NewGameConfirmButton_K2Node_ComponentBoundEvent_10_OnButtonClickedEvent__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_NewGame.UI_Menu_NewGame_C.BndEvt__UI_Menu_NewGame_NewGameConfirmButton_1_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_NewGame.UI_Menu_NewGame_C.Construct"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_NewGame.UI_Menu_NewGame_C.ExecuteUbergraph_UI_Menu_NewGame"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass UI_Menu_NewGame.UI_Menu_NewGame_C"));
		return ptr;
	}
