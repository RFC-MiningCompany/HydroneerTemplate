...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_SaveManager.UI_Menu_SaveManager_C.ShowCloudSaveConflictWarning?"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_SaveManager.UI_Menu_SaveManager_C.OnCompleted_C53FDA2E40F890A4277525AEB4F182D7"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_SaveManager.UI_Menu_SaveManager_C.Construct"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_SaveManager.UI_Menu_SaveManager_C.SaveSelected"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_SaveManager.UI_Menu_SaveManager_C.RefreshList"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_SaveManager.UI_Menu_SaveManager_C.AnimateText"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_SaveManager.UI_Menu_SaveManager_C.RestoreDelete Button"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_SaveManager.UI_Menu_SaveManager_C.BndEvt__UI_Menu_SaveManager_BackupVisibility_K2Node_ComponentBoundEvent_0_OnCheckBoxComponentStateChanged__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_SaveManager.UI_Menu_SaveManager_C.BndEvt__UI_Menu_SaveManager_H_ButtonMetal1_C_2_K2Node_ComponentBoundEvent_6_OnButtonPressedEvent__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_SaveManager.UI_Menu_SaveManager_C.BndEvt__UI_Menu_SaveManager_ButtonDeleteSave_K2Node_ComponentBoundEvent_7_OnButtonPressedEvent__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_SaveManager.UI_Menu_SaveManager_C.BndEvt__UI_Menu_SaveManager_H_ButtonMetal2_C_1_K2Node_ComponentBoundEvent_8_OnButtonPressedEvent__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_SaveManager.UI_Menu_SaveManager_C.BndEvt__UI_Menu_SaveManager_H_ButtonMetal1_KeepLocal_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_SaveManager.UI_Menu_SaveManager_C.BndEvt__UI_Menu_SaveManager_H_ButtonMetal1_KeepCloud_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_SaveManager.UI_Menu_SaveManager_C.ExecuteUbergraph_UI_Menu_SaveManager"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass UI_Menu_SaveManager.UI_Menu_SaveManager_C"));
		return ptr;
	}
