...
namespace CG
{
	...
	void UABP_Dummy_C::AnimGraph(struct FPoseLink* AnimGraph)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function ABP_Dummy.ABP_Dummy_C.AnimGraph"));
	...
	void UABP_Dummy_C::ExecuteUbergraph_ABP_Dummy(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function ABP_Dummy.ABP_Dummy_C.ExecuteUbergraph_ABP_Dummy"));
	...
	UClass* UABP_Dummy_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass ABP_Dummy.ABP_Dummy_C"));
		return ptr;
	}
