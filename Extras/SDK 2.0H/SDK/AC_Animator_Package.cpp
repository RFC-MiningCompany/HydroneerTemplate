...
namespace CG
{
	...
	void UAC_Animator_C::PlayAnimation(float Seconds, class UMeshComponent* Mesh, class UCurveVector* MovementCurve, class UCurveVector* RotationCurve)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Animator.AC_Animator_C.PlayAnimation"));
	...
	void UAC_Animator_C::AnimationTimerEvent()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Animator.AC_Animator_C.AnimationTimerEvent"));
	...
	void UAC_Animator_C::ExecuteUbergraph_AC_Animator(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Animator.AC_Animator_C.ExecuteUbergraph_AC_Animator"));
	...
	UClass* UAC_Animator_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass AC_Animator.AC_Animator_C"));
		return ptr;
	}
