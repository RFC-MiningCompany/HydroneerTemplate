...
namespace CG
{
	...
	void UAC_Durability_C::Repaired(class ABP_ParentItem_C* RepairingTool)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Durability.AC_Durability_C.Repaired"));
	...
	void UAC_Durability_C::TryRepair(class ABP_ParentItem_C* RepairingTool)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Durability.AC_Durability_C.TryRepair"));
	...
	void UAC_Durability_C::DoneRepair()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Durability.AC_Durability_C.DoneRepair"));
	...
	void UAC_Durability_C::FindDurability(class ABP_ParentItem_C* Item)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Durability.AC_Durability_C.FindDurability"));
	...
	void UAC_Durability_C::ReturnDurability(float DurabilityAmount)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Durability.AC_Durability_C.ReturnDurability"));
	...
	void UAC_Durability_C::ExecuteUbergraph_AC_Durability(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Durability.AC_Durability_C.ExecuteUbergraph_AC_Durability"));
	...
	UClass* UAC_Durability_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass AC_Durability.AC_Durability_C"));
		return ptr;
	}
