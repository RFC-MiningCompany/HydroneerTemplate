...
namespace CG
{
	...
	void UAC_Explosive_C::GetRandomSpaceInRadius(struct FVector* Location)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Explosive.AC_Explosive_C.GetRandomSpaceInRadius"));
	...
	void UAC_Explosive_C::TraceForVoxelWorld(class ABP_HydroVoxelWorld_C** VoxWorld)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Explosive.AC_Explosive_C.TraceForVoxelWorld"));
	...
	void UAC_Explosive_C::CreateHoles(int32_t Amount)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Explosive.AC_Explosive_C.CreateHoles"));
	...
	void UAC_Explosive_C::FindOverlappingActors(TArray<class ABP_ParentItem_C*>* Items)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Explosive.AC_Explosive_C.FindOverlappingActors"));
	...
	void UAC_Explosive_C::SpawnScrap(const struct FVector& Location, float Size)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Explosive.AC_Explosive_C.SpawnScrap"));
	...
	void UAC_Explosive_C::CheckOverlaps()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Explosive.AC_Explosive_C.CheckOverlaps"));
	...
	void UAC_Explosive_C::LoopForItems(class AActor* Object)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Explosive.AC_Explosive_C.LoopForItems"));
	...
	void UAC_Explosive_C::Explode()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Explosive.AC_Explosive_C.Explode"));
	...
	void UAC_Explosive_C::ExecuteUbergraph_AC_Explosive(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Explosive.AC_Explosive_C.ExecuteUbergraph_AC_Explosive"));
	...
	UClass* UAC_Explosive_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass AC_Explosive.AC_Explosive_C"));
		return ptr;
	}
