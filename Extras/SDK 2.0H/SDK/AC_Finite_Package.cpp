...
namespace CG
{
	...
	void UAC_Finite_C::Used(int32_t Amount)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Finite.AC_Finite_C.Used"));
	...
	void UAC_Finite_C::AddUses(int32_t AmountToAdd)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Finite.AC_Finite_C.AddUses"));
	...
	void UAC_Finite_C::ExecuteUbergraph_AC_Finite(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Finite.AC_Finite_C.ExecuteUbergraph_AC_Finite"));
	...
	UClass* UAC_Finite_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass AC_Finite.AC_Finite_C"));
		return ptr;
	}
