...
namespace CG
{
	...
	void UAC_Highlight_C::SetHighlight(class ABP_GameController_C* Controller)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Highlight.AC_Highlight_C.SetHighlight"));
	...
	void UAC_Highlight_C::ToggleHighlightSpecific(int32_t StencilValue, bool Highlight_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Highlight.AC_Highlight_C.ToggleHighlightSpecific"));
	...
	void UAC_Highlight_C::ForceStopHighlight(class ABP_GameController_C* Controller)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Highlight.AC_Highlight_C.ForceStopHighlight"));
	...
	void UAC_Highlight_C::TogglePlayerHighlight(bool Highlight_, class ABP_GameController_C* Controller)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Highlight.AC_Highlight_C.TogglePlayerHighlight"));
	...
	void UAC_Highlight_C::OnUnhighlighted__DelegateSignature(class ABP_GameController_C* Controller)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Highlight.AC_Highlight_C.OnUnhighlighted__DelegateSignature"));
	...
	void UAC_Highlight_C::OnHighlighted__DelegateSignature(class ABP_GameController_C* Controller)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Highlight.AC_Highlight_C.OnHighlighted__DelegateSignature"));
	...
	UClass* UAC_Highlight_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass AC_Highlight.AC_Highlight_C"));
		return ptr;
	}
