...
namespace CG
{
	...
	void UAC_Magnet_C::NewItem(class ABP_ParentItem_C* Item)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Magnet.AC_Magnet_C.NewItem"));
	...
	void UAC_Magnet_C::RemoveItem(class ABP_ParentItem_C* Item)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Magnet.AC_Magnet_C.RemoveItem"));
	...
	void UAC_Magnet_C::StartMagnet(class USceneComponent* AttractLocation)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Magnet.AC_Magnet_C.StartMagnet"));
	...
	void UAC_Magnet_C::StopMagnet()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Magnet.AC_Magnet_C.StopMagnet"));
	...
	void UAC_Magnet_C::MagnetTimer()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Magnet.AC_Magnet_C.MagnetTimer"));
	...
	void UAC_Magnet_C::PrepItemsMag()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Magnet.AC_Magnet_C.PrepItemsMag"));
	...
	void UAC_Magnet_C::PrepItemsDrop()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Magnet.AC_Magnet_C.PrepItemsDrop"));
	...
	void UAC_Magnet_C::ExecuteUbergraph_AC_Magnet(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_Magnet.AC_Magnet_C.ExecuteUbergraph_AC_Magnet"));
	...
	UClass* UAC_Magnet_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass AC_Magnet.AC_Magnet_C"));
		return ptr;
	}
