...
namespace CG
{
	...
	void UAC_StoreFunctions_C::CalcWeight(TArray<class ABP_ParentResource_C*>* Resources, float* Weight)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_StoreFunctions.AC_StoreFunctions_C.CalcWeight"));
	...
	void UAC_StoreFunctions_C::CalcPrice(TArray<class ABP_ParentResource_C*>* Array, int32_t* Total)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_StoreFunctions.AC_StoreFunctions_C.CalcPrice"));
	...
	void UAC_StoreFunctions_C::CalculateCraftedPrice(class ABP_ParentCraftedResource_C* CraftedItem, int32_t* Price)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_StoreFunctions.AC_StoreFunctions_C.CalculateCraftedPrice"));
	...
	void UAC_StoreFunctions_C::CalculateFishPrice(class ABP_CaughtFish_C* Fish, int32_t* Cost)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_StoreFunctions.AC_StoreFunctions_C.CalculateFishPrice"));
	...
	void UAC_StoreFunctions_C::ReplaceCoinsWithNewValue(int32_t NewValue, const struct FTransform& SpawnLocation)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_StoreFunctions.AC_StoreFunctions_C.ReplaceCoinsWithNewValue"));
	...
	void UAC_StoreFunctions_C::GetTotalCoinValue(int32_t* Price)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AC_StoreFunctions.AC_StoreFunctions_C.GetTotalCoinValue"));
	...
	UClass* UAC_StoreFunctions_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass AC_StoreFunctions.AC_StoreFunctions_C"));
		return ptr;
	}
