...
namespace CG
{
	...
	UClass* UAudioAnalyzerAsset::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class AudioAnalyzer.AudioAnalyzerAsset"));
		return ptr;
	}
	...
	UClass* UAudioAnalyzerNRTSettings::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class AudioAnalyzer.AudioAnalyzerNRTSettings"));
		return ptr;
	}
	...
	UClass* UAudioAnalyzerNRT::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class AudioAnalyzer.AudioAnalyzerNRT"));
		return ptr;
	}
