...
namespace CG
{
	...
	void UInputLabel::UpdateLabel()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputLabel.UpdateLabel"));
	...
	void UInputLabel::MappingsChanged(class APlayerController* Player)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputLabel.MappingsChanged"));
	...
	UClass* UInputLabel::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class AutoSettingsInput.InputLabel"));
		return ptr;
	}
	...
	UClass* UActionLabel::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class AutoSettingsInput.ActionLabel"));
		return ptr;
	}
	...
	void UInputMapping::UpdateMapping()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputMapping.UpdateMapping"));
	...
	void UInputMapping::UpdateLabel()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputMapping.UpdateLabel"));
	...
	void UInputMapping::ChordCaptured(const struct FCapturedInput& CapturedInput)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputMapping.ChordCaptured"));
	...
	void UInputMapping::BindChord(const struct FCapturedInput& CapturedInput)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputMapping.BindChord"));
	...
	UClass* UInputMapping::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class AutoSettingsInput.InputMapping"));
		return ptr;
	}
	...
	UClass* UActionMapping::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class AutoSettingsInput.ActionMapping"));
		return ptr;
	}
	...
	UClass* UAutoSettingsInputConfig::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class AutoSettingsInput.AutoSettingsInputConfig"));
		return ptr;
	}
	...
	UClass* UAutoSettingsInputConfigInterface::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class AutoSettingsInput.AutoSettingsInputConfigInterface"));
		return ptr;
	}
	...
	TArray<class UTexture*> UAutoSettingsInputProjectConfig::LoadKeyIcons(const struct FGameplayTagContainer& KeyIconTags)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.AutoSettingsInputProjectConfig.LoadKeyIcons"));
	...
	struct FGameplayTag UAutoSettingsInputProjectConfig::GetKeyGroupStatic(const struct FKey& Key)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.AutoSettingsInputProjectConfig.GetKeyGroupStatic"));
	...
	class FText UAutoSettingsInputProjectConfig::GetKeyFriendlyNameStatic(const struct FKey& Key)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.AutoSettingsInputProjectConfig.GetKeyFriendlyNameStatic"));
	...
	UClass* UAutoSettingsInputProjectConfig::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class AutoSettingsInput.AutoSettingsInputProjectConfig"));
		return ptr;
	}
	...
	UClass* UAutoSettingsInputSubsystem::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class AutoSettingsInput.AutoSettingsInputSubsystem"));
		return ptr;
	}
	...
	UClass* UAutoSettingsInputValidationSubsystem::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class AutoSettingsInput.AutoSettingsInputValidationSubsystem"));
		return ptr;
	}
	...
	void UAutoSettingsPlayer::SaveInputMappings(const struct FPlayerInputMappings& InputMappings)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.AutoSettingsPlayer.SaveInputMappings"));
	...
	class FString UAutoSettingsPlayer::GetUniquePlayerIdentifier()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.AutoSettingsPlayer.GetUniquePlayerIdentifier"));
	...
	bool UAutoSettingsPlayer::GetInputMappings(struct FPlayerInputMappings* InputMappings)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.AutoSettingsPlayer.GetInputMappings"));
	...
	struct FInputMappingPreset UAutoSettingsPlayer::GetDefaultInputMappingPreset()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.AutoSettingsPlayer.GetDefaultInputMappingPreset"));
	...
	UClass* UAutoSettingsPlayer::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class AutoSettingsInput.AutoSettingsPlayer"));
		return ptr;
	}
	...
	UClass* UAxisLabel::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class AutoSettingsInput.AxisLabel"));
		return ptr;
	}
	...
	UClass* UAxisMapping::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class AutoSettingsInput.AxisMapping"));
		return ptr;
	}
	...
	class UBindCapturePrompt* UBindCaptureButton::StartCapture()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.BindCaptureButton.StartCapture"));
	...
	void UBindCaptureButton::InitializePrompt(class UBindCapturePrompt* PromptWidget)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.BindCaptureButton.InitializePrompt"));
	...
	void UBindCaptureButton::ChordCaptured(const struct FCapturedInput& CapturedInput)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.BindCaptureButton.ChordCaptured"));
	...
	UClass* UBindCaptureButton::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class AutoSettingsInput.BindCaptureButton"));
		return ptr;
	}
	...
	bool UBindCapturePrompt::IsKeyAllowed(const struct FKey& PrimaryKey)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.BindCapturePrompt.IsKeyAllowed"));
	...
	struct FGameplayTag UBindCapturePrompt::GetKeyGroup()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.BindCapturePrompt.GetKeyGroup"));
	...
	void UBindCapturePrompt::Cancel()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.BindCapturePrompt.Cancel"));
	...
	UClass* UBindCapturePrompt::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class AutoSettingsInput.BindCapturePrompt"));
		return ptr;
	}
	...
	void UGlobalKeyIconTagManager::SetGlobalKeyIconTags(const struct FGameplayTagContainer& InGlobalIconTags)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.GlobalKeyIconTagManager.SetGlobalKeyIconTags"));
	...
	class UTexture* UGlobalKeyIconTagManager::GetIconForKey(const struct FKey& InKey, const struct FGameplayTagContainer& IconTags, float AxisScale)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.GlobalKeyIconTagManager.GetIconForKey"));
	...
	UClass* UGlobalKeyIconTagManager::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class AutoSettingsInput.GlobalKeyIconTagManager"));
		return ptr;
	}
	...
	void UInputMappingManager::SetPlayerKeyGroupStatic(class APlayerController* Player, const struct FGameplayTag& KeyGroup)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputMappingManager.SetPlayerKeyGroupStatic"));
	...
	void UInputMappingManager::SetPlayerInputPresetStatic(class APlayerController* Player, const struct FInputMappingPreset& Preset)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputMappingManager.SetPlayerInputPresetStatic"));
	...
	void UInputMappingManager::SetPlayerInputPresetByTag(class APlayerController* Player, const struct FGameplayTag& PresetTag)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputMappingManager.SetPlayerInputPresetByTag"));
	...
	void UInputMappingManager::OnRegisteredPlayerControllerDestroyed(class AActor* DestroyedActor)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputMappingManager.OnRegisteredPlayerControllerDestroyed"));
	...
	bool UInputMappingManager::InitializePlayerInputOverridesStatic(class APlayerController* Player)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputMappingManager.InitializePlayerInputOverridesStatic"));
	...
	void UInputMappingManager::GetPlayerMappingsByKey(class APlayerController* Player, const struct FKey& Key, TArray<struct FInputActionKeyMapping>* Actions, TArray<struct FInputAxisKeyMapping>* Axes)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputMappingManager.GetPlayerMappingsByKey"));
	...
	struct FPlayerInputMappings UInputMappingManager::GetPlayerInputMappingsStatic(class APlayerController* Player)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputMappingManager.GetPlayerInputMappingsStatic"));
	...
	struct FInputAxisKeyMapping UInputMappingManager::GetPlayerAxisMappingStatic(class APlayerController* Player, const class FName& AxisName, float Scale, int32_t MappingGroup)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputMappingManager.GetPlayerAxisMappingStatic"));
	...
	TArray<struct FInputAxisKeyMapping> UInputMappingManager::GetPlayerAxisMappings(class APlayerController* Player, const class FName& AxisName, float Scale, int32_t MappingGroup, const struct FGameplayTag& KeyGroup, bool bUsePlayerKeyGroup)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputMappingManager.GetPlayerAxisMappings"));
	...
	struct FInputAxisKeyMapping UInputMappingManager::GetPlayerAxisMapping(class APlayerController* Player, const class FName& AxisName, float Scale, int32_t MappingGroup, const struct FGameplayTag& KeyGroup, bool bUsePlayerKeyGroup)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputMappingManager.GetPlayerAxisMapping"));
	...
	struct FInputActionKeyMapping UInputMappingManager::GetPlayerActionMappingStatic(class APlayerController* Player, const class FName& ActionName, int32_t MappingGroup)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputMappingManager.GetPlayerActionMappingStatic"));
	...
	TArray<struct FInputActionKeyMapping> UInputMappingManager::GetPlayerActionMappings(class APlayerController* Player, const class FName& ActionName, int32_t MappingGroup, const struct FGameplayTag& KeyGroup, bool bUsePlayerKeyGroup)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputMappingManager.GetPlayerActionMappings"));
	...
	struct FInputActionKeyMapping UInputMappingManager::GetPlayerActionMapping(class APlayerController* Player, const class FName& ActionName, int32_t MappingGroup, const struct FGameplayTag& KeyGroup, bool bUsePlayerKeyGroup)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputMappingManager.GetPlayerActionMapping"));
	...
	TArray<struct FInputMappingPreset> UInputMappingManager::GetDefaultInputPresets()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputMappingManager.GetDefaultInputPresets"));
	...
	void UInputMappingManager::AddPlayerAxisOverrideStatic(class APlayerController* Player, const struct FInputAxisKeyMapping& NewMapping, int32_t MappingGroup, bool bAnyKeyGroup)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputMappingManager.AddPlayerAxisOverrideStatic"));
	...
	void UInputMappingManager::AddPlayerAxisOverride(class APlayerController* Player, const struct FInputAxisKeyMapping& NewMapping, int32_t MappingGroup, bool bAnyKeyGroup)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputMappingManager.AddPlayerAxisOverride"));
	...
	void UInputMappingManager::AddPlayerActionOverrideStatic(class APlayerController* Player, const struct FInputActionKeyMapping& NewMapping, int32_t MappingGroup, bool bAnyKeyGroup)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputMappingManager.AddPlayerActionOverrideStatic"));
	...
	void UInputMappingManager::AddPlayerActionOverride(class APlayerController* Player, const struct FInputActionKeyMapping& NewMapping, int32_t MappingGroup, bool bAnyKeyGroup)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.InputMappingManager.AddPlayerActionOverride"));
	...
	UClass* UInputMappingManager::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class AutoSettingsInput.InputMappingManager"));
		return ptr;
	}
	...
	void UKeyLabel::UpdateKeyLabel()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.KeyLabel.UpdateKeyLabel"));
	...
	void UKeyLabel::OnGlobalKeyIconTagsModified()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.KeyLabel.OnGlobalKeyIconTagsModified"));
	...
	bool UKeyLabel::HasValidKey()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.KeyLabel.HasValidKey"));
	...
	bool UKeyLabel::HasIcon()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.KeyLabel.HasIcon"));
	...
	UMG_ESlateVisibility UKeyLabel::GetIconVisibility()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.KeyLabel.GetIconVisibility"));
	...
	struct FSlateBrush UKeyLabel::GetIconBrush()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.KeyLabel.GetIconBrush"));
	...
	class UTexture* UKeyLabel::GetIcon()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.KeyLabel.GetIcon"));
	...
	UMG_ESlateVisibility UKeyLabel::GetDisplayNameVisibility()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.KeyLabel.GetDisplayNameVisibility"));
	...
	class FText UKeyLabel::GetDisplayName()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function AutoSettingsInput.KeyLabel.GetDisplayName"));
	...
	UClass* UKeyLabel::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class AutoSettingsInput.KeyLabel"));
		return ptr;
	}
