...
namespace CG
{
	...
	void UBPI_Interact_C::BPI_Unhighlight(class ABP_GameController_C* Controller)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BPI_Interact.BPI_Interact_C.BPI_Unhighlight"));
	...
	void UBPI_Interact_C::BPI_Highlight(class ABP_GameController_C* Controller)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BPI_Interact.BPI_Interact_C.BPI_Highlight"));
	...
	void UBPI_Interact_C::BPI_GetCanHighlight(bool* CanHighlight_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BPI_Interact.BPI_Interact_C.BPI_GetCanHighlight"));
	...
	void UBPI_Interact_C::BPI_SetHighlightArray(TArray<int32_t>* HighlightArray, bool* Result)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BPI_Interact.BPI_Interact_C.BPI_SetHighlightArray"));
	...
	void UBPI_Interact_C::BPI_GetHighlightArray(TArray<int32_t>* HighlightArray)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BPI_Interact.BPI_Interact_C.BPI_GetHighlightArray"));
	...
	UClass* UBPI_Interact_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BPI_Interact.BPI_Interact_C"));
		return ptr;
	}
