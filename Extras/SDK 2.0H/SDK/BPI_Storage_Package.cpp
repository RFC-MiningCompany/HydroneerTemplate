...
namespace CG
{
	...
	void UBPI_Storage_C::StoredItemPickedUp(class ABP_ParentItem_C* ItemPickedUp)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BPI_Storage.BPI_Storage_C.StoredItemPickedUp"));
	...
	void UBPI_Storage_C::ItemStored(class ABP_ParentItem_C* Item)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BPI_Storage.BPI_Storage_C.ItemStored"));
	...
	UClass* UBPI_Storage_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BPI_Storage.BPI_Storage_C"));
		return ptr;
	}
