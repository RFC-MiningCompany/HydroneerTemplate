...
namespace CG
{
	...
	void UBPI_Vehicle_C::ExitVehicle()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BPI_Vehicle.BPI_Vehicle_C.ExitVehicle"));
	...
	void UBPI_Vehicle_C::EnterVehicle(class APawn* Pawn)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BPI_Vehicle.BPI_Vehicle_C.EnterVehicle"));
	...
	UClass* UBPI_Vehicle_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BPI_Vehicle.BPI_Vehicle_C"));
		return ptr;
	}
