...
namespace CG
{
	...
	void ABP_BedFancy_C::Dummy()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_BedFancy.BP_BedFancy_C.Dummy"));
	...
	void ABP_BedFancy_C::InpActEvt_M_K2Node_InputKeyEvent_2(const struct FKey& Key)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_BedFancy.BP_BedFancy_C.InpActEvt_M_K2Node_InputKeyEvent_2"));
	...
	void ABP_BedFancy_C::InpActEvt_F_K2Node_InputKeyEvent_1(const struct FKey& Key)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_BedFancy.BP_BedFancy_C.InpActEvt_F_K2Node_InputKeyEvent_1"));
	...
	void ABP_BedFancy_C::ReceiveBeginPlay()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_BedFancy.BP_BedFancy_C.ReceiveBeginPlay"));
	...
	void ABP_BedFancy_C::ReceiveActorBeginOverlap(class AActor* OtherActor)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_BedFancy.BP_BedFancy_C.ReceiveActorBeginOverlap"));
	...
	void ABP_BedFancy_C::ReceiveTick(float DeltaSeconds)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_BedFancy.BP_BedFancy_C.ReceiveTick"));
	...
	void ABP_BedFancy_C::ExecuteUbergraph_BP_BedFancy(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_BedFancy.BP_BedFancy_C.ExecuteUbergraph_BP_BedFancy"));
	...
	UClass* ABP_BedFancy_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_BedFancy.BP_BedFancy_C"));
		return ptr;
	}
