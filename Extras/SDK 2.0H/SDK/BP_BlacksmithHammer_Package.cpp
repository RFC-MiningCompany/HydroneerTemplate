...
namespace CG
{
	...
	void ABP_BlacksmithHammer_C::LMBDownWhileCarrying(class ABP_GameController_C* Controller, class AActor* HitActor, const struct FVector& HitLocation, bool* ConsumeInput_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_BlacksmithHammer.BP_BlacksmithHammer_C.LMBDownWhileCarrying"));
	...
	UClass* ABP_BlacksmithHammer_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_BlacksmithHammer.BP_BlacksmithHammer_C"));
		return ptr;
	}
