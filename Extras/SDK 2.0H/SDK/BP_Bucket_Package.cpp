...
namespace CG
{
	...
	void ABP_Bucket_C::LMBDownWhileCarrying(class ABP_GameController_C* Controller, class AActor* HitActor, const struct FVector& HitLocation, bool* ConsumeInput_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Bucket.BP_Bucket_C.LMBDownWhileCarrying"));
	...
	void ABP_Bucket_C::OverlappedDirtParticle(class ABP_DirtResource_C* InputPin)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Bucket.BP_Bucket_C.OverlappedDirtParticle"));
	...
	void ABP_Bucket_C::WaterParticleHit()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Bucket.BP_Bucket_C.WaterParticleHit"));
	...
	void ABP_Bucket_C::BndEvt__Cylinder_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Bucket.BP_Bucket_C.BndEvt__Cylinder_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
	...
	void ABP_Bucket_C::AddDirt(int32_t DirtQuality, int32_t DirtLoads)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Bucket.BP_Bucket_C.AddDirt"));
	...
	void ABP_Bucket_C::EmptyDirt()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Bucket.BP_Bucket_C.EmptyDirt"));
	...
	void ABP_Bucket_C::Empty_Water()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Bucket.BP_Bucket_C.Empty Water"));
	...
	void ABP_Bucket_C::EmptyDirtNoAnim()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Bucket.BP_Bucket_C.EmptyDirtNoAnim"));
	...
	void ABP_Bucket_C::InWater()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Bucket.BP_Bucket_C.InWater"));
	...
	void ABP_Bucket_C::ChangeDirtMesh(bool bNewVisibility)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Bucket.BP_Bucket_C.ChangeDirtMesh"));
	...
	void ABP_Bucket_C::OverridePickedup()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Bucket.BP_Bucket_C.OverridePickedup"));
	...
	void ABP_Bucket_C::BndEvt__BP_Bucket_Cylinder_K2Node_ComponentBoundEvent_0_ComponentEndOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Bucket.BP_Bucket_C.BndEvt__BP_Bucket_Cylinder_K2Node_ComponentBoundEvent_0_ComponentEndOverlapSignature__DelegateSignature"));
	...
	void ABP_Bucket_C::Empty()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Bucket.BP_Bucket_C.Empty"));
	...
	void ABP_Bucket_C::ExecuteUbergraph_BP_Bucket(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Bucket.BP_Bucket_C.ExecuteUbergraph_BP_Bucket"));
	...
	UClass* ABP_Bucket_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_Bucket.BP_Bucket_C"));
		return ptr;
	}
