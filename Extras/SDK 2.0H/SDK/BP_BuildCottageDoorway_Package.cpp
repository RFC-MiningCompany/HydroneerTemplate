...
namespace CG
{
	...
	void ABP_BuildCottageDoorway_C::LMBDownIsTarget(class UPrimitiveComponent* Component, class ABP_ParentItem_C* CarryingItem, class ABP_GameController_C* Insigator)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_BuildCottageDoorway.BP_BuildCottageDoorway_C.LMBDownIsTarget"));
	...
	void ABP_BuildCottageDoorway_C::ExecuteUbergraph_BP_BuildCottageDoorway(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_BuildCottageDoorway.BP_BuildCottageDoorway_C.ExecuteUbergraph_BP_BuildCottageDoorway"));
	...
	UClass* ABP_BuildCottageDoorway_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_BuildCottageDoorway.BP_BuildCottageDoorway_C"));
		return ptr;
	}
