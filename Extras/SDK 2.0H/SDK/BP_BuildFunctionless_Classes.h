...
namespace CG
{
	...
	public:
		...
		E_Functionless_E_Functionless                              ItemName;                                                // 0x0390(0x0001) Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash
