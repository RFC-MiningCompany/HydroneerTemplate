...
namespace CG
{
	...
	void ABP_BuildFunctionless_C::CreateProxyItem()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_BuildFunctionless.BP_BuildFunctionless_C.CreateProxyItem"));
	...
	void ABP_BuildFunctionless_C::InitFunctionless()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_BuildFunctionless.BP_BuildFunctionless_C.InitFunctionless"));
	...
	void ABP_BuildFunctionless_C::UserConstructionScript()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_BuildFunctionless.BP_BuildFunctionless_C.UserConstructionScript"));
	...
	void ABP_BuildFunctionless_C::ActorLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_BuildFunctionless.BP_BuildFunctionless_C.ActorLoaded"));
	...
	void ABP_BuildFunctionless_C::ExecuteUbergraph_BP_BuildFunctionless(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_BuildFunctionless.BP_BuildFunctionless_C.ExecuteUbergraph_BP_BuildFunctionless"));
	...
	UClass* ABP_BuildFunctionless_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_BuildFunctionless.BP_BuildFunctionless_C"));
		return ptr;
	}
