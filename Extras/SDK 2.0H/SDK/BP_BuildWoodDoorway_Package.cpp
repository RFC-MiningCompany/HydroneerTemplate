...
namespace CG
{
	...
	void ABP_BuildWoodDoorway_C::LMBDownIsTarget(class UPrimitiveComponent* Component, class ABP_ParentItem_C* CarryingItem, class ABP_GameController_C* Insigator)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_BuildWoodDoorway.BP_BuildWoodDoorway_C.LMBDownIsTarget"));
	...
	void ABP_BuildWoodDoorway_C::ExecuteUbergraph_BP_BuildWoodDoorway(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_BuildWoodDoorway.BP_BuildWoodDoorway_C.ExecuteUbergraph_BP_BuildWoodDoorway"));
	...
	UClass* ABP_BuildWoodDoorway_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_BuildWoodDoorway.BP_BuildWoodDoorway_C"));
		return ptr;
	}
