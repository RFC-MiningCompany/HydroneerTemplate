...
namespace CG
{
	...
	void ABP_Clouds_C::UserConstructionScript()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Clouds.BP_Clouds_C.UserConstructionScript"));
	...
	UClass* ABP_Clouds_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_Clouds.BP_Clouds_C"));
		return ptr;
	}
