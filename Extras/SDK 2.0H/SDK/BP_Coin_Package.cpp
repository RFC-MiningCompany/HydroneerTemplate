...
namespace CG
{
	...
	void ABP_Coin_C::CombineCoins(class ABP_Coin_C* OtherCoins)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Coin.BP_Coin_C.CombineCoins"));
	...
	void ABP_Coin_C::UserConstructionScript()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Coin.BP_Coin_C.UserConstructionScript"));
	...
	void ABP_Coin_C::CheckForCostumeChange()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Coin.BP_Coin_C.CheckForCostumeChange"));
	...
	void ABP_Coin_C::RemoveCoins(int32_t AmountToRemove)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Coin.BP_Coin_C.RemoveCoins"));
	...
	void ABP_Coin_C::PlayCoinSound()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Coin.BP_Coin_C.PlayCoinSound"));
	...
	void ABP_Coin_C::ReceiveBeginPlay()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Coin.BP_Coin_C.ReceiveBeginPlay"));
	...
	void ABP_Coin_C::RestackCoins(TArray<class ABP_Coin_C*> Coins)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Coin.BP_Coin_C.RestackCoins"));
	...
	void ABP_Coin_C::OverrideLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Coin.BP_Coin_C.OverrideLoaded"));
	...
	void ABP_Coin_C::OverrideHighlighted()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Coin.BP_Coin_C.OverrideHighlighted"));
	...
	void ABP_Coin_C::OverrideUnhighlighted()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Coin.BP_Coin_C.OverrideUnhighlighted"));
	...
	void ABP_Coin_C::OverrideHit(class AActor* OtherActor)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Coin.BP_Coin_C.OverrideHit"));
	...
	void ABP_Coin_C::ExecuteUbergraph_BP_Coin(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Coin.BP_Coin_C.ExecuteUbergraph_BP_Coin"));
	...
	UClass* ABP_Coin_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_Coin.BP_Coin_C"));
		return ptr;
	}
