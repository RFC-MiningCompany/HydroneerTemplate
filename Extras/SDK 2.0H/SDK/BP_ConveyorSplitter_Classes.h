...
namespace CG
{
	 ...
	 * Size -> 0x0068 (FullSize[0x0440] - InheritedSize[0x03D8])
	 */
	...
	public:
		...
		class UBoxComponent*                                       SplitBox;                                                // 0x03F0(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
		class UBoxComponent*                                       StraightBox;                                             // 0x03F8(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
		...
		TArray<class ABP_ParentItem_C*>                            ItemsToSplit;                                            // 0x0418(0x0010) Edit, BlueprintVisible, DisableEditOnTemplate, DisableEditOnInstance
		...
		TArray<class UClass*>                                      TestClasses;                                             // 0x0430(0x0010) Edit, BlueprintVisible, DisableEditOnInstance
