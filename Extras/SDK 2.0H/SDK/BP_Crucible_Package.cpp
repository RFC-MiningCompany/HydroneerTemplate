...
namespace CG
{
	...
	void ABP_Crucible_C::LMBDownWhileCarrying(class ABP_GameController_C* Controller, class AActor* HitActor, const struct FVector& HitLocation, bool* ConsumeInput_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Crucible.BP_Crucible_C.LMBDownWhileCarrying"));
	...
	void ABP_Crucible_C::LoopResourcesForTargets(class UClass* Ore, class UClass* Bar, TArray<class ABP_ParentResource_C*>* Items)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Crucible.BP_Crucible_C.LoopResourcesForTargets"));
	 ...
	 * 		Flags  -> ()
	 * Parameters:
	 * 		E_MetalType_E_MetalType                            CurrentMoltenType                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 ...
	 */
	void ABP_Crucible_C::FindTestClass(E_MetalType_E_MetalType CurrentMoltenType, TArray<class ABP_ParentResource_C*>* Class, int32_t* BarOut)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Crucible.BP_Crucible_C.FindTestClass"));
		
		struct
		{
			E_MetalType_E_MetalType                            CurrentMoltenType;
	...
	void ABP_Crucible_C::UserConstructionScript()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Crucible.BP_Crucible_C.UserConstructionScript"));
	...
	void ABP_Crucible_C::StoredItemPickedUp(class ABP_ParentItem_C* ItemPickedUp)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Crucible.BP_Crucible_C.StoredItemPickedUp"));
	...
	void ABP_Crucible_C::WaterParticleHit()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Crucible.BP_Crucible_C.WaterParticleHit"));
	...
	void ABP_Crucible_C::BndEvt__Cylinder_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Crucible.BP_Crucible_C.BndEvt__Cylinder_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
	...
	void ABP_Crucible_C::SpawnBar(class ABP_Mould_C* Mould)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Crucible.BP_Crucible_C.SpawnBar"));
	...
	void ABP_Crucible_C::PlayPourAnim()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Crucible.BP_Crucible_C.PlayPourAnim"));
	...
	void ABP_Crucible_C::OverrideLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Crucible.BP_Crucible_C.OverrideLoaded"));
	...
	void ABP_Crucible_C::UpdateVisuals()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Crucible.BP_Crucible_C.UpdateVisuals"));
	...
	void ABP_Crucible_C::HeatUpdated(float Heat)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Crucible.BP_Crucible_C.HeatUpdated"));
	...
	void ABP_Crucible_C::FullHeat()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Crucible.BP_Crucible_C.FullHeat"));
	...
	void ABP_Crucible_C::InFire()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Crucible.BP_Crucible_C.InFire"));
	...
	void ABP_Crucible_C::OutOfFire()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Crucible.BP_Crucible_C.OutOfFire"));
	...
	void ABP_Crucible_C::InWater()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Crucible.BP_Crucible_C.InWater"));
	...
	void ABP_Crucible_C::ItemStored(class ABP_ParentItem_C* Item)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Crucible.BP_Crucible_C.ItemStored"));
	...
	void ABP_Crucible_C::BndEvt__BP_Crucible_Cylinder_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Crucible.BP_Crucible_C.BndEvt__BP_Crucible_Cylinder_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature"));
	...
	void ABP_Crucible_C::ExecuteUbergraph_BP_Crucible(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Crucible.BP_Crucible_C.ExecuteUbergraph_BP_Crucible"));
	...
	UClass* ABP_Crucible_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_Crucible.BP_Crucible_C"));
		return ptr;
	}
