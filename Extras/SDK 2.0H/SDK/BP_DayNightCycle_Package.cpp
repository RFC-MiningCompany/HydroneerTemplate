...
namespace CG
{
	...
	void ABP_DayNightCycle_C::ComponentsToSave(TArray<class UActorComponent*>* Components)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.ComponentsToSave"));
	...
	void ABP_DayNightCycle_C::SetDayModePostLoad()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.SetDayModePostLoad"));
	...
	void ABP_DayNightCycle_C::SetDayMode()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.SetDayMode"));
	...
	void ABP_DayNightCycle_C::ActorSaved()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.ActorSaved"));
	...
	void ABP_DayNightCycle_C::ReceiveBeginPlay()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.ReceiveBeginPlay"));
	...
	void ABP_DayNightCycle_C::ActorPreSave()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.ActorPreSave"));
	...
	void ABP_DayNightCycle_C::SpeedUpToSunrise(class ABP_ParentBed_C* Bed, class ABP_GameController_C* Controller)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.SpeedUpToSunrise"));
	...
	void ABP_DayNightCycle_C::SunRiseTimerCheck()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.SunRiseTimerCheck"));
	...
	void ABP_DayNightCycle_C::SetNewRate()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.SetNewRate"));
	...
	void ABP_DayNightCycle_C::Update()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.Update"));
	...
	void ABP_DayNightCycle_C::ActorLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.ActorLoaded"));
	...
	void ABP_DayNightCycle_C::ExecuteUbergraph_BP_DayNightCycle(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_DayNightCycle.BP_DayNightCycle_C.ExecuteUbergraph_BP_DayNightCycle"));
	...
	UClass* ABP_DayNightCycle_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_DayNightCycle.BP_DayNightCycle_C"));
		return ptr;
	}
