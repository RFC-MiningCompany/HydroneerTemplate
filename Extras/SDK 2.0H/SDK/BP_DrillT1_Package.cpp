...
namespace CG
{
	...
	void ABP_DrillT1_C::OverridePlayOneShotAnim()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_DrillT1.BP_DrillT1_C.OverridePlayOneShotAnim"));
	...
	void ABP_DrillT1_C::ExecuteUbergraph_BP_DrillT1(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_DrillT1.BP_DrillT1_C.ExecuteUbergraph_BP_DrillT1"));
	...
	UClass* ABP_DrillT1_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_DrillT1.BP_DrillT1_C"));
		return ptr;
	}
