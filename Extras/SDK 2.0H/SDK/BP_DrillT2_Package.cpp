...
namespace CG
{
	...
	void ABP_DrillT2_C::OverrideDrillStart()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_DrillT2.BP_DrillT2_C.OverrideDrillStart"));
	...
	void ABP_DrillT2_C::OverrideDrillStop()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_DrillT2.BP_DrillT2_C.OverrideDrillStop"));
	...
	void ABP_DrillT2_C::AnimTimer()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_DrillT2.BP_DrillT2_C.AnimTimer"));
	...
	void ABP_DrillT2_C::ExecuteUbergraph_BP_DrillT2(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_DrillT2.BP_DrillT2_C.ExecuteUbergraph_BP_DrillT2"));
	...
	UClass* ABP_DrillT2_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_DrillT2.BP_DrillT2_C"));
		return ptr;
	}
