...
namespace CG
{
	...
	void ABP_Dummy_HydroGuy_C::DummyHighlight(bool Highlight_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Dummy_HydroGuy.BP_Dummy_HydroGuy_C.DummyHighlight"));
	...
	void ABP_Dummy_HydroGuy_C::SetRenderTarget(class UTextureRenderTarget2D* RenderTarget)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Dummy_HydroGuy.BP_Dummy_HydroGuy_C.SetRenderTarget"));
	...
	void ABP_Dummy_HydroGuy_C::ToggleFrameCapture(bool Capture_Every_Frame)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Dummy_HydroGuy.BP_Dummy_HydroGuy_C.ToggleFrameCapture"));
	...
	void ABP_Dummy_HydroGuy_C::UserConstructionScript()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Dummy_HydroGuy.BP_Dummy_HydroGuy_C.UserConstructionScript"));
	...
	void ABP_Dummy_HydroGuy_C::ReceiveBeginPlay()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Dummy_HydroGuy.BP_Dummy_HydroGuy_C.ReceiveBeginPlay"));
	...
	void ABP_Dummy_HydroGuy_C::ReceiveTick(float DeltaSeconds)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Dummy_HydroGuy.BP_Dummy_HydroGuy_C.ReceiveTick"));
	...
	void ABP_Dummy_HydroGuy_C::ExecuteUbergraph_BP_Dummy_HydroGuy(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Dummy_HydroGuy.BP_Dummy_HydroGuy_C.ExecuteUbergraph_BP_Dummy_HydroGuy"));
	...
	UClass* ABP_Dummy_HydroGuy_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_Dummy_HydroGuy.BP_Dummy_HydroGuy_C"));
		return ptr;
	}
