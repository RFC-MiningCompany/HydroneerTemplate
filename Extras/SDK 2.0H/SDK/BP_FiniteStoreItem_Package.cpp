...
namespace CG
{
	...
	void ABP_FiniteStoreItem_C::ComponentsToSave(TArray<class UActorComponent*>* Components)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_FiniteStoreItem.BP_FiniteStoreItem_C.ComponentsToSave"));
	...
	void ABP_FiniteStoreItem_C::ActorPreSave()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_FiniteStoreItem.BP_FiniteStoreItem_C.ActorPreSave"));
	...
	void ABP_FiniteStoreItem_C::ActorSaved()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_FiniteStoreItem.BP_FiniteStoreItem_C.ActorSaved"));
	...
	void ABP_FiniteStoreItem_C::ItemStored(class ABP_ParentItem_C* Item)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_FiniteStoreItem.BP_FiniteStoreItem_C.ItemStored"));
	...
	void ABP_FiniteStoreItem_C::ReceiveBeginPlay()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_FiniteStoreItem.BP_FiniteStoreItem_C.ReceiveBeginPlay"));
	...
	void ABP_FiniteStoreItem_C::StoredItemPickedUp(class ABP_ParentItem_C* ItemPickedUp)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_FiniteStoreItem.BP_FiniteStoreItem_C.StoredItemPickedUp"));
	...
	void ABP_FiniteStoreItem_C::RestockItem()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_FiniteStoreItem.BP_FiniteStoreItem_C.RestockItem"));
	...
	void ABP_FiniteStoreItem_C::CheckIfItemSold(TArray<class ABP_ParentItem_C*> Items)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_FiniteStoreItem.BP_FiniteStoreItem_C.CheckIfItemSold"));
	...
	void ABP_FiniteStoreItem_C::ActorLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_FiniteStoreItem.BP_FiniteStoreItem_C.ActorLoaded"));
	...
	void ABP_FiniteStoreItem_C::ExecuteUbergraph_BP_FiniteStoreItem(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_FiniteStoreItem.BP_FiniteStoreItem_C.ExecuteUbergraph_BP_FiniteStoreItem"));
	...
	UClass* ABP_FiniteStoreItem_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_FiniteStoreItem.BP_FiniteStoreItem_C"));
		return ptr;
	}
