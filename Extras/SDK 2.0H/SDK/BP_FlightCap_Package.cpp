...
namespace CG
{
	...
	void ABP_FlightCap_C::OverrideHatOn(class ABP_GameCharacter_C* Character)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_FlightCap.BP_FlightCap_C.OverrideHatOn"));
	...
	void ABP_FlightCap_C::OverrideHatOff(class ABP_GameCharacter_C* Character)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_FlightCap.BP_FlightCap_C.OverrideHatOff"));
	...
	void ABP_FlightCap_C::ExecuteUbergraph_BP_FlightCap(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_FlightCap.BP_FlightCap_C.ExecuteUbergraph_BP_FlightCap"));
	...
	UClass* ABP_FlightCap_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_FlightCap.BP_FlightCap_C"));
		return ptr;
	}
