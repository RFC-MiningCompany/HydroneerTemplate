...
namespace CG
{
	...
	void ABP_GravityTool_C::LMBDownWhileCarrying(class ABP_GameController_C* Controller, class AActor* HitActor, const struct FVector& HitLocation, bool* ConsumeInput_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_GravityTool.BP_GravityTool_C.LMBDownWhileCarrying"));
	...
	void ABP_GravityTool_C::UserConstructionScript()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_GravityTool.BP_GravityTool_C.UserConstructionScript"));
	...
	void ABP_GravityTool_C::Timeline_1__FinishedFunc()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_GravityTool.BP_GravityTool_C.Timeline_1__FinishedFunc"));
	...
	void ABP_GravityTool_C::Timeline_1__UpdateFunc()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_GravityTool.BP_GravityTool_C.Timeline_1__UpdateFunc"));
	...
	void ABP_GravityTool_C::Animate()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_GravityTool.BP_GravityTool_C.Animate"));
	...
	void ABP_GravityTool_C::OverrideDroppedItem(class ABP_GameCharacter_C* Character)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_GravityTool.BP_GravityTool_C.OverrideDroppedItem"));
	...
	void ABP_GravityTool_C::GravTimer()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_GravityTool.BP_GravityTool_C.GravTimer"));
	...
	void ABP_GravityTool_C::StopLiftingObject(bool Add_Velocity_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_GravityTool.BP_GravityTool_C.StopLiftingObject"));
	...
	void ABP_GravityTool_C::StartLiftingObject(class AActor* Object)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_GravityTool.BP_GravityTool_C.StartLiftingObject"));
	...
	void ABP_GravityTool_C::TurnOnHeat(bool Heat_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_GravityTool.BP_GravityTool_C.TurnOnHeat"));
	...
	void ABP_GravityTool_C::RMBDownWhileCarrying(class ABP_GameController_C* Controller, class AActor* Hit_Actor, const struct FVector& HitLocation)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_GravityTool.BP_GravityTool_C.RMBDownWhileCarrying"));
	...
	void ABP_GravityTool_C::LMBDown(class AActor* HitActor)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_GravityTool.BP_GravityTool_C.LMBDown"));
	...
	void ABP_GravityTool_C::ExecuteUbergraph_BP_GravityTool(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_GravityTool.BP_GravityTool_C.ExecuteUbergraph_BP_GravityTool"));
	...
	UClass* ABP_GravityTool_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_GravityTool.BP_GravityTool_C"));
		return ptr;
	}
