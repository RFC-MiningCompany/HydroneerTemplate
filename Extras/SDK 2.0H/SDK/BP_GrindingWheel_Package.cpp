...
namespace CG
{
	...
	void ABP_GrindingWheel_C::GrindGem(class ABP_ParentResource_C* UncutGem)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_GrindingWheel.BP_GrindingWheel_C.GrindGem"));
	...
	void ABP_GrindingWheel_C::SpinWheel()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_GrindingWheel.BP_GrindingWheel_C.SpinWheel"));
	...
	void ABP_GrindingWheel_C::LMBDownIsTarget(class UPrimitiveComponent* Component, class ABP_ParentItem_C* CarryingItem, class ABP_GameController_C* Insigator)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_GrindingWheel.BP_GrindingWheel_C.LMBDownIsTarget"));
	...
	void ABP_GrindingWheel_C::ExecuteUbergraph_BP_GrindingWheel(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_GrindingWheel.BP_GrindingWheel_C.ExecuteUbergraph_BP_GrindingWheel"));
	...
	UClass* ABP_GrindingWheel_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_GrindingWheel.BP_GrindingWheel_C"));
		return ptr;
	}
