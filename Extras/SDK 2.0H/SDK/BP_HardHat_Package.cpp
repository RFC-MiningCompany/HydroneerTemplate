...
namespace CG
{
	...
	void ABP_HardHat_C::OverrideHatOn(class ABP_GameCharacter_C* Character)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HardHat.BP_HardHat_C.OverrideHatOn"));
	...
	void ABP_HardHat_C::OverrideHatOff(class ABP_GameCharacter_C* Character)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HardHat.BP_HardHat_C.OverrideHatOff"));
	...
	void ABP_HardHat_C::ExecuteUbergraph_BP_HardHat(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HardHat.BP_HardHat_C.ExecuteUbergraph_BP_HardHat"));
	...
	UClass* ABP_HardHat_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_HardHat.BP_HardHat_C"));
		return ptr;
	}
