...
namespace CG
{
	...
	void ABP_HookFilter_C::ComponentsToSave(TArray<class UActorComponent*>* Components)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookFilter.BP_HookFilter_C.ComponentsToSave"));
	...
	void ABP_HookFilter_C::HookFunctionality(class ABP_ParentItem_C* HookedTo, class USceneComponent* Component, bool* CanPass_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookFilter.BP_HookFilter_C.HookFunctionality"));
	...
	void ABP_HookFilter_C::ReturnDurability(float DurabilityAmount)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookFilter.BP_HookFilter_C.ReturnDurability"));
	...
	void ABP_HookFilter_C::TryRepair(class ABP_ParentItem_C* RepairingTool)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookFilter.BP_HookFilter_C.TryRepair"));
	...
	void ABP_HookFilter_C::DoneRepair()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookFilter.BP_HookFilter_C.DoneRepair"));
	...
	void ABP_HookFilter_C::FindDurability(class ABP_ParentItem_C* Item)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookFilter.BP_HookFilter_C.FindDurability"));
	...
	void ABP_HookFilter_C::ExecuteUbergraph_BP_HookFilter(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookFilter.BP_HookFilter_C.ExecuteUbergraph_BP_HookFilter"));
	...
	UClass* ABP_HookFilter_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_HookFilter.BP_HookFilter_C"));
		return ptr;
	}
