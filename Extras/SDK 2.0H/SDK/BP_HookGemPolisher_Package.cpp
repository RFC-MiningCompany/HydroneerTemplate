...
namespace CG
{
	...
	void ABP_HookGemPolisher_C::SpawnGem(class UClass* GemClass, float Weight, class ABP_ParentItem_C* OldUncut)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookGemPolisher.BP_HookGemPolisher_C.SpawnGem"));
	...
	void ABP_HookGemPolisher_C::PolishTimer()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookGemPolisher.BP_HookGemPolisher_C.PolishTimer"));
	...
	void ABP_HookGemPolisher_C::HookFunctionality(class ABP_ParentItem_C* HookedTo, class USceneComponent* Component, bool* CanPass_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookGemPolisher.BP_HookGemPolisher_C.HookFunctionality"));
	...
	void ABP_HookGemPolisher_C::OverridePickedup()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookGemPolisher.BP_HookGemPolisher_C.OverridePickedup"));
	...
	void ABP_HookGemPolisher_C::OverrideParentNoWater()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookGemPolisher.BP_HookGemPolisher_C.OverrideParentNoWater"));
	...
	void ABP_HookGemPolisher_C::BndEvt__ShredBox_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookGemPolisher.BP_HookGemPolisher_C.BndEvt__ShredBox_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
	...
	void ABP_HookGemPolisher_C::ExecuteUbergraph_BP_HookGemPolisher(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookGemPolisher.BP_HookGemPolisher_C.ExecuteUbergraph_BP_HookGemPolisher"));
	...
	UClass* ABP_HookGemPolisher_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_HookGemPolisher.BP_HookGemPolisher_C"));
		return ptr;
	}
