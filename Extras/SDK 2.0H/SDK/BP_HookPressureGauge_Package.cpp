...
namespace CG
{
	...
	void ABP_HookPressureGauge_C::HookFunctionality(class ABP_ParentItem_C* HookedTo, class USceneComponent* Component, bool* CanPass_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookPressureGauge.BP_HookPressureGauge_C.HookFunctionality"));
	...
	void ABP_HookPressureGauge_C::ReceiveTick(float DeltaSeconds)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookPressureGauge.BP_HookPressureGauge_C.ReceiveTick"));
	...
	void ABP_HookPressureGauge_C::ExecuteUbergraph_BP_HookPressureGauge(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookPressureGauge.BP_HookPressureGauge_C.ExecuteUbergraph_BP_HookPressureGauge"));
	...
	UClass* ABP_HookPressureGauge_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_HookPressureGauge.BP_HookPressureGauge_C"));
		return ptr;
	}
