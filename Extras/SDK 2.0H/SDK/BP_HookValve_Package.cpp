...
namespace CG
{
	...
	void ABP_HookValve_C::HookFunctionality(class ABP_ParentItem_C* HookedTo, class USceneComponent* Component, bool* CanPass_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookValve.BP_HookValve_C.HookFunctionality"));
	...
	void ABP_HookValve_C::LMBDownIsTarget(class UPrimitiveComponent* Component, class ABP_ParentItem_C* CarryingItem, class ABP_GameController_C* Insigator)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookValve.BP_HookValve_C.LMBDownIsTarget"));
	...
	void ABP_HookValve_C::ActorLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookValve.BP_HookValve_C.ActorLoaded"));
	...
	void ABP_HookValve_C::ExecuteUbergraph_BP_HookValve(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookValve.BP_HookValve_C.ExecuteUbergraph_BP_HookValve"));
	...
	UClass* ABP_HookValve_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_HookValve.BP_HookValve_C"));
		return ptr;
	}
