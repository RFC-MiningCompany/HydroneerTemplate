...
namespace CG
{
	...
	void ABP_HydroVoxelWorld_C::ComponentsToSave(TArray<class UActorComponent*>* Components)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HydroVoxelWorld.BP_HydroVoxelWorld_C.ComponentsToSave"));
	...
	void ABP_HydroVoxelWorld_C::ActorPreSave()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HydroVoxelWorld.BP_HydroVoxelWorld_C.ActorPreSave"));
	...
	void ABP_HydroVoxelWorld_C::ActorLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HydroVoxelWorld.BP_HydroVoxelWorld_C.ActorLoaded"));
	...
	void ABP_HydroVoxelWorld_C::ActorSaved()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HydroVoxelWorld.BP_HydroVoxelWorld_C.ActorSaved"));
	...
	void ABP_HydroVoxelWorld_C::ExecuteUbergraph_BP_HydroVoxelWorld(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_HydroVoxelWorld.BP_HydroVoxelWorld_C.ExecuteUbergraph_BP_HydroVoxelWorld"));
	...
	UClass* ABP_HydroVoxelWorld_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_HydroVoxelWorld.BP_HydroVoxelWorld_C"));
		return ptr;
	}
