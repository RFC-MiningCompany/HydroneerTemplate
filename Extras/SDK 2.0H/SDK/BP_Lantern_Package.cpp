...
namespace CG
{
	...
	void ABP_Lantern_C::LMBDownWhileCarrying(class ABP_GameController_C* Controller, class AActor* HitActor, const struct FVector& HitLocation, bool* ConsumeInput_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Lantern.BP_Lantern_C.LMBDownWhileCarrying"));
	...
	void ABP_Lantern_C::CreateProxyItem()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Lantern.BP_Lantern_C.CreateProxyItem"));
	...
	void ABP_Lantern_C::UserConstructionScript()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Lantern.BP_Lantern_C.UserConstructionScript"));
	...
	void ABP_Lantern_C::Timeline_1__FinishedFunc()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Lantern.BP_Lantern_C.Timeline_1__FinishedFunc"));
	...
	void ABP_Lantern_C::Timeline_1__UpdateFunc()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Lantern.BP_Lantern_C.Timeline_1__UpdateFunc"));
	...
	void ABP_Lantern_C::WaterParticleHit()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Lantern.BP_Lantern_C.WaterParticleHit"));
	...
	void ABP_Lantern_C::OverrideLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Lantern.BP_Lantern_C.OverrideLoaded"));
	...
	void ABP_Lantern_C::InWater()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Lantern.BP_Lantern_C.InWater"));
	...
	void ABP_Lantern_C::ToggleLight(bool TurnOn_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Lantern.BP_Lantern_C.ToggleLight"));
	...
	void ABP_Lantern_C::ExecuteUbergraph_BP_Lantern(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Lantern.BP_Lantern_C.ExecuteUbergraph_BP_Lantern"));
	...
	UClass* ABP_Lantern_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_Lantern.BP_Lantern_C"));
		return ptr;
	}
