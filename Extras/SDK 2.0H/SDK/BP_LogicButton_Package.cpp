...
namespace CG
{
	...
	void ABP_LogicButton_C::LMBDownIsTarget(class UPrimitiveComponent* Component, class ABP_ParentItem_C* CarryingItem, class ABP_GameController_C* Insigator)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicButton.BP_LogicButton_C.LMBDownIsTarget"));
	...
	void ABP_LogicButton_C::ExecuteUbergraph_BP_LogicButton(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicButton.BP_LogicButton_C.ExecuteUbergraph_BP_LogicButton"));
	...
	UClass* ABP_LogicButton_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_LogicButton.BP_LogicButton_C"));
		return ptr;
	}
