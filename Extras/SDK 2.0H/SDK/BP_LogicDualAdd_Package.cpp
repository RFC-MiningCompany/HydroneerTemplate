...
namespace CG
{
	...
	void ABP_LogicDualAdd_C::OverrideLogicIn(class USceneComponent* Component)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicDualAdd.BP_LogicDualAdd_C.OverrideLogicIn"));
	...
	void ABP_LogicDualAdd_C::ExecuteUbergraph_BP_LogicDualAdd(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicDualAdd.BP_LogicDualAdd_C.ExecuteUbergraph_BP_LogicDualAdd"));
	...
	UClass* ABP_LogicDualAdd_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_LogicDualAdd.BP_LogicDualAdd_C"));
		return ptr;
	}
