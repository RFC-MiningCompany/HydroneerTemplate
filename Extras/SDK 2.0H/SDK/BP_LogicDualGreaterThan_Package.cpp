...
namespace CG
{
	...
	void ABP_LogicDualGreaterThan_C::OverrideLogicIn(class USceneComponent* Component)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicDualGreaterThan.BP_LogicDualGreaterThan_C.OverrideLogicIn"));
	...
	void ABP_LogicDualGreaterThan_C::ExecuteUbergraph_BP_LogicDualGreaterThan(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicDualGreaterThan.BP_LogicDualGreaterThan_C.ExecuteUbergraph_BP_LogicDualGreaterThan"));
	...
	UClass* ABP_LogicDualGreaterThan_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_LogicDualGreaterThan.BP_LogicDualGreaterThan_C"));
		return ptr;
	}
