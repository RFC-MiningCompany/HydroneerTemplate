...
namespace CG
{
	...
	void ABP_LogicDualSub_C::OverrideLogicIn(class USceneComponent* Component)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicDualSub.BP_LogicDualSub_C.OverrideLogicIn"));
	...
	void ABP_LogicDualSub_C::ExecuteUbergraph_BP_LogicDualSub(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicDualSub.BP_LogicDualSub_C.ExecuteUbergraph_BP_LogicDualSub"));
	...
	UClass* ABP_LogicDualSub_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_LogicDualSub.BP_LogicDualSub_C"));
		return ptr;
	}
