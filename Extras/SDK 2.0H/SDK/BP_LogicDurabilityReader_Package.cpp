...
namespace CG
{
	...
	void ABP_LogicDurabilityReader_C::TryRepair(class ABP_ParentItem_C* RepairingTool)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicDurabilityReader.BP_LogicDurabilityReader_C.TryRepair"));
	...
	void ABP_LogicDurabilityReader_C::DoneRepair()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicDurabilityReader.BP_LogicDurabilityReader_C.DoneRepair"));
	...
	void ABP_LogicDurabilityReader_C::FindDurability(class ABP_ParentItem_C* Item)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicDurabilityReader.BP_LogicDurabilityReader_C.FindDurability"));
	...
	void ABP_LogicDurabilityReader_C::OverridePlacedDown(class ABP_GameCharacter_C* Character)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicDurabilityReader.BP_LogicDurabilityReader_C.OverridePlacedDown"));
	...
	void ABP_LogicDurabilityReader_C::OverridePickedup()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicDurabilityReader.BP_LogicDurabilityReader_C.OverridePickedup"));
	...
	void ABP_LogicDurabilityReader_C::OverrideLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicDurabilityReader.BP_LogicDurabilityReader_C.OverrideLoaded"));
	...
	void ABP_LogicDurabilityReader_C::ReadTime()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicDurabilityReader.BP_LogicDurabilityReader_C.ReadTime"));
	...
	void ABP_LogicDurabilityReader_C::ReturnDurability(float DurabilityAmount)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicDurabilityReader.BP_LogicDurabilityReader_C.ReturnDurability"));
	...
	void ABP_LogicDurabilityReader_C::ExecuteUbergraph_BP_LogicDurabilityReader(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicDurabilityReader.BP_LogicDurabilityReader_C.ExecuteUbergraph_BP_LogicDurabilityReader"));
	...
	UClass* ABP_LogicDurabilityReader_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_LogicDurabilityReader.BP_LogicDurabilityReader_C"));
		return ptr;
	}
