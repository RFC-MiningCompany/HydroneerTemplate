...
namespace CG
{
	...
	void ABP_LogicElbow_C::OverrideLogicIn(class USceneComponent* Component)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicElbow.BP_LogicElbow_C.OverrideLogicIn"));
	...
	void ABP_LogicElbow_C::ExecuteUbergraph_BP_LogicElbow(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicElbow.BP_LogicElbow_C.ExecuteUbergraph_BP_LogicElbow"));
	...
	UClass* ABP_LogicElbow_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_LogicElbow.BP_LogicElbow_C"));
		return ptr;
	}
