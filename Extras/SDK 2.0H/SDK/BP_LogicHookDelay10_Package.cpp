...
namespace CG
{
	...
	void ABP_LogicHookDelay10_C::HookFunctionality(class ABP_ParentItem_C* HookedTo, class USceneComponent* Component, bool* CanPass_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookDelay10.BP_LogicHookDelay10_C.HookFunctionality"));
	...
	void ABP_LogicHookDelay10_C::WaitForDelay(class ABP_ParentLogic_C* Logic, class USceneComponent* Component)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookDelay10.BP_LogicHookDelay10_C.WaitForDelay"));
	...
	void ABP_LogicHookDelay10_C::ExecuteUbergraph_BP_LogicHookDelay10(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookDelay10.BP_LogicHookDelay10_C.ExecuteUbergraph_BP_LogicHookDelay10"));
	...
	UClass* ABP_LogicHookDelay10_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_LogicHookDelay10.BP_LogicHookDelay10_C"));
		return ptr;
	}
