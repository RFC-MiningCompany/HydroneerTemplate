...
namespace CG
{
	...
	void ABP_LogicHookDisplay_C::HookFunctionality(class ABP_ParentItem_C* HookedTo, class USceneComponent* Component, bool* CanPass_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookDisplay.BP_LogicHookDisplay_C.HookFunctionality"));
	...
	UClass* ABP_LogicHookDisplay_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_LogicHookDisplay.BP_LogicHookDisplay_C"));
		return ptr;
	}
