...
namespace CG
{
	...
	void ABP_LogicHookFlipFlop_C::HookFunctionality(class ABP_ParentItem_C* HookedTo, class USceneComponent* Component, bool* CanPass_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookFlipFlop.BP_LogicHookFlipFlop_C.HookFunctionality"));
	...
	UClass* ABP_LogicHookFlipFlop_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_LogicHookFlipFlop.BP_LogicHookFlipFlop_C"));
		return ptr;
	}
