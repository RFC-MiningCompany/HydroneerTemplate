...
namespace CG
{
	...
	void ABP_LogicHookLight_C::TurnOffLight()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.TurnOffLight"));
	...
	void ABP_LogicHookLight_C::HookFunctionality(class ABP_ParentItem_C* HookedTo, class USceneComponent* Component, bool* CanPass_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.HookFunctionality"));
	...
	void ABP_LogicHookLight_C::UserConstructionScript()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.UserConstructionScript"));
	...
	void ABP_LogicHookLight_C::Timeline_0__FinishedFunc()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.Timeline_0__FinishedFunc"));
	...
	void ABP_LogicHookLight_C::Timeline_0__UpdateFunc()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.Timeline_0__UpdateFunc"));
	...
	void ABP_LogicHookLight_C::Timeline_1__FinishedFunc()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.Timeline_1__FinishedFunc"));
	...
	void ABP_LogicHookLight_C::Timeline_1__UpdateFunc()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.Timeline_1__UpdateFunc"));
	...
	void ABP_LogicHookLight_C::OverrideLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.OverrideLoaded"));
	...
	void ABP_LogicHookLight_C::RaiseBrightness(bool Up_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.RaiseBrightness"));
	...
	void ABP_LogicHookLight_C::ChangeColor(const struct FVector& A)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.ChangeColor"));
	...
	void ABP_LogicHookLight_C::NewLogicInput(class ABP_ParentLogic_C* LogicItem)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.NewLogicInput"));
	...
	void ABP_LogicHookLight_C::OverridePickedup()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.OverridePickedup"));
	...
	void ABP_LogicHookLight_C::ExecuteUbergraph_BP_LogicHookLight(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookLight.BP_LogicHookLight_C.ExecuteUbergraph_BP_LogicHookLight"));
	...
	UClass* ABP_LogicHookLight_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_LogicHookLight.BP_LogicHookLight_C"));
		return ptr;
	}
