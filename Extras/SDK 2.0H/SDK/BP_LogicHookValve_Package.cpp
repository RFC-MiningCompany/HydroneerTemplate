...
namespace CG
{
	...
	void ABP_LogicHookValve_C::HookFunctionality(class ABP_ParentItem_C* HookedTo, class USceneComponent* Component, bool* CanPass_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookValve.BP_LogicHookValve_C.HookFunctionality"));
	...
	void ABP_LogicHookValve_C::LMBDownIsTarget(class UPrimitiveComponent* Component, class ABP_ParentItem_C* CarryingItem, class ABP_GameController_C* Insigator)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookValve.BP_LogicHookValve_C.LMBDownIsTarget"));
	...
	void ABP_LogicHookValve_C::OverrideLogicIn(const class FString& Logic)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookValve.BP_LogicHookValve_C.OverrideLogicIn"));
	...
	void ABP_LogicHookValve_C::ActorLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookValve.BP_LogicHookValve_C.ActorLoaded"));
	...
	void ABP_LogicHookValve_C::ReceiveTick(float DeltaSeconds)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookValve.BP_LogicHookValve_C.ReceiveTick"));
	...
	void ABP_LogicHookValve_C::ExecuteUbergraph_BP_LogicHookValve(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookValve.BP_LogicHookValve_C.ExecuteUbergraph_BP_LogicHookValve"));
	...
	UClass* ABP_LogicHookValve_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_LogicHookValve.BP_LogicHookValve_C"));
		return ptr;
	}
