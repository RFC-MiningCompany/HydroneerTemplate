...
namespace CG
{
	...
	void ABP_LogicKeypad_C::UpdateText()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicKeypad.BP_LogicKeypad_C.UpdateText"));
	...
	void ABP_LogicKeypad_C::OverrideLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicKeypad.BP_LogicKeypad_C.OverrideLoaded"));
	...
	void ABP_LogicKeypad_C::CustomEvent()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicKeypad.BP_LogicKeypad_C.CustomEvent"));
	...
	void ABP_LogicKeypad_C::LMBDownIsTarget(class UPrimitiveComponent* Component, class ABP_ParentItem_C* CarryingItem, class ABP_GameController_C* Insigator)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicKeypad.BP_LogicKeypad_C.LMBDownIsTarget"));
	...
	void ABP_LogicKeypad_C::ExecuteUbergraph_BP_LogicKeypad(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicKeypad.BP_LogicKeypad_C.ExecuteUbergraph_BP_LogicKeypad"));
	...
	UClass* ABP_LogicKeypad_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_LogicKeypad.BP_LogicKeypad_C"));
		return ptr;
	}
