...
namespace CG
{
	...
	void ABP_LogicLever_C::OverrideLoaded()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicLever.BP_LogicLever_C.OverrideLoaded"));
	...
	void ABP_LogicLever_C::LMBDownIsTarget(class UPrimitiveComponent* Component, class ABP_ParentItem_C* CarryingItem, class ABP_GameController_C* Insigator)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicLever.BP_LogicLever_C.LMBDownIsTarget"));
	...
	void ABP_LogicLever_C::OverrideAnimFinished()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicLever.BP_LogicLever_C.OverrideAnimFinished"));
	...
	void ABP_LogicLever_C::ExecuteUbergraph_BP_LogicLever(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicLever.BP_LogicLever_C.ExecuteUbergraph_BP_LogicLever"));
	...
	UClass* ABP_LogicLever_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_LogicLever.BP_LogicLever_C"));
		return ptr;
	}
