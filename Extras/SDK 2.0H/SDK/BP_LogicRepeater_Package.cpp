...
namespace CG
{
	...
	void ABP_LogicRepeater_C::OverridePlacedDown(class ABP_GameCharacter_C* Character)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicRepeater.BP_LogicRepeater_C.OverridePlacedDown"));
	...
	void ABP_LogicRepeater_C::OverrideLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicRepeater.BP_LogicRepeater_C.OverrideLoaded"));
	...
	void ABP_LogicRepeater_C::ItemPickedUp(class ABP_GameCharacter_C* Player)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicRepeater.BP_LogicRepeater_C.ItemPickedUp"));
	...
	void ABP_LogicRepeater_C::Repeat()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicRepeater.BP_LogicRepeater_C.Repeat"));
	...
	void ABP_LogicRepeater_C::ExecuteUbergraph_BP_LogicRepeater(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicRepeater.BP_LogicRepeater_C.ExecuteUbergraph_BP_LogicRepeater"));
	...
	UClass* ABP_LogicRepeater_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_LogicRepeater.BP_LogicRepeater_C"));
		return ptr;
	}
