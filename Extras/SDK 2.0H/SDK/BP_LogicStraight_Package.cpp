...
namespace CG
{
	...
	void ABP_LogicStraight_C::OverrideLogicIn(class USceneComponent* Component)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicStraight.BP_LogicStraight_C.OverrideLogicIn"));
	...
	void ABP_LogicStraight_C::ExecuteUbergraph_BP_LogicStraight(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicStraight.BP_LogicStraight_C.ExecuteUbergraph_BP_LogicStraight"));
	...
	UClass* ABP_LogicStraight_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_LogicStraight.BP_LogicStraight_C"));
		return ptr;
	}
