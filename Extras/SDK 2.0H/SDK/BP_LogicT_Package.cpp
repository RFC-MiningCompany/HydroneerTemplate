...
namespace CG
{
	...
	void ABP_LogicT_C::OverrideLogicIn(class USceneComponent* Component)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicT.BP_LogicT_C.OverrideLogicIn"));
	...
	void ABP_LogicT_C::ExecuteUbergraph_BP_LogicT(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicT.BP_LogicT_C.ExecuteUbergraph_BP_LogicT"));
	...
	UClass* ABP_LogicT_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_LogicT.BP_LogicT_C"));
		return ptr;
	}
