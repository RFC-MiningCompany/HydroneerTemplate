...
namespace CG
{
	...
	void ABP_MasterworkDesign_C::InitDesign()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_MasterworkDesign.BP_MasterworkDesign_C.InitDesign"));
	...
	void ABP_MasterworkDesign_C::UserConstructionScript()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_MasterworkDesign.BP_MasterworkDesign_C.UserConstructionScript"));
	...
	void ABP_MasterworkDesign_C::ActorLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_MasterworkDesign.BP_MasterworkDesign_C.ActorLoaded"));
	...
	void ABP_MasterworkDesign_C::ExecuteUbergraph_BP_MasterworkDesign(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_MasterworkDesign.BP_MasterworkDesign_C.ExecuteUbergraph_BP_MasterworkDesign"));
	...
	UClass* ABP_MasterworkDesign_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_MasterworkDesign.BP_MasterworkDesign_C"));
		return ptr;
	}
