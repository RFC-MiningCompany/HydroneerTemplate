...
namespace CG
{
	...
	void ABP_MiningHelmet_C::UserConstructionScript()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_MiningHelmet.BP_MiningHelmet_C.UserConstructionScript"));
	...
	void ABP_MiningHelmet_C::Timeline_0__FinishedFunc()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_MiningHelmet.BP_MiningHelmet_C.Timeline_0__FinishedFunc"));
	...
	void ABP_MiningHelmet_C::Timeline_0__UpdateFunc()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_MiningHelmet.BP_MiningHelmet_C.Timeline_0__UpdateFunc"));
	...
	void ABP_MiningHelmet_C::WaterParticleHit()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_MiningHelmet.BP_MiningHelmet_C.WaterParticleHit"));
	...
	void ABP_MiningHelmet_C::OverrideHatOn(class ABP_GameCharacter_C* Character)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_MiningHelmet.BP_MiningHelmet_C.OverrideHatOn"));
	...
	void ABP_MiningHelmet_C::OverrideHatOff(class ABP_GameCharacter_C* Character)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_MiningHelmet.BP_MiningHelmet_C.OverrideHatOff"));
	...
	void ABP_MiningHelmet_C::InWater()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_MiningHelmet.BP_MiningHelmet_C.InWater"));
	...
	void ABP_MiningHelmet_C::ExecuteUbergraph_BP_MiningHelmet(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_MiningHelmet.BP_MiningHelmet_C.ExecuteUbergraph_BP_MiningHelmet"));
	...
	UClass* ABP_MiningHelmet_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_MiningHelmet.BP_MiningHelmet_C"));
		return ptr;
	}
