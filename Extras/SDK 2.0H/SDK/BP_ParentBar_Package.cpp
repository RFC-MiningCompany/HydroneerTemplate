...
namespace CG
{
	...
	void ABP_ParentBar_C::UserConstructionScript()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBar.BP_ParentBar_C.UserConstructionScript"));
	...
	void ABP_ParentBar_C::HeatUpdated(float Heat)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBar.BP_ParentBar_C.HeatUpdated"));
	...
	void ABP_ParentBar_C::InFire()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBar.BP_ParentBar_C.InFire"));
	...
	void ABP_ParentBar_C::OutOfFire()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBar.BP_ParentBar_C.OutOfFire"));
	...
	void ABP_ParentBar_C::FullHeat()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBar.BP_ParentBar_C.FullHeat"));
	...
	void ABP_ParentBar_C::InWater()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBar.BP_ParentBar_C.InWater"));
	...
	void ABP_ParentBar_C::WaterParticleHit()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBar.BP_ParentBar_C.WaterParticleHit"));
	...
	void ABP_ParentBar_C::SetCraftedSize()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBar.BP_ParentBar_C.SetCraftedSize"));
	...
	void ABP_ParentBar_C::SetResourceSize()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBar.BP_ParentBar_C.SetResourceSize"));
	...
	void ABP_ParentBar_C::ExecuteUbergraph_BP_ParentBar(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBar.BP_ParentBar_C.ExecuteUbergraph_BP_ParentBar"));
	...
	UClass* ABP_ParentBar_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentBar.BP_ParentBar_C"));
		return ptr;
	}
