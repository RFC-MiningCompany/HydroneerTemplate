...
namespace CG
{
	...
	void ABP_ParentBed_C::FadeEyesOut()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBed.BP_ParentBed_C.FadeEyesOut"));
	...
	void ABP_ParentBed_C::Deactivated(class ABP_GameController_C* Controller)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBed.BP_ParentBed_C.Deactivated"));
	...
	void ABP_ParentBed_C::LMBDownIsTarget(class UPrimitiveComponent* Component, class ABP_ParentItem_C* CarryingItem, class ABP_GameController_C* Insigator)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBed.BP_ParentBed_C.LMBDownIsTarget"));
	...
	void ABP_ParentBed_C::ExecuteUbergraph_BP_ParentBed(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBed.BP_ParentBed_C.ExecuteUbergraph_BP_ParentBed"));
	...
	UClass* ABP_ParentBed_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentBed.BP_ParentBed_C"));
		return ptr;
	}
