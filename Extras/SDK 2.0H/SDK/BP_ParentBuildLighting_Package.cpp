...
namespace CG
{
	...
	void ABP_ParentBuildLighting_C::UserConstructionScript()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBuildLighting.BP_ParentBuildLighting_C.UserConstructionScript"));
	...
	void ABP_ParentBuildLighting_C::Timeline_0__FinishedFunc()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBuildLighting.BP_ParentBuildLighting_C.Timeline_0__FinishedFunc"));
	...
	void ABP_ParentBuildLighting_C::Timeline_0__UpdateFunc()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBuildLighting.BP_ParentBuildLighting_C.Timeline_0__UpdateFunc"));
	...
	void ABP_ParentBuildLighting_C::LMBDownIsTarget(class UPrimitiveComponent* Component, class ABP_ParentItem_C* CarryingItem, class ABP_GameController_C* Insigator)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBuildLighting.BP_ParentBuildLighting_C.LMBDownIsTarget"));
	...
	void ABP_ParentBuildLighting_C::ActorLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBuildLighting.BP_ParentBuildLighting_C.ActorLoaded"));
	...
	void ABP_ParentBuildLighting_C::ReceiveBeginPlay()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBuildLighting.BP_ParentBuildLighting_C.ReceiveBeginPlay"));
	...
	void ABP_ParentBuildLighting_C::OverrideLightOn()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBuildLighting.BP_ParentBuildLighting_C.OverrideLightOn"));
	...
	void ABP_ParentBuildLighting_C::OverrideLightOff()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBuildLighting.BP_ParentBuildLighting_C.OverrideLightOff"));
	...
	void ABP_ParentBuildLighting_C::ExecuteUbergraph_BP_ParentBuildLighting(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBuildLighting.BP_ParentBuildLighting_C.ExecuteUbergraph_BP_ParentBuildLighting"));
	...
	UClass* ABP_ParentBuildLighting_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentBuildLighting.BP_ParentBuildLighting_C"));
		return ptr;
	}
