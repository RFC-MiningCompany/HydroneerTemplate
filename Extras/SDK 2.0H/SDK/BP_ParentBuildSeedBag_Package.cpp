...
namespace CG
{
	...
	void ABP_ParentBuildSeedBag_C::OverridePlacedDown(class ABP_GameCharacter_C* Character)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBuildSeedBag.BP_ParentBuildSeedBag_C.OverridePlacedDown"));
	...
	void ABP_ParentBuildSeedBag_C::ExecuteUbergraph_BP_ParentBuildSeedBag(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBuildSeedBag.BP_ParentBuildSeedBag_C.ExecuteUbergraph_BP_ParentBuildSeedBag"));
	...
	UClass* ABP_ParentBuildSeedBag_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentBuildSeedBag.BP_ParentBuildSeedBag_C"));
		return ptr;
	}
