...
namespace CG
{
	...
	void ABP_ParentCart_C::CalculateWheelTurn(float DeltaSeconds)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentCart.BP_ParentCart_C.CalculateWheelTurn"));
	...
	void ABP_ParentCart_C::ScanForDropCollision(bool* Can_Drop_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentCart.BP_ParentCart_C.ScanForDropCollision"));
	...
	void ABP_ParentCart_C::ToggleProxyItem(bool Enabled_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentCart.BP_ParentCart_C.ToggleProxyItem"));
	...
	void ABP_ParentCart_C::UserConstructionScript()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentCart.BP_ParentCart_C.UserConstructionScript"));
	...
	void ABP_ParentCart_C::ItemStored(class ABP_ParentItem_C* Item)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentCart.BP_ParentCart_C.ItemStored"));
	...
	void ABP_ParentCart_C::Movement_Sound()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentCart.BP_ParentCart_C.Movement Sound"));
	...
	void ABP_ParentCart_C::ToggleMovementSound(bool Condition)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentCart.BP_ParentCart_C.ToggleMovementSound"));
	...
	void ABP_ParentCart_C::BndEvt__StorageBox_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentCart.BP_ParentCart_C.BndEvt__StorageBox_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
	...
	void ABP_ParentCart_C::OverridePickedup()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentCart.BP_ParentCart_C.OverridePickedup"));
	...
	void ABP_ParentCart_C::OverrideDroppedItem(class ABP_GameCharacter_C* Character)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentCart.BP_ParentCart_C.OverrideDroppedItem"));
	...
	void ABP_ParentCart_C::OverrideLockedPhysics()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentCart.BP_ParentCart_C.OverrideLockedPhysics"));
	...
	void ABP_ParentCart_C::ChangeAttachedReactionss(E_PhyReact_E_PhyReact New_Reaction)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentCart.BP_ParentCart_C.ChangeAttachedReactionss"));
	...
	void ABP_ParentCart_C::BndEvt__BP_ParentCart_StorageBox_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentCart.BP_ParentCart_C.BndEvt__BP_ParentCart_StorageBox_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature"));
	...
	void ABP_ParentCart_C::StoredItemPickedUp(class ABP_ParentItem_C* ItemPickedUp)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentCart.BP_ParentCart_C.StoredItemPickedUp"));
	...
	void ABP_ParentCart_C::ReceiveDestroyed()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentCart.BP_ParentCart_C.ReceiveDestroyed"));
	...
	void ABP_ParentCart_C::ReceiveTick(float DeltaSeconds)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentCart.BP_ParentCart_C.ReceiveTick"));
	...
	void ABP_ParentCart_C::ActorLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentCart.BP_ParentCart_C.ActorLoaded"));
	...
	void ABP_ParentCart_C::ExecuteUbergraph_BP_ParentCart(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentCart.BP_ParentCart_C.ExecuteUbergraph_BP_ParentCart"));
	...
	UClass* ABP_ParentCart_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentCart.BP_ParentCart_C"));
		return ptr;
	}
