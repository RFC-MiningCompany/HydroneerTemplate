...
namespace CG
{
	...
	void ABP_ParentConveyor_C::FindBeltSpeed(class USceneComponent* Component, struct FVector* DeltaLocationToAdd)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentConveyor.BP_ParentConveyor_C.FindBeltSpeed"));
	...
	void ABP_ParentConveyor_C::CanMoveItem_(class AActor* Actor, TArray<class ABP_ParentItem_C*>* CurrentlyMovingItems, bool* CanMove_, class ABP_ParentResource_C** ResourceRef)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentConveyor.BP_ParentConveyor_C.CanMoveItem?"));
	...
	void ABP_ParentConveyor_C::HookFunctionality(class ABP_ParentItem_C* HookedTo, class USceneComponent* Component, bool* CanPass_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentConveyor.BP_ParentConveyor_C.HookFunctionality"));
	...
	void ABP_ParentConveyor_C::ChangeBeltSpeed()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentConveyor.BP_ParentConveyor_C.ChangeBeltSpeed"));
	...
	void ABP_ParentConveyor_C::UserConstructionScript()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentConveyor.BP_ParentConveyor_C.UserConstructionScript"));
	...
	void ABP_ParentConveyor_C::OverridePlacedDown(class ABP_GameCharacter_C* Character)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentConveyor.BP_ParentConveyor_C.OverridePlacedDown"));
	...
	void ABP_ParentConveyor_C::OverrideStartPlacing()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentConveyor.BP_ParentConveyor_C.OverrideStartPlacing"));
	...
	void ABP_ParentConveyor_C::OverrideDroppedItem(class ABP_GameCharacter_C* Character)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentConveyor.BP_ParentConveyor_C.OverrideDroppedItem"));
	...
	void ABP_ParentConveyor_C::ItemPickedUp(class ABP_GameCharacter_C* Player)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentConveyor.BP_ParentConveyor_C.ItemPickedUp"));
	...
	void ABP_ParentConveyor_C::OverrideParentNoWater()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentConveyor.BP_ParentConveyor_C.OverrideParentNoWater"));
	...
	void ABP_ParentConveyor_C::ShovelOnToConveyor(int32_t Quality, float Size)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentConveyor.BP_ParentConveyor_C.ShovelOnToConveyor"));
	...
	void ABP_ParentConveyor_C::ItemExitConveyor(class ABP_ParentItem_C* Item, const struct FVector& ForwardVec)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentConveyor.BP_ParentConveyor_C.ItemExitConveyor"));
	...
	void ABP_ParentConveyor_C::ExecuteUbergraph_BP_ParentConveyor(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentConveyor.BP_ParentConveyor_C.ExecuteUbergraph_BP_ParentConveyor"));
	...
	UClass* ABP_ParentConveyor_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentConveyor.BP_ParentConveyor_C"));
		return ptr;
	}
