...
namespace CG
{
	...
	void ABP_ParentDualLogic_C::AddZeros(const class FString& Logic, class FString* Output)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentDualLogic.BP_ParentDualLogic_C.AddZeros"));
	...
	void ABP_ParentDualLogic_C::LogicIn(class USceneComponent* Component, const class FString& Logic)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentDualLogic.BP_ParentDualLogic_C.LogicIn"));
	...
	void ABP_ParentDualLogic_C::ExecuteUbergraph_BP_ParentDualLogic(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentDualLogic.BP_ParentDualLogic_C.ExecuteUbergraph_BP_ParentDualLogic"));
	...
	UClass* ABP_ParentDualLogic_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentDualLogic.BP_ParentDualLogic_C"));
		return ptr;
	}
