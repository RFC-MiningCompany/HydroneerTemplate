...
namespace CG
{
	...
	void ABP_ParentHarvester_C::CalcPressureBoost(float Weight, int32_t* DirtLoads)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHarvester.BP_ParentHarvester_C.CalcPressureBoost"));
	...
	void ABP_ParentHarvester_C::ComponentsToSave(TArray<class UActorComponent*>* Components)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHarvester.BP_ParentHarvester_C.ComponentsToSave"));
	...
	void ABP_ParentHarvester_C::TryRepair(class ABP_ParentItem_C* RepairingTool)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHarvester.BP_ParentHarvester_C.TryRepair"));
	...
	void ABP_ParentHarvester_C::ReturnDurability(float DurabilityAmount)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHarvester.BP_ParentHarvester_C.ReturnDurability"));
	...
	void ABP_ParentHarvester_C::FindDurability(class ABP_ParentItem_C* Item)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHarvester.BP_ParentHarvester_C.FindDurability"));
	...
	void ABP_ParentHarvester_C::DoneRepair()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHarvester.BP_ParentHarvester_C.DoneRepair"));
	...
	void ABP_ParentHarvester_C::OverrideWaterIn(class USceneComponent* Component, float RootPressure)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHarvester.BP_ParentHarvester_C.OverrideWaterIn"));
	...
	void ABP_ParentHarvester_C::OverrideEmptyWaterPipe()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHarvester.BP_ParentHarvester_C.OverrideEmptyWaterPipe"));
	...
	void ABP_ParentHarvester_C::OverridePickedup()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHarvester.BP_ParentHarvester_C.OverridePickedup"));
	...
	void ABP_ParentHarvester_C::ToggleHarvester(bool On_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHarvester.BP_ParentHarvester_C.ToggleHarvester"));
	...
	void ABP_ParentHarvester_C::SpinTimer()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHarvester.BP_ParentHarvester_C.SpinTimer"));
	...
	void ABP_ParentHarvester_C::BndEvt__Harvesting_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHarvester.BP_ParentHarvester_C.BndEvt__Harvesting_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
	...
	void ABP_ParentHarvester_C::ExecuteUbergraph_BP_ParentHarvester(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHarvester.BP_ParentHarvester_C.ExecuteUbergraph_BP_ParentHarvester"));
	...
	UClass* ABP_ParentHarvester_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentHarvester.BP_ParentHarvester_C"));
		return ptr;
	}
