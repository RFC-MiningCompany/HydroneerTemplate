...
namespace CG
{
	...
	void ABP_ParentHookIntakeBooster_C::HookFunctionality(class ABP_ParentItem_C* HookedTo, class USceneComponent* Component, bool* CanPass_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHookIntakeBooster.BP_ParentHookIntakeBooster_C.HookFunctionality"));
	...
	UClass* ABP_ParentHookIntakeBooster_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentHookIntakeBooster.BP_ParentHookIntakeBooster_C"));
		return ptr;
	}
