...
namespace CG
{
	...
	void ABP_ParentHookShredder_C::ShredTimer()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHookShredder.BP_ParentHookShredder_C.ShredTimer"));
	...
	void ABP_ParentHookShredder_C::HookFunctionality(class ABP_ParentItem_C* HookedTo, class USceneComponent* Component, bool* CanPass_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHookShredder.BP_ParentHookShredder_C.HookFunctionality"));
	...
	void ABP_ParentHookShredder_C::OverridePickedup()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHookShredder.BP_ParentHookShredder_C.OverridePickedup"));
	...
	void ABP_ParentHookShredder_C::OverrideParentNoWater()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHookShredder.BP_ParentHookShredder_C.OverrideParentNoWater"));
	...
	void ABP_ParentHookShredder_C::BndEvt__ShredBox_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHookShredder.BP_ParentHookShredder_C.BndEvt__ShredBox_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
	...
	void ABP_ParentHookShredder_C::ExecuteUbergraph_BP_ParentHookShredder(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHookShredder.BP_ParentHookShredder_C.ExecuteUbergraph_BP_ParentHookShredder"));
	...
	UClass* ABP_ParentHookShredder_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentHookShredder.BP_ParentHookShredder_C"));
		return ptr;
	}
