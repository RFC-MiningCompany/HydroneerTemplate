...
namespace CG
{
	...
	void ABP_ParentHook_C::HookFunctionality(class ABP_ParentItem_C* HookedTo, class USceneComponent* Component, bool* CanPass_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHook.BP_ParentHook_C.HookFunctionality"));
	...
	void ABP_ParentHook_C::PartHooked(class ABP_ParentBuild_C* HookedTo)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHook.BP_ParentHook_C.PartHooked"));
	...
	void ABP_ParentHook_C::Unhook_from_Parent()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHook.BP_ParentHook_C.Unhook from Parent"));
	...
	void ABP_ParentHook_C::TraceForParents()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHook.BP_ParentHook_C.TraceForParents"));
	...
	void ABP_ParentHook_C::OverridePlacedDown(class ABP_GameCharacter_C* Character)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHook.BP_ParentHook_C.OverridePlacedDown"));
	...
	void ABP_ParentHook_C::OverridePickedup()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHook.BP_ParentHook_C.OverridePickedup"));
	...
	void ABP_ParentHook_C::OverrideParentNoWater()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHook.BP_ParentHook_C.OverrideParentNoWater"));
	...
	void ABP_ParentHook_C::OverridePartHooked(class ABP_ParentBuild_C* HookedTo)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHook.BP_ParentHook_C.OverridePartHooked"));
	...
	void ABP_ParentHook_C::OverrideLogicIn(const class FString& Logic)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHook.BP_ParentHook_C.OverrideLogicIn"));
	...
	void ABP_ParentHook_C::ActorLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHook.BP_ParentHook_C.ActorLoaded"));
	...
	void ABP_ParentHook_C::ExecuteUbergraph_BP_ParentHook(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHook.BP_ParentHook_C.ExecuteUbergraph_BP_ParentHook"));
	...
	UClass* ABP_ParentHook_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentHook.BP_ParentHook_C"));
		return ptr;
	}
