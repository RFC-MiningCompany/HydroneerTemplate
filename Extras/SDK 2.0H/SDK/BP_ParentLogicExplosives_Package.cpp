...
namespace CG
{
	...
	void ABP_ParentLogicExplosives_C::UserConstructionScript()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentLogicExplosives.BP_ParentLogicExplosives_C.UserConstructionScript"));
	...
	void ABP_ParentLogicExplosives_C::OverrideLogicIn(class USceneComponent* Component)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentLogicExplosives.BP_ParentLogicExplosives_C.OverrideLogicIn"));
	...
	void ABP_ParentLogicExplosives_C::ExecuteUbergraph_BP_ParentLogicExplosives(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentLogicExplosives.BP_ParentLogicExplosives_C.ExecuteUbergraph_BP_ParentLogicExplosives"));
	...
	UClass* ABP_ParentLogicExplosives_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentLogicExplosives.BP_ParentLogicExplosives_C"));
		return ptr;
	}
