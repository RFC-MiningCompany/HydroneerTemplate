...
namespace CG
{
	...
	public:
		...
		E_LogicButtonSymbols_E_LogicButtonSymbols                  CurrentSymbol;                                           // 0x03B8(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, SaveGame, IsPlainOldData, NoDestructor, HasGetValueTypeHash
