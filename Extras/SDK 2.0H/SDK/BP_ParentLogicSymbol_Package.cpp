...
namespace CG
{
	...
	void ABP_ParentLogicSymbol_C::ChangeSymbol()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentLogicSymbol.BP_ParentLogicSymbol_C.ChangeSymbol"));
	...
	void ABP_ParentLogicSymbol_C::LMBDownIsTarget(class UPrimitiveComponent* Component, class ABP_ParentItem_C* CarryingItem, class ABP_GameController_C* Insigator)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentLogicSymbol.BP_ParentLogicSymbol_C.LMBDownIsTarget"));
	...
	void ABP_ParentLogicSymbol_C::RMBDownIsTarget(class UPrimitiveComponent* Component, class ABP_ParentItem_C* CarryingItem, class ABP_GameController_C* Instigator)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentLogicSymbol.BP_ParentLogicSymbol_C.RMBDownIsTarget"));
	...
	void ABP_ParentLogicSymbol_C::ActorLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentLogicSymbol.BP_ParentLogicSymbol_C.ActorLoaded"));
	...
	void ABP_ParentLogicSymbol_C::ExecuteUbergraph_BP_ParentLogicSymbol(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentLogicSymbol.BP_ParentLogicSymbol_C.ExecuteUbergraph_BP_ParentLogicSymbol"));
	...
	UClass* ABP_ParentLogicSymbol_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentLogicSymbol.BP_ParentLogicSymbol_C"));
		return ptr;
	}
