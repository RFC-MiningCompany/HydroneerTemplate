...
namespace CG
{
	...
	void ABP_ParentLogic_C::AttachmentFunctionalityCheck(class USceneComponent* Component, bool* CanPass_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentLogic.BP_ParentLogic_C.AttachmentFunctionalityCheck"));
	...
	void ABP_ParentLogic_C::CastLogicOut(class USceneComponent* OutComponent, const class FString& Logic)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentLogic.BP_ParentLogic_C.CastLogicOut"));
	...
	void ABP_ParentLogic_C::OverrideLogicIn(class USceneComponent* Component)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentLogic.BP_ParentLogic_C.OverrideLogicIn"));
	...
	void ABP_ParentLogic_C::SpawnLogic(const struct FVector& SpawnLocation, const struct FRotator& SpawnRotation)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentLogic.BP_ParentLogic_C.SpawnLogic"));
	...
	void ABP_ParentLogic_C::StackOverflowPrevention()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentLogic.BP_ParentLogic_C.StackOverflowPrevention"));
	...
	void ABP_ParentLogic_C::LogicIn(class USceneComponent* Component, const class FString& Logic)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentLogic.BP_ParentLogic_C.LogicIn"));
	...
	void ABP_ParentLogic_C::OverrideWaterIn(class USceneComponent* Component, int32_t Quality, float Pressure)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentLogic.BP_ParentLogic_C.OverrideWaterIn"));
	...
	void ABP_ParentLogic_C::ExecuteUbergraph_BP_ParentLogic(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentLogic.BP_ParentLogic_C.ExecuteUbergraph_BP_ParentLogic"));
	...
	UClass* ABP_ParentLogic_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentLogic.BP_ParentLogic_C"));
		return ptr;
	}
