...
namespace CG
{
	...
	void ABP_ParentPickaxe_C::LMBDownWhileCarrying(class ABP_GameController_C* Controller, class AActor* HitActor, const struct FVector& HitLocation, bool* ConsumeInput_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPickaxe.BP_ParentPickaxe_C.LMBDownWhileCarrying"));
	...
	void ABP_ParentPickaxe_C::Animate()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPickaxe.BP_ParentPickaxe_C.Animate"));
	...
	void ABP_ParentPickaxe_C::ExecuteUbergraph_BP_ParentPickaxe(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPickaxe.BP_ParentPickaxe_C.ExecuteUbergraph_BP_ParentPickaxe"));
	...
	UClass* ABP_ParentPickaxe_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentPickaxe.BP_ParentPickaxe_C"));
		return ptr;
	}
