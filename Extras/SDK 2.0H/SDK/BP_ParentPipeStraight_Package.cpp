...
namespace CG
{
	...
	void ABP_ParentPipeStraight_C::OverrideWaterIn(class USceneComponent* Component, float RootPressure)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPipeStraight.BP_ParentPipeStraight_C.OverrideWaterIn"));
	...
	void ABP_ParentPipeStraight_C::ExecuteUbergraph_BP_ParentPipeStraight(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPipeStraight.BP_ParentPipeStraight_C.ExecuteUbergraph_BP_ParentPipeStraight"));
	...
	UClass* ABP_ParentPipeStraight_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentPipeStraight.BP_ParentPipeStraight_C"));
		return ptr;
	}
