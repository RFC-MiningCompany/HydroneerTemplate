...
namespace CG
{
	...
	void ABP_ParentPipeT_C::OverrideWaterIn(class USceneComponent* Component, float RootPressure)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPipeT.BP_ParentPipeT_C.OverrideWaterIn"));
	...
	void ABP_ParentPipeT_C::ExecuteUbergraph_BP_ParentPipeT(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPipeT.BP_ParentPipeT_C.ExecuteUbergraph_BP_ParentPipeT"));
	...
	UClass* ABP_ParentPipeT_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentPipeT.BP_ParentPipeT_C"));
		return ptr;
	}
