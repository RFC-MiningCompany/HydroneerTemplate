...
namespace CG
{
	...
	void ABP_ParentPipe_C::Pressure_Check(class ABP_ParentPipe_C* Pipe, float PressureToPass, class USceneComponent* WaterOut)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPipe.BP_ParentPipe_C.Pressure Check"));
	...
	void ABP_ParentPipe_C::AttachmentFunctionalityCheck(class USceneComponent* Component, bool* CanPass_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPipe.BP_ParentPipe_C.AttachmentFunctionalityCheck"));
	...
	void ABP_ParentPipe_C::OverrideWaterIn(class USceneComponent* Component, float RootPressure)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPipe.BP_ParentPipe_C.OverrideWaterIn"));
	...
	void ABP_ParentPipe_C::SpawnWater(const struct FVector& SpawnLocation, const struct FRotator& SpawnRotation)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPipe.BP_ParentPipe_C.SpawnWater"));
	...
	void ABP_ParentPipe_C::StackOverflowPrevention()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPipe.BP_ParentPipe_C.StackOverflowPrevention"));
	...
	void ABP_ParentPipe_C::TimerTillEmpty()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPipe.BP_ParentPipe_C.TimerTillEmpty"));
	...
	void ABP_ParentPipe_C::OverrideEmptyWaterPipe()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPipe.BP_ParentPipe_C.OverrideEmptyWaterPipe"));
	...
	void ABP_ParentPipe_C::WaterIn(class USceneComponent* Component, float RootPressure)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPipe.BP_ParentPipe_C.WaterIn"));
	...
	void ABP_ParentPipe_C::CastWaterOut(class USceneComponent* OutComponent, int32_t Quality, float Pressure, float RootPressure)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPipe.BP_ParentPipe_C.CastWaterOut"));
	...
	void ABP_ParentPipe_C::ExecuteUbergraph_BP_ParentPipe(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPipe.BP_ParentPipe_C.ExecuteUbergraph_BP_ParentPipe"));
	...
	UClass* ABP_ParentPipe_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentPipe.BP_ParentPipe_C"));
		return ptr;
	}
