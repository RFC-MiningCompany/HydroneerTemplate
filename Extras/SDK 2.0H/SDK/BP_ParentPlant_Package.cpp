...
namespace CG
{
	...
	void ABP_ParentPlant_C::SkyTest(bool* Clear_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPlant.BP_ParentPlant_C.SkyTest"));
	...
	void ABP_ParentPlant_C::DigPlant()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPlant.BP_ParentPlant_C.DigPlant"));
	...
	void ABP_ParentPlant_C::ReceiveBeginPlay()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPlant.BP_ParentPlant_C.ReceiveBeginPlay"));
	...
	void ABP_ParentPlant_C::GrowLoop()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPlant.BP_ParentPlant_C.GrowLoop"));
	...
	void ABP_ParentPlant_C::PostLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPlant.BP_ParentPlant_C.PostLoaded"));
	...
	void ABP_ParentPlant_C::ExecuteUbergraph_BP_ParentPlant(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPlant.BP_ParentPlant_C.ExecuteUbergraph_BP_ParentPlant"));
	...
	UClass* ABP_ParentPlant_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentPlant.BP_ParentPlant_C"));
		return ptr;
	}
