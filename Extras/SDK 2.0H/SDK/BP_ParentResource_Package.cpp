...
namespace CG
{
	...
	void ABP_ParentResource_C::SetResourceSize()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentResource.BP_ParentResource_C.SetResourceSize"));
	...
	void ABP_ParentResource_C::UserConstructionScript()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentResource.BP_ParentResource_C.UserConstructionScript"));
	...
	UClass* ABP_ParentResource_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentResource.BP_ParentResource_C"));
		return ptr;
	}
