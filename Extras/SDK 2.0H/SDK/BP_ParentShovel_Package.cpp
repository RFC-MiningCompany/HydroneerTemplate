...
namespace CG
{
	...
	void ABP_ParentShovel_C::LMBDownWhileCarrying(class ABP_GameController_C* Controller, class AActor* HitActor, const struct FVector& HitLocation, bool* ConsumeInput_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShovel.BP_ParentShovel_C.LMBDownWhileCarrying"));
	...
	void ABP_ParentShovel_C::DirtFX(bool ShowDirt_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShovel.BP_ParentShovel_C.DirtFX"));
	...
	void ABP_ParentShovel_C::HitActorItem(class ABP_GameController_C* Controller, class AActor* HitActor, bool* Success_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShovel.BP_ParentShovel_C.HitActorItem"));
	...
	void ABP_ParentShovel_C::HitActorSpecialDig(class ABP_GameController_C* Controller, class AActor* HitActor)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShovel.BP_ParentShovel_C.HitActorSpecialDig"));
	...
	void ABP_ParentShovel_C::CantMine(const struct FVector& HitLocation)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShovel.BP_ParentShovel_C.CantMine"));
	...
	void ABP_ParentShovel_C::SetDirt(bool Making_Hole_, int32_t Quality)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShovel.BP_ParentShovel_C.SetDirt"));
	...
	void ABP_ParentShovel_C::ExecuteUbergraph_BP_ParentShovel(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShovel.BP_ParentShovel_C.ExecuteUbergraph_BP_ParentShovel"));
	...
	UClass* ABP_ParentShovel_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentShovel.BP_ParentShovel_C"));
		return ptr;
	}
