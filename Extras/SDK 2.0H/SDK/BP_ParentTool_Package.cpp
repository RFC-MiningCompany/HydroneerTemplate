...
namespace CG
{
	...
	void ABP_ParentTool_C::LMBDownWhileCarrying(class ABP_GameController_C* Controller, class AActor* HitActor, const struct FVector& HitLocation, bool* ConsumeInput_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentTool.BP_ParentTool_C.LMBDownWhileCarrying"));
	...
	void ABP_ParentTool_C::LMBUpWhileCarrying()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentTool.BP_ParentTool_C.LMBUpWhileCarrying"));
	...
	void ABP_ParentTool_C::RMBDownWhileCarrying(class ABP_GameController_C* Controller, class AActor* Hit_Actor, const struct FVector& HitLocation)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentTool.BP_ParentTool_C.RMBDownWhileCarrying"));
	...
	void ABP_ParentTool_C::RMBDownIsTarget(class UPrimitiveComponent* Component, class ABP_ParentItem_C* CarryingItem, class ABP_GameController_C* Instigator)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentTool.BP_ParentTool_C.RMBDownIsTarget"));
	...
	void ABP_ParentTool_C::LMBDownIsTarget(class UPrimitiveComponent* Component, class ABP_ParentItem_C* CarryingItem, class ABP_GameController_C* Insigator)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentTool.BP_ParentTool_C.LMBDownIsTarget"));
	...
	void ABP_ParentTool_C::OverrideAnimFinished()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentTool.BP_ParentTool_C.OverrideAnimFinished"));
	...
	void ABP_ParentTool_C::ExecuteUbergraph_BP_ParentTool(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentTool.BP_ParentTool_C.ExecuteUbergraph_BP_ParentTool"));
	...
	UClass* ABP_ParentTool_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentTool.BP_ParentTool_C"));
		return ptr;
	}
