...
namespace CG
{
	...
	void ABP_ProjectileSpanner_C::TryRepair(class ABP_ParentItem_C* RepairingTool)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ProjectileSpanner.BP_ProjectileSpanner_C.TryRepair"));
	...
	void ABP_ProjectileSpanner_C::DoneRepair()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ProjectileSpanner.BP_ProjectileSpanner_C.DoneRepair"));
	...
	void ABP_ProjectileSpanner_C::FindDurability(class ABP_ParentItem_C* Item)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ProjectileSpanner.BP_ProjectileSpanner_C.FindDurability"));
	...
	void ABP_ProjectileSpanner_C::ReturnDurability(float DurabilityAmount)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ProjectileSpanner.BP_ProjectileSpanner_C.ReturnDurability"));
	...
	void ABP_ProjectileSpanner_C::BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FVector& NormalImpulse, const struct FHitResult& Hit)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ProjectileSpanner.BP_ProjectileSpanner_C.BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature"));
	...
	void ABP_ProjectileSpanner_C::ReceiveBeginPlay()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ProjectileSpanner.BP_ProjectileSpanner_C.ReceiveBeginPlay"));
	...
	void ABP_ProjectileSpanner_C::ExecuteUbergraph_BP_ProjectileSpanner(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ProjectileSpanner.BP_ProjectileSpanner_C.ExecuteUbergraph_BP_ProjectileSpanner"));
	...
	UClass* ABP_ProjectileSpanner_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ProjectileSpanner.BP_ProjectileSpanner_C"));
		return ptr;
	}
