...
namespace CG
{
	...
	void ABP_ProjectileWater_C::BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FVector& NormalImpulse, const struct FHitResult& Hit)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ProjectileWater.BP_ProjectileWater_C.BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature"));
	...
	void ABP_ProjectileWater_C::ReceiveBeginPlay()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ProjectileWater.BP_ProjectileWater_C.ReceiveBeginPlay"));
	...
	void ABP_ProjectileWater_C::ExecuteUbergraph_BP_ProjectileWater(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ProjectileWater.BP_ProjectileWater_C.ExecuteUbergraph_BP_ProjectileWater"));
	...
	UClass* ABP_ProjectileWater_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ProjectileWater.BP_ProjectileWater_C"));
		return ptr;
	}
