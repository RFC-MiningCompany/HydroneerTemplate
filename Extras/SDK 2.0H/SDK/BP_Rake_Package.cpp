...
namespace CG
{
	...
	void ABP_Rake_C::LMBDownWhileCarrying(class ABP_GameController_C* Controller, class AActor* HitActor, const struct FVector& HitLocation, bool* ConsumeInput_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Rake.BP_Rake_C.LMBDownWhileCarrying"));
	...
	void ABP_Rake_C::TestIfCanUse()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Rake.BP_Rake_C.TestIfCanUse"));
	...
	void ABP_Rake_C::Box_Tracing(TArray<struct FHitResult>* OutHits, int32_t* Direction)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Rake.BP_Rake_C.Box Tracing"));
	...
	void ABP_Rake_C::OverridePickedup()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Rake.BP_Rake_C.OverridePickedup"));
	...
	void ABP_Rake_C::OverrideDroppedItem(class ABP_GameCharacter_C* Character)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Rake.BP_Rake_C.OverrideDroppedItem"));
	...
	void ABP_Rake_C::LocationTimer()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Rake.BP_Rake_C.LocationTimer"));
	...
	void ABP_Rake_C::OverrideAnimFinished()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Rake.BP_Rake_C.OverrideAnimFinished"));
	...
	void ABP_Rake_C::ExecuteUbergraph_BP_Rake(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Rake.BP_Rake_C.ExecuteUbergraph_BP_Rake"));
	...
	UClass* ABP_Rake_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_Rake.BP_Rake_C"));
		return ptr;
	}
