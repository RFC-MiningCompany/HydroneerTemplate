...
namespace CG
{
	...
	void ABP_RelicSpawner_C::ComponentsToSave(TArray<class UActorComponent*>* Components)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_RelicSpawner.BP_RelicSpawner_C.ComponentsToSave"));
	...
	void ABP_RelicSpawner_C::ActorPreSave()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_RelicSpawner.BP_RelicSpawner_C.ActorPreSave"));
	...
	void ABP_RelicSpawner_C::ActorSaved()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_RelicSpawner.BP_RelicSpawner_C.ActorSaved"));
	...
	void ABP_RelicSpawner_C::SpawnRelic()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_RelicSpawner.BP_RelicSpawner_C.SpawnRelic"));
	...
	void ABP_RelicSpawner_C::ActorLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_RelicSpawner.BP_RelicSpawner_C.ActorLoaded"));
	...
	void ABP_RelicSpawner_C::ExecuteUbergraph_BP_RelicSpawner(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_RelicSpawner.BP_RelicSpawner_C.ExecuteUbergraph_BP_RelicSpawner"));
	...
	UClass* ABP_RelicSpawner_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_RelicSpawner.BP_RelicSpawner_C"));
		return ptr;
	}
