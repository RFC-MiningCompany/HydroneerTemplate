...
namespace CG
{
	...
	public:
		...
		Engine_ETimelineDirection                                  Timeline_0__Direction_80C98A824FF68D8EB6D38BACDC93B9C5;  // 0x0294(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_ESLV[0x3];                                   // 0x0295(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		E_FishType_E_FishType                                      TargetFish;                                              // 0x02B0(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, SaveGame, IsPlainOldData, NoDestructor, HasGetValueTypeHash
