...
namespace CG
{
	...
	void ABP_Rod_C::LMBDownWhileCarrying(class ABP_GameController_C* Controller, class AActor* HitActor, const struct FVector& HitLocation, bool* ConsumeInput_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Rod.BP_Rod_C.LMBDownWhileCarrying"));
	...
	void ABP_Rod_C::SetUpRod()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Rod.BP_Rod_C.SetUpRod"));
	...
	void ABP_Rod_C::CreateDynamicRodMats()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Rod.BP_Rod_C.CreateDynamicRodMats"));
	...
	void ABP_Rod_C::UserConstructionScript()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Rod.BP_Rod_C.UserConstructionScript"));
	...
	void ABP_Rod_C::BndEvt__Bobber_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FVector& NormalImpulse, const struct FHitResult& Hit)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Rod.BP_Rod_C.BndEvt__Bobber_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature"));
	...
	void ABP_Rod_C::Bobbing()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Rod.BP_Rod_C.Bobbing"));
	...
	void ABP_Rod_C::StartFishing()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Rod.BP_Rod_C.StartFishing"));
	...
	void ABP_Rod_C::StopFishing()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Rod.BP_Rod_C.StopFishing"));
	...
	void ABP_Rod_C::SpawnFish()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Rod.BP_Rod_C.SpawnFish"));
	...
	void ABP_Rod_C::OverrideDroppedItem(class ABP_GameCharacter_C* Character)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Rod.BP_Rod_C.OverrideDroppedItem"));
	...
	void ABP_Rod_C::RMBDownWhileCarrying(class ABP_GameController_C* Controller, class AActor* Hit_Actor, const struct FVector& HitLocation)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Rod.BP_Rod_C.RMBDownWhileCarrying"));
	...
	void ABP_Rod_C::ActorLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Rod.BP_Rod_C.ActorLoaded"));
	...
	void ABP_Rod_C::StartCasting(class ABP_GameController_C* Controller)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Rod.BP_Rod_C.StartCasting"));
	...
	void ABP_Rod_C::ExecuteUbergraph_BP_Rod(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Rod.BP_Rod_C.ExecuteUbergraph_BP_Rod"));
	...
	UClass* ABP_Rod_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_Rod.BP_Rod_C"));
		return ptr;
	}
