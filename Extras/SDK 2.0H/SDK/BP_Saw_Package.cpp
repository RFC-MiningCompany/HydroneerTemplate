...
namespace CG
{
	...
	void ABP_Saw_C::LMBDownWhileCarrying(class ABP_GameController_C* Controller, class AActor* HitActor, const struct FVector& HitLocation, bool* ConsumeInput_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Saw.BP_Saw_C.LMBDownWhileCarrying"));
	...
	void ABP_Saw_C::SawObject(class ABP_ParentBar_C* Bar)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Saw.BP_Saw_C.SawObject"));
	...
	void ABP_Saw_C::Animate()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Saw.BP_Saw_C.Animate"));
	...
	void ABP_Saw_C::ExecuteUbergraph_BP_Saw(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Saw.BP_Saw_C.ExecuteUbergraph_BP_Saw"));
	...
	UClass* ABP_Saw_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_Saw.BP_Saw_C"));
		return ptr;
	}
