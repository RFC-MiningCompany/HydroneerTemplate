...
namespace CG
{
	...
	void ABP_ShelfSafe_C::LMBDownIsTarget(class UPrimitiveComponent* Component, class ABP_ParentItem_C* CarryingItem, class ABP_GameController_C* Insigator)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ShelfSafe.BP_ShelfSafe_C.LMBDownIsTarget"));
	...
	void ABP_ShelfSafe_C::ExecuteUbergraph_BP_ShelfSafe(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ShelfSafe.BP_ShelfSafe_C.ExecuteUbergraph_BP_ShelfSafe"));
	...
	UClass* ABP_ShelfSafe_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ShelfSafe.BP_ShelfSafe_C"));
		return ptr;
	}
