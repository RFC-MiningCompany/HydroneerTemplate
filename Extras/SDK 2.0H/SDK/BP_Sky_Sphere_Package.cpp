...
namespace CG
{
	...
	void ABP_Sky_Sphere_C::RefreshMaterial()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Sky_Sphere.BP_Sky_Sphere_C.RefreshMaterial"));
	...
	void ABP_Sky_Sphere_C::UpdateSunDirection()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Sky_Sphere.BP_Sky_Sphere_C.UpdateSunDirection"));
	...
	void ABP_Sky_Sphere_C::UserConstructionScript()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Sky_Sphere.BP_Sky_Sphere_C.UserConstructionScript"));
