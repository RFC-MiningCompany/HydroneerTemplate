...
namespace CG
{
	...
	void ABP_SmallFurnace_C::OnCompleted_F891126646B2254A9EBB3F8644EA3E18()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_SmallFurnace.BP_SmallFurnace_C.OnCompleted_F891126646B2254A9EBB3F8644EA3E18"));
	...
	void ABP_SmallFurnace_C::BndEvt__Sphere_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_SmallFurnace.BP_SmallFurnace_C.BndEvt__Sphere_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
	...
	void ABP_SmallFurnace_C::BndEvt__Sphere_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_SmallFurnace.BP_SmallFurnace_C.BndEvt__Sphere_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature"));
	...
	void ABP_SmallFurnace_C::OverridePlacedDown(class ABP_GameCharacter_C* Character)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_SmallFurnace.BP_SmallFurnace_C.OverridePlacedDown"));
	...
	void ABP_SmallFurnace_C::OverridePickedup()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_SmallFurnace.BP_SmallFurnace_C.OverridePickedup"));
	...
	void ABP_SmallFurnace_C::ActorLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_SmallFurnace.BP_SmallFurnace_C.ActorLoaded"));
	...
	void ABP_SmallFurnace_C::ExecuteUbergraph_BP_SmallFurnace(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_SmallFurnace.BP_SmallFurnace_C.ExecuteUbergraph_BP_SmallFurnace"));
	...
	UClass* ABP_SmallFurnace_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_SmallFurnace.BP_SmallFurnace_C"));
		return ptr;
	}
