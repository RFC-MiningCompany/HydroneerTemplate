...
namespace CG
{
	...
	public:
		...
		E_MetalType_E_MetalType                                    CurrentLiquidType;                                       // 0x03F0(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, SaveGame, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_F55G[0x3];                                   // 0x03F1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void SetNewLiquidType(E_MetalType_E_MetalType Type, float OreContent);
		void FindLiquidClass(class ABP_ParentResource_C* Resource, E_MetalType_E_MetalType* Type);
