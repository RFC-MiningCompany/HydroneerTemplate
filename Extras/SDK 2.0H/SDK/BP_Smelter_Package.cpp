...
namespace CG
{
	...
	void ABP_Smelter_C::CreateBar(class UClass* Bar)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.CreateBar"));
	...
	void ABP_Smelter_C::SetLiquidHeight()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.SetLiquidHeight"));
	...
	void ABP_Smelter_C::SetNewLiquidType(E_MetalType_E_MetalType Type, float OreContent)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.SetNewLiquidType"));
	...
	void ABP_Smelter_C::FindLiquidClass(class ABP_ParentResource_C* Resource, E_MetalType_E_MetalType* Type)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.FindLiquidClass"));
	...
	void ABP_Smelter_C::OverridePickedup()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.OverridePickedup"));
	...
	void ABP_Smelter_C::OverrideLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.OverrideLoaded"));
	...
	void ABP_Smelter_C::NewItemInPot(class ABP_ParentResource_C* Item)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.NewItemInPot"));
	...
	void ABP_Smelter_C::BndEvt__Cylinder_K2Node_ComponentBoundEvent_2_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.BndEvt__Cylinder_K2Node_ComponentBoundEvent_2_ComponentBeginOverlapSignature__DelegateSignature"));
	...
	void ABP_Smelter_C::SpawnBar()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.SpawnBar"));
	...
	void ABP_Smelter_C::PlayPourAnim()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.PlayPourAnim"));
	...
	void ABP_Smelter_C::LMBDownIsTarget(class UPrimitiveComponent* Component, class ABP_ParentItem_C* CarryingItem, class ABP_GameController_C* Insigator)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.LMBDownIsTarget"));
	...
	void ABP_Smelter_C::OverridePlacedDown(class ABP_GameCharacter_C* Character)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.OverridePlacedDown"));
	...
	void ABP_Smelter_C::OverrideDroppedItem(class ABP_GameCharacter_C* Character)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.OverrideDroppedItem"));
	...
	void ABP_Smelter_C::ExecuteUbergraph_BP_Smelter(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Smelter.BP_Smelter_C.ExecuteUbergraph_BP_Smelter"));
	...
	UClass* ABP_Smelter_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_Smelter.BP_Smelter_C"));
		return ptr;
	}
