...
namespace CG
{
	...
	void ABP_Spanner_C::LMBDownWhileCarrying(class ABP_GameController_C* Controller, class AActor* HitActor, const struct FVector& HitLocation, bool* ConsumeInput_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Spanner.BP_Spanner_C.LMBDownWhileCarrying"));
	...
	void ABP_Spanner_C::TryRepair(class ABP_ParentItem_C* RepairingTool)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Spanner.BP_Spanner_C.TryRepair"));
	...
	void ABP_Spanner_C::FindDurability(class ABP_ParentItem_C* Item)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Spanner.BP_Spanner_C.FindDurability"));
	...
	void ABP_Spanner_C::ReturnDurability(float DurabilityAmount)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Spanner.BP_Spanner_C.ReturnDurability"));
	...
	void ABP_Spanner_C::DoneRepair()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Spanner.BP_Spanner_C.DoneRepair"));
	...
	void ABP_Spanner_C::OverrideAnimFinished()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Spanner.BP_Spanner_C.OverrideAnimFinished"));
	...
	void ABP_Spanner_C::OverrideHit(class AActor* OtherActor)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Spanner.BP_Spanner_C.OverrideHit"));
	...
	void ABP_Spanner_C::ExecuteUbergraph_BP_Spanner(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_Spanner.BP_Spanner_C.ExecuteUbergraph_BP_Spanner"));
	...
	UClass* ABP_Spanner_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_Spanner.BP_Spanner_C"));
		return ptr;
	}
