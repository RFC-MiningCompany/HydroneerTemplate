...
namespace CG
{
	...
	void ABP_StandingTorch_C::SetProxyCollisionVisibility()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_StandingTorch.BP_StandingTorch_C.SetProxyCollisionVisibility"));
	...
	void ABP_StandingTorch_C::ReceiveBeginPlay()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_StandingTorch.BP_StandingTorch_C.ReceiveBeginPlay"));
	...
	void ABP_StandingTorch_C::OverrideLightOn()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_StandingTorch.BP_StandingTorch_C.OverrideLightOn"));
	...
	void ABP_StandingTorch_C::OverrideLightOff()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_StandingTorch.BP_StandingTorch_C.OverrideLightOff"));
	...
	void ABP_StandingTorch_C::ActorLoaded()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_StandingTorch.BP_StandingTorch_C.ActorLoaded"));
	...
	void ABP_StandingTorch_C::ExecuteUbergraph_BP_StandingTorch(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_StandingTorch.BP_StandingTorch_C.ExecuteUbergraph_BP_StandingTorch"));
	...
	UClass* ABP_StandingTorch_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_StandingTorch.BP_StandingTorch_C"));
		return ptr;
	}
