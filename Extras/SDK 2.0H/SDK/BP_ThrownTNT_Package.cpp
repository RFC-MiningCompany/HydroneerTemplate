...
namespace CG
{
	...
	void ABP_ThrownTNT_C::LMBDownWhileCarrying(class ABP_GameController_C* Controller, class AActor* HitActor, const struct FVector& HitLocation, bool* ConsumeInput_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ThrownTNT.BP_ThrownTNT_C.LMBDownWhileCarrying"));
	...
	void ABP_ThrownTNT_C::UserConstructionScript()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ThrownTNT.BP_ThrownTNT_C.UserConstructionScript"));
	...
	void ABP_ThrownTNT_C::Explode_Timer()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ThrownTNT.BP_ThrownTNT_C.Explode Timer"));
	...
	void ABP_ThrownTNT_C::Throw(class ABP_GameController_C* Controller)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ThrownTNT.BP_ThrownTNT_C.Throw"));
	...
	void ABP_ThrownTNT_C::ExecuteUbergraph_BP_ThrownTNT(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_ThrownTNT.BP_ThrownTNT_C.ExecuteUbergraph_BP_ThrownTNT"));
	...
	UClass* ABP_ThrownTNT_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ThrownTNT.BP_ThrownTNT_C"));
		return ptr;
	}
