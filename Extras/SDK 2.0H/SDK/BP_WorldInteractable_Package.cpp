...
namespace CG
{
	...
	void ABP_WorldInteractable_C::OverrideMouseClicked(class UActorComponent* Component, class ABP_GameController_C* Controller)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_WorldInteractable.BP_WorldInteractable_C.OverrideMouseClicked"));
	...
	void ABP_WorldInteractable_C::ExecuteUbergraph_BP_WorldInteractable(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function BP_WorldInteractable.BP_WorldInteractable_C.ExecuteUbergraph_BP_WorldInteractable"));
	...
	UClass* ABP_WorldInteractable_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_WorldInteractable.BP_WorldInteractable_C"));
		return ptr;
	}
