...
namespace CG
{
	...
	UClass* UClothConfigNv::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class ClothingSystemRuntimeNv.ClothConfigNv"));
		return ptr;
	}
	...
	UClass* UClothingSimulationFactoryNv::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class ClothingSystemRuntimeNv.ClothingSimulationFactoryNv"));
		return ptr;
	}
	...
	void UClothingSimulationInteractorNv::SetAnimDriveDamperStiffness(float InStiffness)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function ClothingSystemRuntimeNv.ClothingSimulationInteractorNv.SetAnimDriveDamperStiffness"));
	...
	UClass* UClothingSimulationInteractorNv::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class ClothingSystemRuntimeNv.ClothingSimulationInteractorNv"));
		return ptr;
	}
	...
	UClass* UClothPhysicalMeshDataNv_Legacy::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class ClothingSystemRuntimeNv.ClothPhysicalMeshDataNv_Legacy"));
		return ptr;
	}
