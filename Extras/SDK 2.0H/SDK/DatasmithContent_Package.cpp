...
namespace CG
{
	...
	UClass* UDatasmithAdditionalData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class DatasmithContent.DatasmithAdditionalData"));
		return ptr;
	}
	...
	UClass* UDatasmithTranslatedSceneImportData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class DatasmithContent.DatasmithTranslatedSceneImportData"));
		return ptr;
	}
	...
	UClass* UDatasmithFBXSceneImportData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class DatasmithContent.DatasmithFBXSceneImportData"));
		return ptr;
	}
	...
	UClass* UDatasmithIFCSceneImportData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class DatasmithContent.DatasmithIFCSceneImportData"));
		return ptr;
	}
	...
	UClass* UDatasmithStaticMeshIFCImportData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class DatasmithContent.DatasmithStaticMeshIFCImportData"));
		return ptr;
	}
	...
	class FString UDatasmithContentBlueprintLibrary::GetDatasmithUserDataValueForKey(class UObject* Object, const class FName& Key)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataValueForKey"));
	...
	void UDatasmithContentBlueprintLibrary::GetDatasmithUserDataKeysAndValuesForValue(class UObject* Object, const class FString& StringToMatch, TArray<class FName>* OutKeys, TArray<class FString>* OutValues)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataKeysAndValuesForValue"));
	...
	class UDatasmithAssetUserData* UDatasmithContentBlueprintLibrary::GetDatasmithUserData(class UObject* Object)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserData"));
	...
	UClass* UDatasmithCustomActionBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class DatasmithContent.DatasmithCustomActionBase"));
		return ptr;
	}
	...
	UClass* UDatasmithDecalComponentTemplate::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class DatasmithContent.DatasmithDecalComponentTemplate"));
		return ptr;
	}
	...
	void ADatasmithImportedSequencesActor::PlayLevelSequence(class ULevelSequence* SequenceToPlay)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function DatasmithContent.DatasmithImportedSequencesActor.PlayLevelSequence"));
	...
	UClass* ADatasmithImportedSequencesActor::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class DatasmithContent.DatasmithImportedSequencesActor"));
		return ptr;
	}
	...
	UClass* UDatasmithOptionsBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class DatasmithContent.DatasmithOptionsBase"));
		return ptr;
	}
	...
	UClass* UDatasmithCommonTessellationOptions::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class DatasmithContent.DatasmithCommonTessellationOptions"));
		return ptr;
	}
