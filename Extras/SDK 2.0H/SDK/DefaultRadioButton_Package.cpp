...
namespace CG
{
	...
	struct FSlateColor UDefaultRadioButton_C::GetTextColor()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function DefaultRadioButton.DefaultRadioButton_C.GetTextColor"));
	...
	void UDefaultRadioButton_C::BndEvt__MainButton_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function DefaultRadioButton.DefaultRadioButton_C.BndEvt__MainButton_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	...
	void UDefaultRadioButton_C::ExecuteUbergraph_DefaultRadioButton(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function DefaultRadioButton.DefaultRadioButton_C.ExecuteUbergraph_DefaultRadioButton"));
	...
	void UDefaultRadioButton_C::Clicked__DelegateSignature(int32_t Value)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function DefaultRadioButton.DefaultRadioButton_C.Clicked__DelegateSignature"));
	...
	UClass* UDefaultRadioButton_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass DefaultRadioButton.DefaultRadioButton_C"));
		return ptr;
	}
