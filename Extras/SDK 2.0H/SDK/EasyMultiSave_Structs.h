...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_B1NW[0x90];                                  // 0x0000(0x0090) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_6BVL[0x68];                                  // 0x0000(0x0068) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_A9KY[0x30];                                  // 0x0000(0x0030) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_7ZVZ[0x38];                                  // 0x0000(0x0038) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_LQ3B[0x28];                                  // 0x0000(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_0LYZ[0x80];                                  // 0x0000(0x0080) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_NP7V[0x20];                                  // 0x0000(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_PNNQ[0x50];                                  // 0x0000(0x0050) MISSED OFFSET (PADDING)
