...
namespace CG
{
	...
	void UFootstep_AnimNotify_C::FindFootstepType(class USkeletalMeshComponent* CharacterMesh, int32_t* Type)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Footstep_AnimNotify.Footstep_AnimNotify_C.FindFootstepType"));
	...
	bool UFootstep_AnimNotify_C::Received_Notify(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Footstep_AnimNotify.Footstep_AnimNotify_C.Received_Notify"));
	...
	UClass* UFootstep_AnimNotify_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass Footstep_AnimNotify.Footstep_AnimNotify_C"));
		return ptr;
	}
