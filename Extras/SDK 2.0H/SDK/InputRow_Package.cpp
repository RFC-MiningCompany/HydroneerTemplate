...
namespace CG
{
	...
	void UInputRow_C::PreConstruct(bool IsDesignTime)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function InputRow.InputRow_C.PreConstruct"));
	...
	void UInputRow_C::ExecuteUbergraph_InputRow(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function InputRow.InputRow_C.ExecuteUbergraph_InputRow"));
	...
	UClass* UInputRow_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass InputRow.InputRow_C"));
		return ptr;
	}
