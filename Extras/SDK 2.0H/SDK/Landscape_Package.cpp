...
namespace CG
{
	...
	UClass* AControlPointMeshActor::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class Landscape.ControlPointMeshActor"));
		return ptr;
	}
	...
	bool ALandscapeProxy::LandscapeExportHeightmapToRenderTarget(class UTextureRenderTarget2D* InRenderTarget, bool InExportHeightIntoRGChannel, bool InExportLandscapeProxies)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Landscape.LandscapeProxy.LandscapeExportHeightmapToRenderTarget"));
	...
	void ALandscapeBlueprintBrushBase::RequestLandscapeUpdate()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Landscape.LandscapeBlueprintBrushBase.RequestLandscapeUpdate"));
	...
	class UTextureRenderTarget2D* ALandscapeBlueprintBrushBase::Render(bool InIsHeightmap, class UTextureRenderTarget2D* InCombinedResult, const class FName& InWeightmapLayerName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Landscape.LandscapeBlueprintBrushBase.Render"));
	...
	void ALandscapeBlueprintBrushBase::Initialize(const struct FTransform& InLandscapeTransform, const struct FIntPoint& InLandscapeSize, const struct FIntPoint& InLandscapeRenderTargetSize)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Landscape.LandscapeBlueprintBrushBase.Initialize"));
	...
	void ALandscapeBlueprintBrushBase::GetBlueprintRenderDependencies(TArray<class UObject*>* OutStreamableAssets)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Landscape.LandscapeBlueprintBrushBase.GetBlueprintRenderDependencies"));
	...
	UClass* ALandscapeBlueprintBrushBase::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class Landscape.LandscapeBlueprintBrushBase"));
		return ptr;
	}
	...
	UClass* ULandscapeLODStreamingProxy::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class Landscape.LandscapeLODStreamingProxy"));
		return ptr;
	}
	...
	float ULandscapeComponent::EditorGetPaintLayerWeightByNameAtLocation(const struct FVector& InLocation, const class FName& InPaintLayerName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Landscape.LandscapeComponent.EditorGetPaintLayerWeightByNameAtLocation"));
	...
	float ULandscapeComponent::EditorGetPaintLayerWeightAtLocation(const struct FVector& InLocation, class ULandscapeLayerInfoObject* PaintLayer)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Landscape.LandscapeComponent.EditorGetPaintLayerWeightAtLocation"));
	...
	class ULandscapeComponent* ULandscapeHeightfieldCollisionComponent::GetRenderComponent()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Landscape.LandscapeHeightfieldCollisionComponent.GetRenderComponent"));
	...
	UClass* ULandscapeSettings::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class Landscape.LandscapeSettings"));
		return ptr;
	}
	...
	UClass* ULandscapeSubsystem::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class Landscape.LandscapeSubsystem"));
		return ptr;
	}
	...
	UClass* ULandscapeWeightmapUsage::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class Landscape.LandscapeWeightmapUsage"));
		return ptr;
	}
	...
	UClass* UMaterialExpressionLandscapePhysicalMaterialOutput::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class Landscape.MaterialExpressionLandscapePhysicalMaterialOutput"));
		return ptr;
	}
