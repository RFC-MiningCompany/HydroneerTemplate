...
namespace CG
{
	...
	void AMagicLeapARPinInfoActor_C::UpdatePinState()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapARPinInfoActor.MagicLeapARPinInfoActor_C.UpdatePinState"));
	...
	void AMagicLeapARPinInfoActor_C::UserConstructionScript()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapARPinInfoActor.MagicLeapARPinInfoActor_C.UserConstructionScript"));
	...
	void AMagicLeapARPinInfoActor_C::OnUpdateARPinState()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapARPinInfoActor.MagicLeapARPinInfoActor_C.OnUpdateARPinState"));
	...
	void AMagicLeapARPinInfoActor_C::ReceiveTick(float DeltaSeconds)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapARPinInfoActor.MagicLeapARPinInfoActor_C.ReceiveTick"));
	...
	void AMagicLeapARPinInfoActor_C::ExecuteUbergraph_MagicLeapARPinInfoActor(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapARPinInfoActor.MagicLeapARPinInfoActor_C.ExecuteUbergraph_MagicLeapARPinInfoActor"));
	...
	UClass* AMagicLeapARPinInfoActor_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass MagicLeapARPinInfoActor.MagicLeapARPinInfoActor_C"));
		return ptr;
	}
