...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_GTJC[0xA8];                                  // 0x0238(0x00A8) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_QOBW[0x3];                                   // 0x0179(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Y1PO[0x6];                                   // 0x019A(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_BPH3[0x5];                                   // 0x005B(0x0005) MISSED OFFSET (PADDING)
