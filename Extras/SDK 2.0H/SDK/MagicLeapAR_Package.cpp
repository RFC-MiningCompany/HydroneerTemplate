...
namespace CG
{
	...
	void ULuminARSessionFunctionLibrary::StartLuminARSession(class UObject* WorldContextObject, const struct FLatentActionInfo& LatentInfo, class ULuminARSessionConfig* Configuration)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapAR.LuminARSessionFunctionLibrary.StartLuminARSession"));
	...
	UClass* ULuminARSessionFunctionLibrary::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class MagicLeapAR.LuminARSessionFunctionLibrary"));
		return ptr;
	}
	...
	bool ULuminARFrameFunctionLibrary::LuminARLineTrace(class UObject* WorldContextObject, const struct FVector2D& ScreenPosition, TArray<struct FARTraceResult>* OutHitResults)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapAR.LuminARFrameFunctionLibrary.LuminARLineTrace"));
	...
	MagicLeapAR_ELuminARTrackingState ULuminARFrameFunctionLibrary::GetTrackingState()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapAR.LuminARFrameFunctionLibrary.GetTrackingState"));
	...
	UClass* ULuminARFrameFunctionLibrary::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class MagicLeapAR.LuminARFrameFunctionLibrary"));
		return ptr;
	}
	...
	class ULuminARCandidateImage* ULuminARImageTrackingFunctionLibrary::AddLuminRuntimeCandidateImageEx(class UARSessionConfig* SessionConfig, class UTexture2D* CandidateTexture, const class FString& FriendlyName, float PhysicalWidth, bool bUseUnreliablePose, bool bImageIsStationary, MagicLeapImageTracker_EMagicLeapImageTargetOrientation InAxisOrientation)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapAR.LuminARImageTrackingFunctionLibrary.AddLuminRuntimeCandidateImageEx"));
	...
	class ULuminARCandidateImage* ULuminARImageTrackingFunctionLibrary::AddLuminRuntimeCandidateImage(class UARSessionConfig* SessionConfig, class UTexture2D* CandidateTexture, const class FString& FriendlyName, float PhysicalWidth, bool bUseUnreliablePose, bool bImageIsStationary)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapAR.LuminARImageTrackingFunctionLibrary.AddLuminRuntimeCandidateImage"));
	...
	UClass* ULuminARImageTrackingFunctionLibrary::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class MagicLeapAR.LuminARImageTrackingFunctionLibrary"));
		return ptr;
	}
	...
	UClass* ALuminAROrigin::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class MagicLeapAR.LuminAROrigin"));
		return ptr;
	}
	...
	UClass* ULuminARSessionConfig::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class MagicLeapAR.LuminARSessionConfig"));
		return ptr;
	}
	...
	TArray<float> ULuminARLightEstimate::GetAmbientIntensityNits()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapAR.LuminARLightEstimate.GetAmbientIntensityNits"));
	...
	UClass* ULuminARLightEstimate::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class MagicLeapAR.LuminARLightEstimate"));
		return ptr;
	}
	...
	bool ULuminARCandidateImage::GetUseUnreliablePose()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapAR.LuminARCandidateImage.GetUseUnreliablePose"));
	...
	bool ULuminARCandidateImage::GetImageIsStationary()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapAR.LuminARCandidateImage.GetImageIsStationary"));
	...
	MagicLeapImageTracker_EMagicLeapImageTargetOrientation ULuminARCandidateImage::GetAxisOrientation()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapAR.LuminARCandidateImage.GetAxisOrientation"));
	...
	UClass* ULuminARCandidateImage::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class MagicLeapAR.LuminARCandidateImage"));
		return ptr;
	}
