...
namespace CG
{
	...
	bool UMagicLeapAudioFunctionLibrary::SetOnAudioJackUnpluggedDelegate(const class FScriptDelegate& ResultDelegate)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapAudio.MagicLeapAudioFunctionLibrary.SetOnAudioJackUnpluggedDelegate"));
	...
	bool UMagicLeapAudioFunctionLibrary::SetOnAudioJackPluggedDelegate(const class FScriptDelegate& ResultDelegate)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapAudio.MagicLeapAudioFunctionLibrary.SetOnAudioJackPluggedDelegate"));
	...
	bool UMagicLeapAudioFunctionLibrary::SetMicMute(bool IsMuted)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapAudio.MagicLeapAudioFunctionLibrary.SetMicMute"));
	...
	bool UMagicLeapAudioFunctionLibrary::IsMicMuted()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapAudio.MagicLeapAudioFunctionLibrary.IsMicMuted"));
	...
	UClass* UMagicLeapAudioFunctionLibrary::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class MagicLeapAudio.MagicLeapAudioFunctionLibrary"));
		return ptr;
	}
