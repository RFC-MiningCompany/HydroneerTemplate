...
namespace CG
{
	...
	bool UMagicLeapImageTrackerComponent::SetTargetAsync(class UTexture2D* ImageTarget)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapImageTracker.MagicLeapImageTrackerComponent.SetTargetAsync"));
	...
	bool UMagicLeapImageTrackerComponent::RemoveTargetAsync()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapImageTracker.MagicLeapImageTrackerComponent.RemoveTargetAsync"));
	...
	UClass* UMagicLeapImageTrackerComponent::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class MagicLeapImageTracker.MagicLeapImageTrackerComponent"));
		return ptr;
	}
	...
	void UMagicLeapImageTrackerFunctionLibrary::SetMaxSimultaneousTargets(int32_t MaxSimultaneousTargets)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapImageTracker.MagicLeapImageTrackerFunctionLibrary.SetMaxSimultaneousTargets"));
	...
	bool UMagicLeapImageTrackerFunctionLibrary::IsImageTrackingEnabled()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapImageTracker.MagicLeapImageTrackerFunctionLibrary.IsImageTrackingEnabled"));
	...
	int32_t UMagicLeapImageTrackerFunctionLibrary::GetMaxSimultaneousTargets()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapImageTracker.MagicLeapImageTrackerFunctionLibrary.GetMaxSimultaneousTargets"));
	...
	void UMagicLeapImageTrackerFunctionLibrary::EnableImageTracking(bool bEnable)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapImageTracker.MagicLeapImageTrackerFunctionLibrary.EnableImageTracking"));
	...
	UClass* UMagicLeapImageTrackerFunctionLibrary::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class MagicLeapImageTracker.MagicLeapImageTrackerFunctionLibrary"));
		return ptr;
	}
