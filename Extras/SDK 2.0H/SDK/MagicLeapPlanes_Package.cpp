...
namespace CG
{
	...
	bool UMagicLeapPlanesComponent::RequestPlanesAsync()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapPlanes.MagicLeapPlanesComponent.RequestPlanesAsync"));
	...
	UClass* UMagicLeapPlanesComponent::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class MagicLeapPlanes.MagicLeapPlanesComponent"));
		return ptr;
	}
	...
	void UMagicLeapPlanesFunctionLibrary::ReorderPlaneFlags(TArray<MagicLeapPlanes_EMagicLeapPlaneQueryFlags> InPriority, TArray<MagicLeapPlanes_EMagicLeapPlaneQueryFlags> InFlagsToReorder, TArray<MagicLeapPlanes_EMagicLeapPlaneQueryFlags>* OutReorderedFlags)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.ReorderPlaneFlags"));
	...
	bool UMagicLeapPlanesFunctionLibrary::RemovePersistentQuery(const struct FGuid& Handle)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.RemovePersistentQuery"));
	...
	void UMagicLeapPlanesFunctionLibrary::RemoveFlagsNotInQuery(TArray<MagicLeapPlanes_EMagicLeapPlaneQueryFlags> InQueryFlags, TArray<MagicLeapPlanes_EMagicLeapPlaneQueryFlags> InResultFlags, TArray<MagicLeapPlanes_EMagicLeapPlaneQueryFlags>* OutFlags)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.RemoveFlagsNotInQuery"));
	...
	bool UMagicLeapPlanesFunctionLibrary::PlanesQueryBeginAsync(const struct FMagicLeapPlanesQuery& Query, const class FScriptDelegate& ResultDelegate)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.PlanesQueryBeginAsync"));
	...
	bool UMagicLeapPlanesFunctionLibrary::PlanesPersistentQueryBeginAsync(const struct FMagicLeapPlanesQuery& Query, const struct FGuid& Handle, const class FScriptDelegate& ResultDelegate)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.PlanesPersistentQueryBeginAsync"));
	...
	bool UMagicLeapPlanesFunctionLibrary::IsTrackerValid()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.IsTrackerValid"));
	...
	struct FTransform UMagicLeapPlanesFunctionLibrary::GetContentScale(class AActor* ContentActor, const struct FMagicLeapPlaneResult& PlaneResult)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.GetContentScale"));
	...
	bool UMagicLeapPlanesFunctionLibrary::DestroyTracker()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.DestroyTracker"));
	...
	bool UMagicLeapPlanesFunctionLibrary::CreateTracker()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.CreateTracker"));
	...
	struct FGuid UMagicLeapPlanesFunctionLibrary::AddPersistentQuery(MagicLeapPlanes_EMagicLeapPlaneQueryType PersistentQueryType)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.AddPersistentQuery"));
	...
	UClass* UMagicLeapPlanesFunctionLibrary::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class MagicLeapPlanes.MagicLeapPlanesFunctionLibrary"));
		return ptr;
	}
