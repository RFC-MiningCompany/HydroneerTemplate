...
namespace CG
{
	...
	bool UMagicLeapPrivilegesFunctionLibrary::RequestPrivilegeAsync(MagicLeapPrivileges_EMagicLeapPrivilege Privilege, const class FScriptDelegate& ResultDelegate)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapPrivileges.MagicLeapPrivilegesFunctionLibrary.RequestPrivilegeAsync"));
	...
	bool UMagicLeapPrivilegesFunctionLibrary::RequestPrivilege(MagicLeapPrivileges_EMagicLeapPrivilege Privilege)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapPrivileges.MagicLeapPrivilegesFunctionLibrary.RequestPrivilege"));
	...
	bool UMagicLeapPrivilegesFunctionLibrary::CheckPrivilege(MagicLeapPrivileges_EMagicLeapPrivilege Privilege)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MagicLeapPrivileges.MagicLeapPrivilegesFunctionLibrary.CheckPrivilege"));
	...
	UClass* UMagicLeapPrivilegesFunctionLibrary::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class MagicLeapPrivileges.MagicLeapPrivilegesFunctionLibrary"));
		return ptr;
	}
