...
namespace CG
{
	...
	UClass* UCGameEngine::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class Mining.CGameEngine"));
		return ptr;
	}
	...
	void UCGameInstance::DiscordRunCallbacks()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CGameInstance.DiscordRunCallbacks"));
	...
	UClass* UCGameInstance::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class Mining.CGameInstance"));
		return ptr;
	}
	...
	bool UCHydroneerLibrary::StringToClassRef(const class FString& ClassStringName, class UClass** OutClass)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerLibrary.StringToClassRef"));
	...
	class FString UCHydroneerLibrary::SanitizeString(const class FString& Filename)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerLibrary.SanitizeString"));
	...
	bool UCHydroneerLibrary::RenameSave(const class FString& OriginalSaveName, const class FString& NewSaveName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerLibrary.RenameSave"));
	...
	void UCHydroneerLibrary::ReloadInput(bool bReload)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerLibrary.ReloadInput"));
	...
	class FString UCHydroneerLibrary::GetSaveDirectory()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerLibrary.GetSaveDirectory"));
	...
	void UCHydroneerLibrary::GetSaveBackupNames(const class FString& SaveName, TArray<class FString>* OutBackups)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerLibrary.GetSaveBackupNames"));
	...
	int32_t UCHydroneerLibrary::GetHighestCurrentSaveIndex(const class FString& SaveName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerLibrary.GetHighestCurrentSaveIndex"));
	...
	class FString UCHydroneerLibrary::GetAppdataLocalDir()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerLibrary.GetAppdataLocalDir"));
	...
	TArray<class FString> UCHydroneerLibrary::FindFolders(const class FString& FilePath)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerLibrary.FindFolders"));
	...
	void UCHydroneerLibrary::CopyOverDirectory(const class FString& OldDirectory, const class FString& NewDirectory)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerLibrary.CopyOverDirectory"));
	...
	void UCHydroneerLibrary::BackupSave(const class FString& SaveName, bool bIncrementSave, int32_t MaxIncrements)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerLibrary.BackupSave"));
	...
	UClass* UCHydroneerLibrary::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class Mining.CHydroneerLibrary"));
		return ptr;
	}
	...
	class UCHydroneerProjectSettings* UCHydroneerProjectSettings::Get()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CHydroneerProjectSettings.Get"));
	...
	UClass* UCHydroneerProjectSettings::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class Mining.CHydroneerProjectSettings"));
		return ptr;
	}
	...
	void UCModdingSubsystem::UnloadMod(const class FString& ModName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CModdingSubsystem.UnloadMod"));
	...
	void UCModdingSubsystem::UninstallUnsubscribedMods()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CModdingSubsystem.UninstallUnsubscribedMods"));
	...
	void UCModdingSubsystem::LoadMod(const class FString& ModName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CModdingSubsystem.LoadMod"));
	...
	void UCModdingSubsystem::InstallAllPending()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CModdingSubsystem.InstallAllPending"));
	...
	class UCModdingSubsystem* UCModdingSubsystem::GetModdingSubsystem()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CModdingSubsystem.GetModdingSubsystem"));
	...
	TArray<class FString> UCModdingSubsystem::GetLoadedMods()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CModdingSubsystem.GetLoadedMods"));
	...
	TArray<class FString> UCModdingSubsystem::GetInstalledMods()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CModdingSubsystem.GetInstalledMods"));
	...
	TArray<struct FPublishedFileID> UCModdingSubsystem::GetAllSubscribedMods()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function Mining.CModdingSubsystem.GetAllSubscribedMods"));
	...
	UClass* UCModdingSubsystem::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class Mining.CModdingSubsystem"));
		return ptr;
	}
	...
	UClass* ULocalCableComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class Mining.LocalCableComponent"));
		return ptr;
	}
