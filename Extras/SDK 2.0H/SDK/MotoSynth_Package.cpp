...
namespace CG
{
	...
	UClass* UMotoSynthPreset::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class MotoSynth.MotoSynthPreset"));
		return ptr;
	}
	...
	UClass* UMotoSynthSource::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class MotoSynth.MotoSynthSource"));
		return ptr;
	}
	...
	void USynthComponentMoto::SetSettings(const struct FMotoSynthRuntimeSettings& InSettings)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MotoSynth.SynthComponentMoto.SetSettings"));
	...
	void USynthComponentMoto::SetRPM(float InRPM, float InTimeSec)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MotoSynth.SynthComponentMoto.SetRPM"));
	...
	bool USynthComponentMoto::IsEnabled()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MotoSynth.SynthComponentMoto.IsEnabled"));
	...
	void USynthComponentMoto::GetRPMRange(float* OutMinRPM, float* OutMaxRPM)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function MotoSynth.SynthComponentMoto.GetRPMRange"));
	...
	UClass* USynthComponentMoto::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class MotoSynth.SynthComponentMoto"));
		return ptr;
	}
