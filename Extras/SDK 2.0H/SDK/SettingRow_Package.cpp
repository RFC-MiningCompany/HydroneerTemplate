...
namespace CG
{
	...
	void USettingRow_C::PreConstruct(bool IsDesignTime)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function SettingRow.SettingRow_C.PreConstruct"));
	...
	void USettingRow_C::ExecuteUbergraph_SettingRow(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function SettingRow.SettingRow_C.ExecuteUbergraph_SettingRow"));
	...
	UClass* USettingRow_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass SettingRow.SettingRow_C"));
		return ptr;
	}
