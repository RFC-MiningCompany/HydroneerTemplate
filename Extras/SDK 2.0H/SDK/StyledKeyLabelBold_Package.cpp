...
namespace CG
{
	...
	struct FSlateBrush UStyledKeyLabelBold_C::GetIconBrush()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function StyledKeyLabelBold.StyledKeyLabelBold_C.GetIconBrush"));
	...
	class FText UStyledKeyLabelBold_C::GetDisplayNameUpper()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function StyledKeyLabelBold.StyledKeyLabelBold_C.GetDisplayNameUpper"));
	...
	void UStyledKeyLabelBold_C::UpdateKeyLabel()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function StyledKeyLabelBold.StyledKeyLabelBold_C.UpdateKeyLabel"));
	...
	void UStyledKeyLabelBold_C::ExecuteUbergraph_StyledKeyLabelBold(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function StyledKeyLabelBold.StyledKeyLabelBold_C.ExecuteUbergraph_StyledKeyLabelBold"));
	...
	UClass* UStyledKeyLabelBold_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass StyledKeyLabelBold.StyledKeyLabelBold_C"));
		return ptr;
	}
