...
namespace CG
{
	...
	struct FSlateBrush UStyledKeyLabel_C::GetIconBrush()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function StyledKeyLabel.StyledKeyLabel_C.GetIconBrush"));
	...
	class FText UStyledKeyLabel_C::GetDisplayNameUpper()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function StyledKeyLabel.StyledKeyLabel_C.GetDisplayNameUpper"));
	...
	void UStyledKeyLabel_C::UpdateKeyLabel()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function StyledKeyLabel.StyledKeyLabel_C.UpdateKeyLabel"));
	...
	void UStyledKeyLabel_C::ExecuteUbergraph_StyledKeyLabel(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function StyledKeyLabel.StyledKeyLabel_C.ExecuteUbergraph_StyledKeyLabel"));
	...
	UClass* UStyledKeyLabel_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass StyledKeyLabel.StyledKeyLabel_C"));
		return ptr;
	}
