...
namespace CG
{
	...
	struct FSlateColor UStyledRadioButton_C::GetColour()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function StyledRadioButton.StyledRadioButton_C.GetColour"));
	...
	void UStyledRadioButton_C::BndEvt__MainButton_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function StyledRadioButton.StyledRadioButton_C.BndEvt__MainButton_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	...
	void UStyledRadioButton_C::ExecuteUbergraph_StyledRadioButton(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function StyledRadioButton.StyledRadioButton_C.ExecuteUbergraph_StyledRadioButton"));
	...
	UClass* UStyledRadioButton_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass StyledRadioButton.StyledRadioButton_C"));
		return ptr;
	}
