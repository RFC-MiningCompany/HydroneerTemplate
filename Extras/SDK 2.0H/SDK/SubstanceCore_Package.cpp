...
namespace CG
{
	...
	class UMaterialInstanceDynamic* USubstanceGraphInstance::GetDynamicMaterialInstance(const class FName& Name, class UMaterial* InParentMaterial)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function SubstanceCore.SubstanceGraphInstance.GetDynamicMaterialInstance"));
	...
	UClass* USubstanceOutputData::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class SubstanceCore.SubstanceOutputData"));
		return ptr;
	}
