...
namespace CG
{
	...
	UClass* UTemplateSequence::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class TemplateSequence.TemplateSequence"));
		return ptr;
	}
	...
	UClass* UCameraAnimationSequence::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class TemplateSequence.CameraAnimationSequence"));
		return ptr;
	}
	...
	UClass* USequenceCameraShakeCameraStandIn::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class TemplateSequence.SequenceCameraShakeCameraStandIn"));
		return ptr;
	}
	...
	UClass* USequenceCameraShake::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class TemplateSequence.SequenceCameraShake"));
		return ptr;
	}
	...
	UClass* USequenceCameraShakeSequencePlayer::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class TemplateSequence.SequenceCameraShakeSequencePlayer"));
		return ptr;
	}
	...
	void ATemplateSequenceActor::SetSequence(class UTemplateSequence* InSequence)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function TemplateSequence.TemplateSequenceActor.SetSequence"));
	...
	void ATemplateSequenceActor::SetBinding(class AActor* Actor)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function TemplateSequence.TemplateSequenceActor.SetBinding"));
	...
	class UTemplateSequence* ATemplateSequenceActor::LoadSequence()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function TemplateSequence.TemplateSequenceActor.LoadSequence"));
	...
	class UTemplateSequencePlayer* ATemplateSequenceActor::GetSequencePlayer()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function TemplateSequence.TemplateSequenceActor.GetSequencePlayer"));
	...
	class UTemplateSequence* ATemplateSequenceActor::GetSequence()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function TemplateSequence.TemplateSequenceActor.GetSequence"));
	...
	UClass* ATemplateSequenceActor::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class TemplateSequence.TemplateSequenceActor"));
		return ptr;
	}
	...
	class UTemplateSequencePlayer* UTemplateSequencePlayer::CreateTemplateSequencePlayer(class UObject* WorldContextObject, class UTemplateSequence* TemplateSequence, const struct FMovieSceneSequencePlaybackSettings& Settings, class ATemplateSequenceActor** OutActor)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function TemplateSequence.TemplateSequencePlayer.CreateTemplateSequencePlayer"));
	...
	UClass* UTemplateSequencePlayer::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class TemplateSequence.TemplateSequencePlayer"));
		return ptr;
	}
	...
	UClass* UTemplateSequenceSection::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class TemplateSequence.TemplateSequenceSection"));
		return ptr;
	}
	...
	UClass* UTemplateSequenceSystem::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class TemplateSequence.TemplateSequenceSystem"));
		return ptr;
	}
	...
	UClass* UTemplateSequenceTrack::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class TemplateSequence.TemplateSequenceTrack"));
		return ptr;
	}
