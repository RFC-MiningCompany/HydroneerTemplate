...
namespace CG
{
	...
	void UUI_Badge_C::Construct()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_Badge.UI_Badge_C.Construct"));
	...
	void UUI_Badge_C::ExecuteUbergraph_UI_Badge(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_Badge.UI_Badge_C.ExecuteUbergraph_UI_Badge"));
	...
	UClass* UUI_Badge_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass UI_Badge.UI_Badge_C"));
		return ptr;
	}
