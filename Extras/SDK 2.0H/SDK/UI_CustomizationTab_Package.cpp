...
namespace CG
{
	...
	void UUI_CustomizationTab_C::OnSelected()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_CustomizationTab.UI_CustomizationTab_C.OnSelected"));
	...
	void UUI_CustomizationTab_C::UpdateSelection(class UWidget* Widget)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_CustomizationTab.UI_CustomizationTab_C.UpdateSelection"));
	...
	void UUI_CustomizationTab_C::PreConstruct(bool IsDesignTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_CustomizationTab.UI_CustomizationTab_C.PreConstruct"));
	...
	void UUI_CustomizationTab_C::BndEvt__UI_CustomizationOption_Button_Option_K2Node_ComponentBoundEvent_1_OnButtonPressedEvent__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_CustomizationTab.UI_CustomizationTab_C.BndEvt__UI_CustomizationOption_Button_Option_K2Node_ComponentBoundEvent_1_OnButtonPressedEvent__DelegateSignature"));
	...
	void UUI_CustomizationTab_C::ExecuteUbergraph_UI_CustomizationTab(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_CustomizationTab.UI_CustomizationTab_C.ExecuteUbergraph_UI_CustomizationTab"));
	...
	void UUI_CustomizationTab_C::OnPressed__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_CustomizationTab.UI_CustomizationTab_C.OnPressed__DelegateSignature"));
	...
	UClass* UUI_CustomizationTab_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass UI_CustomizationTab.UI_CustomizationTab_C"));
		return ptr;
	}
