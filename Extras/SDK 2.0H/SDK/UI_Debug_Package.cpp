...
namespace CG
{
	...
	class FText UUI_Debug_C::GetText_1()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_Debug.UI_Debug_C.GetText_1"));
	...
	UClass* UUI_Debug_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass UI_Debug.UI_Debug_C"));
		return ptr;
	}
