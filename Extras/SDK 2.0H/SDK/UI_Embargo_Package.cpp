...
namespace CG
{
	...
	void UUI_Embargo_C::BndEvt__UI_Embargo_Exit_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_Embargo.UI_Embargo_C.BndEvt__UI_Embargo_Exit_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	...
	void UUI_Embargo_C::BndEvt__UI_Embargo_Agree_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_Embargo.UI_Embargo_C.BndEvt__UI_Embargo_Agree_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature"));
	...
	void UUI_Embargo_C::ExecuteUbergraph_UI_Embargo(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_Embargo.UI_Embargo_C.ExecuteUbergraph_UI_Embargo"));
	...
	UClass* UUI_Embargo_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass UI_Embargo.UI_Embargo_C"));
		return ptr;
	}
