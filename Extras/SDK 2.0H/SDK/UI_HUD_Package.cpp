...
namespace CG
{
	...
	void UUI_HUD_C::AddBadges(TArray<E_Badges_E_Badges>* Badges, class UPanelWidget* Target)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_HUD.UI_HUD_C.AddBadges"));
	...
	void UUI_HUD_C::SetPriceBox(int32_t Amount, class ABP_ParentItem_C* StoreItem)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_HUD.UI_HUD_C.SetPriceBox"));
	...
	void UUI_HUD_C::NewItemPickedUp(const class FText& Name, const class FText& Description, TArray<E_Badges_E_Badges> Badges)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_HUD.UI_HUD_C.NewItemPickedUp"));
	...
	void UUI_HUD_C::ItemDropped()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_HUD.UI_HUD_C.ItemDropped"));
	...
	void UUI_HUD_C::VehicleTipBoxShow(bool Show_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_HUD.UI_HUD_C.VehicleTipBoxShow"));
	...
	void UUI_HUD_C::SetCrosshair(E_Crosshairs_E_Crosshairs Type)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_HUD.UI_HUD_C.SetCrosshair"));
	...
	void UUI_HUD_C::Saving_(bool Saving_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_HUD.UI_HUD_C.Saving?"));
	...
	void UUI_HUD_C::ToggleCrosshair(bool Show_)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_HUD.UI_HUD_C.ToggleCrosshair"));
	...
	void UUI_HUD_C::ExecuteUbergraph_UI_HUD(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_HUD.UI_HUD_C.ExecuteUbergraph_UI_HUD"));
	...
	UClass* UUI_HUD_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass UI_HUD.UI_HUD_C"));
		return ptr;
	}
