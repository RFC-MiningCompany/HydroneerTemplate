...
namespace CG
{
	...
	void UUI_MapPlayerLocation_C::UpdateSelection(int32_t PlayerIndex)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_MapPlayerLocation.UI_MapPlayerLocation_C.UpdateSelection"));
	...
	void UUI_MapPlayerLocation_C::PreConstruct(bool IsDesignTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_MapPlayerLocation.UI_MapPlayerLocation_C.PreConstruct"));
	...
	void UUI_MapPlayerLocation_C::ExecuteUbergraph_UI_MapPlayerLocation(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_MapPlayerLocation.UI_MapPlayerLocation_C.ExecuteUbergraph_UI_MapPlayerLocation"));
	...
	UClass* UUI_MapPlayerLocation_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass UI_MapPlayerLocation.UI_MapPlayerLocation_C"));
		return ptr;
	}
