...
namespace CG
{
	...
	void UUI_Menu_ModItem_C::BndEvt__UI_Menu_ModItem_Sub_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_ModItem.UI_Menu_ModItem_C.BndEvt__UI_Menu_ModItem_Sub_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	...
	void UUI_Menu_ModItem_C::ExecuteUbergraph_UI_Menu_ModItem(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_ModItem.UI_Menu_ModItem_C.ExecuteUbergraph_UI_Menu_ModItem"));
	...
	void UUI_Menu_ModItem_C::Unsubscribe__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_ModItem.UI_Menu_ModItem_C.Unsubscribe__DelegateSignature"));
	...
	void UUI_Menu_ModItem_C::Subscribe__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_ModItem.UI_Menu_ModItem_C.Subscribe__DelegateSignature"));
	...
	UClass* UUI_Menu_ModItem_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass UI_Menu_ModItem.UI_Menu_ModItem_C"));
		return ptr;
	}
