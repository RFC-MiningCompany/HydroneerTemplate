...
namespace CG
{
	...
	void UUI_Menu_PatchNotes_C::Construct()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_PatchNotes.UI_Menu_PatchNotes_C.Construct"));
	...
	void UUI_Menu_PatchNotes_C::ExecuteUbergraph_UI_Menu_PatchNotes(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_Menu_PatchNotes.UI_Menu_PatchNotes_C.ExecuteUbergraph_UI_Menu_PatchNotes"));
	...
	UClass* UUI_Menu_PatchNotes_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass UI_Menu_PatchNotes.UI_Menu_PatchNotes_C"));
		return ptr;
	}
