...
namespace CG
{
	...
	public:
		...
		class FScriptMulticastDelegate                             OnThumbnailSelected;                                     // 0x0278(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
