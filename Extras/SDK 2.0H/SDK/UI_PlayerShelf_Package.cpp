...
namespace CG
{
	...
	void UUI_PlayerShelf_C::ThumbnailSelected(class APlayerController* PlayerController, int32_t SessionID, class UTextureRenderTarget2D* RenderTarget)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_PlayerShelf.UI_PlayerShelf_C.ThumbnailSelected"));
	...
	void UUI_PlayerShelf_C::AddPlayer(class APlayerController* PlayerController, int32_t SessionID)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_PlayerShelf.UI_PlayerShelf_C.AddPlayer"));
	...
	void UUI_PlayerShelf_C::BndEvt__UI_MenuPlayers_Button_AddPlayer_K2Node_ComponentBoundEvent_0_OnButtonPressedEvent__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_PlayerShelf.UI_PlayerShelf_C.BndEvt__UI_MenuPlayers_Button_AddPlayer_K2Node_ComponentBoundEvent_0_OnButtonPressedEvent__DelegateSignature"));
	...
	void UUI_PlayerShelf_C::Construct()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_PlayerShelf.UI_PlayerShelf_C.Construct"));
	...
	void UUI_PlayerShelf_C::ExecuteUbergraph_UI_PlayerShelf(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_PlayerShelf.UI_PlayerShelf_C.ExecuteUbergraph_UI_PlayerShelf"));
	...
	void UUI_PlayerShelf_C::OnThumbnailSelected__DelegateSignature(class APlayerController* PlayerController, int32_t SessionID, class UTextureRenderTarget2D* RenderTarget)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_PlayerShelf.UI_PlayerShelf_C.OnThumbnailSelected__DelegateSignature"));
	...
	UClass* UUI_PlayerShelf_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass UI_PlayerShelf.UI_PlayerShelf_C"));
		return ptr;
	}
