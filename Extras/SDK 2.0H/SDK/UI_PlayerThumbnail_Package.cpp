...
namespace CG
{
	...
	void UUI_PlayerThumbnail_C::CreateAndSetRenderTarget()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_PlayerThumbnail.UI_PlayerThumbnail_C.CreateAndSetRenderTarget"));
	...
	void UUI_PlayerThumbnail_C::SetBarColor()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_PlayerThumbnail.UI_PlayerThumbnail_C.SetBarColor"));
	...
	void UUI_PlayerThumbnail_C::PreConstruct(bool IsDesignTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_PlayerThumbnail.UI_PlayerThumbnail_C.PreConstruct"));
	...
	void UUI_PlayerThumbnail_C::BndEvt__UI_CharacterThumbnail_Button_Player_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_PlayerThumbnail.UI_PlayerThumbnail_C.BndEvt__UI_CharacterThumbnail_Button_Player_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	...
	void UUI_PlayerThumbnail_C::Construct()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_PlayerThumbnail.UI_PlayerThumbnail_C.Construct"));
	...
	void UUI_PlayerThumbnail_C::OnPlayerDestroyed(class AActor* DestroyedActor)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_PlayerThumbnail.UI_PlayerThumbnail_C.OnPlayerDestroyed"));
	...
	void UUI_PlayerThumbnail_C::Tick(const struct FGeometry& MyGeometry, float InDeltaTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_PlayerThumbnail.UI_PlayerThumbnail_C.Tick"));
	...
	void UUI_PlayerThumbnail_C::BndEvt__UI_PlayerThumbnail_Button_Player_K2Node_ComponentBoundEvent_1_OnButtonHoverEvent__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_PlayerThumbnail.UI_PlayerThumbnail_C.BndEvt__UI_PlayerThumbnail_Button_Player_K2Node_ComponentBoundEvent_1_OnButtonHoverEvent__DelegateSignature"));
	...
	void UUI_PlayerThumbnail_C::BndEvt__UI_PlayerThumbnail_Button_Player_K2Node_ComponentBoundEvent_2_OnButtonHoverEvent__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_PlayerThumbnail.UI_PlayerThumbnail_C.BndEvt__UI_PlayerThumbnail_Button_Player_K2Node_ComponentBoundEvent_2_OnButtonHoverEvent__DelegateSignature"));
	...
	void UUI_PlayerThumbnail_C::ExecuteUbergraph_UI_PlayerThumbnail(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_PlayerThumbnail.UI_PlayerThumbnail_C.ExecuteUbergraph_UI_PlayerThumbnail"));
	...
	void UUI_PlayerThumbnail_C::OnThumbnailSelected__DelegateSignature(class APlayerController* PlayerController, int32_t SessionID, class UTextureRenderTarget2D* RenderTarget)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_PlayerThumbnail.UI_PlayerThumbnail_C.OnThumbnailSelected__DelegateSignature"));
	...
	UClass* UUI_PlayerThumbnail_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass UI_PlayerThumbnail.UI_PlayerThumbnail_C"));
		return ptr;
	}
