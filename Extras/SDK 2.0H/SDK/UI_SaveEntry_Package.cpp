...
namespace CG
{
	...
	void UUI_SaveEntry_C::Construct()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_SaveEntry.UI_SaveEntry_C.Construct"));
	...
	void UUI_SaveEntry_C::BndEvt__UI_SaveEntry_Button_0_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_SaveEntry.UI_SaveEntry_C.BndEvt__UI_SaveEntry_Button_0_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	...
	void UUI_SaveEntry_C::ExecuteUbergraph_UI_SaveEntry(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_SaveEntry.UI_SaveEntry_C.ExecuteUbergraph_UI_SaveEntry"));
	...
	UClass* UUI_SaveEntry_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass UI_SaveEntry.UI_SaveEntry_C"));
		return ptr;
	}
