...
namespace CG
{
	...
	public:
		...
		E_ClothingSlots_E_ClothingSlots                            ClothingSlot;                                            // 0x02A0(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_IOXJ[0x7];                                   // 0x02A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Init(TArray<class UPData_Customizable_Base_C*>* Options);
