...
namespace CG
{
	...
	void UUI_StylePanel_C::Update(class UWidget* Widget)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_StylePanel.UI_StylePanel_C.Update"));
	...
	void UUI_StylePanel_C::Init(TArray<class UPData_Customizable_Base_C*>* Options)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_StylePanel.UI_StylePanel_C.Init"));
	...
	void UUI_StylePanel_C::PreConstruct(bool IsDesignTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_StylePanel.UI_StylePanel_C.PreConstruct"));
	...
	void UUI_StylePanel_C::ExecuteUbergraph_UI_StylePanel(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_StylePanel.UI_StylePanel_C.ExecuteUbergraph_UI_StylePanel"));
	...
	void UUI_StylePanel_C::OnUpdateStyle__DelegateSignature(int32_t StyleIndex)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_StylePanel.UI_StylePanel_C.OnUpdateStyle__DelegateSignature"));
	...
	UClass* UUI_StylePanel_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass UI_StylePanel.UI_StylePanel_C"));
		return ptr;
	}
