...
namespace CG
{
	...
	void UUI_SwatchColor_C::UpdateSelection(const class FName& ColorID)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_SwatchColor.UI_SwatchColor_C.UpdateSelection"));
	...
	void UUI_SwatchColor_C::OnSelect()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_SwatchColor.UI_SwatchColor_C.OnSelect"));
	...
	void UUI_SwatchColor_C::BndEvt__UI_ColorSwatch_Button_Swatch_K2Node_ComponentBoundEvent_1_OnButtonPressedEvent__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_SwatchColor.UI_SwatchColor_C.BndEvt__UI_ColorSwatch_Button_Swatch_K2Node_ComponentBoundEvent_1_OnButtonPressedEvent__DelegateSignature"));
	...
	void UUI_SwatchColor_C::BndEvt__UI_ColorSwatch_Button_Swatch_K2Node_ComponentBoundEvent_0_OnButtonHoverEvent__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_SwatchColor.UI_SwatchColor_C.BndEvt__UI_ColorSwatch_Button_Swatch_K2Node_ComponentBoundEvent_0_OnButtonHoverEvent__DelegateSignature"));
	...
	void UUI_SwatchColor_C::BndEvt__UI_SwatchColor_Button_Swatch_K2Node_ComponentBoundEvent_2_OnButtonHoverEvent__DelegateSignature()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_SwatchColor.UI_SwatchColor_C.BndEvt__UI_SwatchColor_Button_Swatch_K2Node_ComponentBoundEvent_2_OnButtonHoverEvent__DelegateSignature"));
	...
	void UUI_SwatchColor_C::PreConstruct(bool IsDesignTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_SwatchColor.UI_SwatchColor_C.PreConstruct"));
	...
	void UUI_SwatchColor_C::ExecuteUbergraph_UI_SwatchColor(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_SwatchColor.UI_SwatchColor_C.ExecuteUbergraph_UI_SwatchColor"));
	...
	void UUI_SwatchColor_C::OnSelected__DelegateSignature(const class FName& ColorID)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_SwatchColor.UI_SwatchColor_C.OnSelected__DelegateSignature"));
	...
	UClass* UUI_SwatchColor_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass UI_SwatchColor.UI_SwatchColor_C"));
		return ptr;
	}
