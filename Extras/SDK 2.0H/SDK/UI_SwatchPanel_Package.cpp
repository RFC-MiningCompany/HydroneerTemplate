...
namespace CG
{
	...
	void UUI_SwatchPanel_C::Init()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_SwatchPanel.UI_SwatchPanel_C.Init"));
	...
	void UUI_SwatchPanel_C::UpdateSelectionColor(const class FName& ColorID)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_SwatchPanel.UI_SwatchPanel_C.UpdateSelectionColor"));
	...
	void UUI_SwatchPanel_C::PreConstruct(bool IsDesignTime)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_SwatchPanel.UI_SwatchPanel_C.PreConstruct"));
	...
	void UUI_SwatchPanel_C::ExecuteUbergraph_UI_SwatchPanel(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_SwatchPanel.UI_SwatchPanel_C.ExecuteUbergraph_UI_SwatchPanel"));
	...
	void UUI_SwatchPanel_C::OnUpdate__DelegateSignature(const class FName& ColorID)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_SwatchPanel.UI_SwatchPanel_C.OnUpdate__DelegateSignature"));
	...
	UClass* UUI_SwatchPanel_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass UI_SwatchPanel.UI_SwatchPanel_C"));
		return ptr;
	}
