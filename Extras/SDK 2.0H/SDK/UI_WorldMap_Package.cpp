...
namespace CG
{
	...
	void UUI_WorldMap_C::UpdateSelection(bool InUse_)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_WorldMap.UI_WorldMap_C.UpdateSelection"));
	...
	void UUI_WorldMap_C::Loop()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_WorldMap.UI_WorldMap_C.Loop"));
	...
	void UUI_WorldMap_C::Activate(int32_t PlayerIndex)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_WorldMap.UI_WorldMap_C.Activate"));
	...
	void UUI_WorldMap_C::Deactivate()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_WorldMap.UI_WorldMap_C.Deactivate"));
	...
	void UUI_WorldMap_C::ExecuteUbergraph_UI_WorldMap(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function UI_WorldMap.UI_WorldMap_C.ExecuteUbergraph_UI_WorldMap"));
	...
	UClass* UUI_WorldMap_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass UI_WorldMap.UI_WorldMap_C"));
		return ptr;
	}
