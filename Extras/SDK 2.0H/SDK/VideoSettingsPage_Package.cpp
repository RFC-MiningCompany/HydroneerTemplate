...
namespace CG
{
	...
	bool UVideoSettingsPage_C::Get_AutoApplyCheckbox_bIsEnabled_1()
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function VideoSettingsPage.VideoSettingsPage_C.Get_AutoApplyCheckbox_bIsEnabled_1"));
	...
	bool UVideoSettingsPage_C::Get_ApplyButton_bIsEnabled_1()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function VideoSettingsPage.VideoSettingsPage_C.Get_ApplyButton_bIsEnabled_1"));
	...
	bool UVideoSettingsPage_C::Get_SaveButton_bIsEnabled_1()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function VideoSettingsPage.VideoSettingsPage_C.Get_SaveButton_bIsEnabled_1"));
	...
	UClass* UVideoSettingsPage_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass VideoSettingsPage.VideoSettingsPage_C"));
		return ptr;
	}
