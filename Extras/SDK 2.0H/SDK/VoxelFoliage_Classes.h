...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_E6KJ[0x3];                                   // 0x0271(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MI4L[0x3];                                   // 0x027D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		VoxelFoliage_EVoxelFoliageRotation                         RotationAlignment;                                       // 0x02A8(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_MFMB[0x2];                                   // 0x02AA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_4IC5[0x2];                                   // 0x02E2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_7K5Q[0x4];                                   // 0x02F4(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_CFZC[0x7];                                   // 0x0221(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		void SpawnVoxelSpawnerActorsInArea(TArray<class AVoxelFoliageActor*>* OutActors, class AVoxelWorld* World, const struct FVoxelIntBox& Bounds, Voxel_EVoxelSpawnerActorSpawnType SpawnType);
	...
	public:
		...
		unsigned char                                              UnknownData_HGED[0x30];                                  // 0x0678(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FVoxelInstancedMeshKey                              Voxel_MeshKey;                                           // 0x06A8(0x01A8) HasGetValueTypeHash, NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_7VL6[0x160];                                 // 0x0850(0x0160) MISSED OFFSET (PADDING)
