...
namespace CG
{
	...
	UClass* UVoxelFoliage::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class VoxelFoliage.VoxelFoliage"));
		return ptr;
	}
	...
	UClass* AVoxelFoliageActor::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class VoxelFoliage.VoxelFoliageActor"));
		return ptr;
	}
	...
	UClass* UVoxelFoliageBiomeType::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class VoxelFoliage.VoxelFoliageBiomeType"));
		return ptr;
	}
	...
	UClass* UVoxelFoliageBiome::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class VoxelFoliage.VoxelFoliageBiome"));
		return ptr;
	}
	...
	void UVoxelFoliageBlueprintLibrary::SpawnVoxelSpawnerActorsInArea(TArray<class AVoxelFoliageActor*>* OutActors, class AVoxelWorld* World, const struct FVoxelIntBox& Bounds, Voxel_EVoxelSpawnerActorSpawnType SpawnType)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function VoxelFoliage.VoxelFoliageBlueprintLibrary.SpawnVoxelSpawnerActorsInArea"));
	...
	class AVoxelFoliageActor* UVoxelFoliageBlueprintLibrary::SpawnVoxelSpawnerActorByInstanceIndex(class AVoxelWorld* World, class UVoxelHierarchicalInstancedStaticMeshComponent* Component, int32_t InstanceIndex)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function VoxelFoliage.VoxelFoliageBlueprintLibrary.SpawnVoxelSpawnerActorByInstanceIndex"));
	...
	void UVoxelFoliageBlueprintLibrary::LoadFromSpawnersSave(class AVoxelWorld* World, const struct FVoxelFoliageSave& Save)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function VoxelFoliage.VoxelFoliageBlueprintLibrary.LoadFromSpawnersSave"));
	...
	struct FVoxelFoliageSave UVoxelFoliageBlueprintLibrary::GetSpawnersSave(class AVoxelWorld* World)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function VoxelFoliage.VoxelFoliageBlueprintLibrary.GetSpawnersSave"));
	...
	void UVoxelFoliageBlueprintLibrary::AddInstances(class AVoxelWorld* World, TArray<struct FTransform> Transforms, TArray<float> CustomData, const struct FVoxelInstancedMeshKey& MeshKey, const struct FVector& FloatingDetectionOffset)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function VoxelFoliage.VoxelFoliageBlueprintLibrary.AddInstances"));
	...
	UClass* UVoxelFoliageBlueprintLibrary::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class VoxelFoliage.VoxelFoliageBlueprintLibrary"));
		return ptr;
	}
	...
	UClass* UVoxelFoliageCollection::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class VoxelFoliage.VoxelFoliageCollection"));
		return ptr;
	}
	...
	UClass* UVoxelFoliageDebugSubsystemProxy::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class VoxelFoliage.VoxelFoliageDebugSubsystemProxy"));
		return ptr;
	}
	...
	UClass* UVoxelFoliageSubsystemProxy::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class VoxelFoliage.VoxelFoliageSubsystemProxy"));
		return ptr;
	}
	...
	UClass* UVoxelHierarchicalInstancedStaticMeshComponent::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class VoxelFoliage.VoxelHierarchicalInstancedStaticMeshComponent"));
		return ptr;
	}
	...
	UClass* UVoxelInstancedMeshSubsystemProxy::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class VoxelFoliage.VoxelInstancedMeshSubsystemProxy"));
		return ptr;
	}
