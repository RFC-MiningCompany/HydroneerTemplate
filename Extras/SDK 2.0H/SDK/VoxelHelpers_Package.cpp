...
namespace CG
{
	...
	UClass* UMaterialExpressionBlendMaterialAttributesBarycentric::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class VoxelHelpers.MaterialExpressionBlendMaterialAttributesBarycentric"));
		return ptr;
	}
	...
	UClass* UMaterialExpressionPack::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class VoxelHelpers.MaterialExpressionPack"));
		return ptr;
	}
	...
	UClass* UMaterialExpressionUnpack::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class VoxelHelpers.MaterialExpressionUnpack"));
		return ptr;
	}
	...
	UClass* UVoxelColorWheel::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class VoxelHelpers.VoxelColorWheel"));
		return ptr;
	}
	...
	void UVoxelHelpersLibrary::CreateProcMeshPlane(class UProceduralMeshComponent* Mesh, int32_t SizeX, int32_t SizeY, float Step)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>(_xor_("Function VoxelHelpers.VoxelHelpersLibrary.CreateProcMeshPlane"));
	...
	UClass* UVoxelHelpersLibrary::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass(_xor_("Class VoxelHelpers.VoxelHelpersLibrary"));
		return ptr;
	}
