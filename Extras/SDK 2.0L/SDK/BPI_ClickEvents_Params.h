...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BPI_ClickEvents.BPI_ClickEvents_C.LMBDownIsTarget
	 */
	struct UBPI_ClickEvents_C_LMBDownIsTarget_Params
	{
	public:
	...
	/**
	 * Function BPI_ClickEvents.BPI_ClickEvents_C.RMBDownIsTarget
	 */
	struct UBPI_ClickEvents_C_RMBDownIsTarget_Params
	{
	public:
		class UPrimitiveComponent*                                 Component;                                               // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		class ABP_ParentItem_C*                                    CarryingItem;                                            // 0x0008(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	/**
	 * Function BPI_ClickEvents.BPI_ClickEvents_C.RMBDownWhileCarrying
	 */
	struct UBPI_ClickEvents_C_RMBDownWhileCarrying_Params
	{
	public:
	...
	/**
	 * Function BPI_ClickEvents.BPI_ClickEvents_C.LMBDownWhileCarrying
	 */
	struct UBPI_ClickEvents_C_LMBDownWhileCarrying_Params
	{
	public:
		class ABP_GameController_C*                                Controller;                                              // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	/**
	 * Function BPI_ClickEvents.BPI_ClickEvents_C.LMBUpWhileCarrying
	 */
	struct UBPI_ClickEvents_C_LMBUpWhileCarrying_Params
	{	};
