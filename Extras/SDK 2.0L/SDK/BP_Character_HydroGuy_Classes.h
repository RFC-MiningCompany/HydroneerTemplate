...
namespace CG
{
	 ...
	 * Size -> 0x0142 (FullSize[0x06C8] - InheritedSize[0x0586])
	 */
	class ABP_Character_HydroGuy_C : public ABP_GameCharacter_C
	{
	public:
		unsigned char                                              UnknownData_TXYM[0x2];                                   // 0x0586(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_F0E8[0x4];                                   // 0x0644(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_7VU5[0x4];                                   // 0x069C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
