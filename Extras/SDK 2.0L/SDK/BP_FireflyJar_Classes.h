...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_YTQ7[0x7];                                   // 0x0349(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		float                                                      Timeline_1_NewTrack_0_B89785ED4BA71D7F05CB3A80FE1B098D;  // 0x0370(0x0004) ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_TULI[0x3];                                   // 0x0375(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
