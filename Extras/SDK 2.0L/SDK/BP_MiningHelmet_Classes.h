...
namespace CG
{
	...
	public:
		...
		ETimelineDirection                                         Timeline_0__Direction_D5296FD143D2ED95CD7316B9842BF492;  // 0x0374(0x0001) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_7MQU[0x3];                                   // 0x0375(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
