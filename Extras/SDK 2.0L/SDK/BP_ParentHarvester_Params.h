...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_ParentHarvester.BP_ParentHarvester_C.CalcPressureBoost
	 */
	struct ABP_ParentHarvester_C_CalcPressureBoost_Params
	{
	public:
		...
		int32_t                                                    DirtLoads;                                               // 0x0004(0x0004)  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};

	/**
	 * Function BP_ParentHarvester.BP_ParentHarvester_C.ComponentsToSave
	 */
	struct ABP_ParentHarvester_C_ComponentsToSave_Params
	{
	public:
