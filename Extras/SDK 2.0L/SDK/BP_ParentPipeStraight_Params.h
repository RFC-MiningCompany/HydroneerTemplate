...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_ParentPipeStraight.BP_ParentPipeStraight_C.OverrideWaterIn
	 */
	struct ABP_ParentPipeStraight_C_OverrideWaterIn_Params
	{
	public:
	...
	/**
	 * Function BP_ParentPipeStraight.BP_ParentPipeStraight_C.ExecuteUbergraph_BP_ParentPipeStraight
	 */
	struct ABP_ParentPipeStraight_C_ExecuteUbergraph_BP_ParentPipeStraight_Params
	{
	public:
