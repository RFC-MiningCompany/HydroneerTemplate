...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_07FN[0x3];                                   // 0x04C1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_1IFE[0x1C];                                  // 0x04E4(0x001C) MISSED OFFSET (PADDING)
