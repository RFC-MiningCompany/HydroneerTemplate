...
namespace CG
{
	...
	{
		ChaosNiagara_LocationZToSpawn_None   = 0x0000000000000000,
		ChaosNiagara_LocationZToSpawn_Min    = 0x0000000000000001,
		ChaosNiagara_LocationZToSpawn_Max    = 0x0000000000000002,
		ChaosNiagara_LocationZToSpawn_MinMax = 0x0000000000000003,
		ChaosNiagara_Max                     = 0x0000000000000004
	};
	...
	{
		ChaosNiagara_LocationYToSpawn_None   = 0x0000000000000000,
		ChaosNiagara_LocationYToSpawn_Min    = 0x0000000000000001,
		ChaosNiagara_LocationYToSpawn_Max    = 0x0000000000000002,
		ChaosNiagara_LocationYToSpawn_MinMax = 0x0000000000000003,
		ChaosNiagara_Max                     = 0x0000000000000004
	};
	...
	{
		ChaosNiagara_LocationXToSpawn_None   = 0x0000000000000000,
		ChaosNiagara_LocationXToSpawn_Min    = 0x0000000000000001,
		ChaosNiagara_LocationXToSpawn_Max    = 0x0000000000000002,
		ChaosNiagara_LocationXToSpawn_MinMax = 0x0000000000000003,
		ChaosNiagara_Max                     = 0x0000000000000004
	};
	...
	{
		ChaosNiagara_LocationFilteringMode_Inclusive = 0x0000000000000000,
		ChaosNiagara_LocationFilteringMode_Exclusive = 0x0000000000000001,
		ChaosNiagara_Max                             = 0x0000000000000002
	};
	...
	{
		ChaosNiagara_DataSourceType_Collision = 0x0000000000000000,
		ChaosNiagara_DataSourceType_Breaking  = 0x0000000000000001,
		ChaosNiagara_DataSourceType_Trailing  = 0x0000000000000002,
		ChaosNiagara_Max                      = 0x0000000000000003
	};
	...
	{
		ChaosNiagara_DebugType_NoDebug              = 0x0000000000000000,
		ChaosNiagara_DebugType_ColorBySolver        = 0x0000000000000001,
		ChaosNiagara_DebugType_ColorByParticleIndex = 0x0000000000000002,
		ChaosNiagara_Max                            = 0x0000000000000003
	};
	...
	{
		ChaosNiagara_RandomVelocityGenerationType_RandomDistribution              = 0x0000000000000000,
		ChaosNiagara_RandomVelocityGenerationType_RandomDistributionWithStreamers = 0x0000000000000001,
		ChaosNiagara_RandomVelocityGenerationType_CollisionNormalBased            = 0x0000000000000002,
		ChaosNiagara_Max                                                          = 0x0000000000000003
	};
	...
	{
		ChaosNiagara_DataSortType_NoSorting          = 0x0000000000000000,
		ChaosNiagara_DataSortType_RandomShuffle      = 0x0000000000000001,
		ChaosNiagara_DataSortType_SortByMassMaxToMin = 0x0000000000000002,
		ChaosNiagara_DataSortType_SortByMassMinToMax = 0x0000000000000003,
		ChaosNiagara_Max                             = 0x0000000000000004
	};
