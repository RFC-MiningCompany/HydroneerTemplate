...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_JDVQ[0x90];                                  // 0x0000(0x0090) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_3ZSY[0x68];                                  // 0x0000(0x0068) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_FLFJ[0x30];                                  // 0x0000(0x0030) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_B6FS[0x38];                                  // 0x0000(0x0038) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_FP3Y[0x28];                                  // 0x0000(0x0028) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_2LOC[0x80];                                  // 0x0000(0x0080) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_KFXP[0x20];                                  // 0x0000(0x0020) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_EOFH[0x50];                                  // 0x0000(0x0050) MISSED OFFSET (PADDING)
	};
