...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function Footstep_AnimNotify.Footstep_AnimNotify_C.FindFootstepType
	 */
	struct UFootstep_AnimNotify_C_FindFootstepType_Params
	{
	public:
		...
		int32_t                                                    Type;                                                    // 0x0008(0x0004)  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
