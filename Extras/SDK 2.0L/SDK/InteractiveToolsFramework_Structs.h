...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_1POZ[0xAC];                                  // 0x0000(0x00AC) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_1J5K[0x18];                                  // 0x0008(0x0018) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_Y9OW[0x30];                                  // 0x0000(0x0030) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_13PO[0x28];                                  // 0x0000(0x0028) MISSED OFFSET (PADDING)
	};
