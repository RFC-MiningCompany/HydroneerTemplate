...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_NJ84[0xA8];                                  // 0x0238(0x00A8) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_B8XR[0x3];                                   // 0x0179(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_4SB0[0x6];                                   // 0x019A(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_XIKF[0x5];                                   // 0x005B(0x0005) MISSED OFFSET (PADDING)
