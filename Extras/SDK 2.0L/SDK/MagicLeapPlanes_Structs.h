...
namespace CG
{
	...
	enum class EMagicLeapPlaneQueryFlags : uint8_t
	{
		...
		Arbitrary       = 0x0000000000000002,
		OrientToGravity = 0x0000000000000003,
		PreferInner     = 0x0000000000000004,
		Ceiling         = 0x0000000000000005,
		Floor           = 0x0000000000000006,
		Wall            = 0x0000000000000007,
		Polygons        = 0x0000000000000008,
	...
	public:
		...
		unsigned char                                              UnknownData_VX0N[0x4];                                   // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_CJKN[0xE];                                   // 0x0052(0x000E) MISSED OFFSET (PADDING)
	};
