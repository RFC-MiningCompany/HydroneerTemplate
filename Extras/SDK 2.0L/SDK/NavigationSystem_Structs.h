...
namespace CG
{
	...
	enum class ERuntimeGenerationType : uint8_t
	{
		...
		DynamicModifiersOnly = 0x0000000000000001,
		Dynamic              = 0x0000000000000002,
		LegacyGeneration     = 0x0000000000000003,
	...
	{
		TotalCost     = 0x0000000000000000,
		HeuristicOnly = 0x0000000000000001,
		RealCostOnly  = 0x0000000000000002,
	...
	{
		Override = 0x0000000000000000,
		Append   = 0x0000000000000001,
		Skip     = 0x0000000000000002,
		MAX      = 0x0000000000000003
	};
	...
	{
		Monotone       = 0x0000000000000000,
		Watershed      = 0x0000000000000001,
		ChunkyMonotone = 0x0000000000000002,
		MAX            = 0x0000000000000003
	};
	...
	public:
		...
		unsigned char                                              UnknownData_LFKZ[0x4];                                   // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_GKOR[0x10];                                  // 0x0008(0x0010) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_TL3U[0x7];                                   // 0x0011(0x0007) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_0OMX[0x2];                                   // 0x0002(0x0002) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_8UE5[0x18];                                  // 0x0000(0x0018) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_S9BX[0x4];                                   // 0x006C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_IL5O[0x2];                                   // 0x0032(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MBTX[0x3];                                   // 0x003D(0x0003) MISSED OFFSET (PADDING)
	};
