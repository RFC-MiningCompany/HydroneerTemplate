...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_9W65[0x18];                                  // 0x0030(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_6UQK[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_FC5W[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_NB2U[0x4];                                   // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_FLCB[0x1E0];                                 // 0x0138(0x01E0) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnCallback;                                              // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_18M8[0x30];                                  // 0x0048(0x0030) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_1WJF[0xE0];                                  // 0x00B8(0x00E0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_H299[0xA0];                                  // 0x0098(0x00A0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_TU1Q[0x20];                                  // 0x0058(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_7ZH5[0xC0];                                  // 0x00A8(0x00C0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_XRC6[0x120];                                 // 0x00D8(0x0120) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_BG28[0xE8];                                  // 0x0058(0x00E8) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnCallback;                                              // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_2IVQ[0x90];                                  // 0x0048(0x0090) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnSuccess;                                               // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		class FScriptMulticastDelegate                             OnFailure;                                               // 0x0048(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_W3DM[0x20];                                  // 0x0058(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnCallback;                                              // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_8G7W[0xE0];                                  // 0x0048(0x00E0) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_4YQA[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_1TXL[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_ZBKP[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_XT3I[0xC0];                                  // 0x00A8(0x00C0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_PYNR[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_QPL8[0x80];                                  // 0x0088(0x0080) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_K2L1[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_XIXD[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_TMCU[0x160];                                 // 0x00F8(0x0160) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_PEZU[0xA0];                                  // 0x0098(0x00A0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_K8DK[0xA0];                                  // 0x0098(0x00A0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_U1EJ[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
