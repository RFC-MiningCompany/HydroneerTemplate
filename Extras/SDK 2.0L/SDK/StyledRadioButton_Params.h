...
namespace CG
{
	 ...
	 */
	struct UStyledRadioButton_C_GetColour_Params
	{
	public:
	 ...
	 */
	struct UStyledRadioButton_C_BndEvt__MainButton_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature_Params
	{	};

	/**
	 * Function StyledRadioButton.StyledRadioButton_C.ExecuteUbergraph_StyledRadioButton
	 */
	struct UStyledRadioButton_C_ExecuteUbergraph_StyledRadioButton_Params
	{
	public:
