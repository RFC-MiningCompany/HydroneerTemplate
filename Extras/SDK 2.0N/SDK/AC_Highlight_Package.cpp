...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_Highlight.AC_Highlight_C.SetHighlight"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_Highlight.AC_Highlight_C.ToggleHighlightSpecific"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_Highlight.AC_Highlight_C.ForceStopHighlight"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_Highlight.AC_Highlight_C.TogglePlayerHighlight"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_Highlight.AC_Highlight_C.OnUnhighlighted__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function AC_Highlight.AC_Highlight_C.OnHighlighted__DelegateSignature"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass AC_Highlight.AC_Highlight_C"));
		return ptr;
	}
