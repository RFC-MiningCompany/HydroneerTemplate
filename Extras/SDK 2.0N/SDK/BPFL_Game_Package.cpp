...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BPFL_Game.BPFL_Game_C.FindMetadata"));
		
		UBPFL_Game_C_FindMetadata_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BPFL_Game.BPFL_Game_C.GetAllAttachedActors"));
		
		UBPFL_Game_C_GetAllAttachedActors_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BPFL_Game.BPFL_Game_C.GetSaveGameUserData"));
		
		UBPFL_Game_C_GetSaveGameUserData_Params params {};
		params.__WorldContext = __WorldContext;
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BPFL_Game.BPFL_Game_C.GetBP_GameController"));
		
		UBPFL_Game_C_GetBP_GameController_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BPFL_Game.BPFL_Game_C.GetBP_GameState"));
		
		UBPFL_Game_C_GetBP_GameState_Params params {};
		params.__WorldContext = __WorldContext;
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BPFL_Game.BPFL_Game_C.GetBP_GameInstance"));
		
		UBPFL_Game_C_GetBP_GameInstance_Params params {};
		params.__WorldContext = __WorldContext;
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BPFL_Game.BPFL_Game_C.GetGM_Hydroneer"));
		
		UBPFL_Game_C_GetGM_Hydroneer_Params params {};
		params.__WorldContext = __WorldContext;
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BPFL_Game.BPFL_Game_C"));
		return ptr;
	}
