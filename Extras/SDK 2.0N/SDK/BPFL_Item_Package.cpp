...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BPFL_Item.BPFL_Item_C.SetHighlight"));
		
		UBPFL_Item_C_SetHighlight_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BPFL_Item.BPFL_Item_C.ForceStopHighlight"));
		
		UBPFL_Item_C_ForceStopHighlight_Params params {};
		params.Controller = Controller;
		params.Target = Target;
		params.__WorldContext = __WorldContext;
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BPFL_Item.BPFL_Item_C.ToggleHighlightSpecific"));
		
		UBPFL_Item_C_ToggleHighlightSpecific_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BPFL_Item.BPFL_Item_C.ToggleHighlightPlayer"));
		
		UBPFL_Item_C_ToggleHighlightPlayer_Params params {};
		params.Highlight_ = Highlight_;
		params.Controller = Controller;
		params.Target = Target;
		params.__WorldContext = __WorldContext;
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BPFL_Item.BPFL_Item_C"));
		return ptr;
	}
