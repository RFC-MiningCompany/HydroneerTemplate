...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BPI_ClickEvents.BPI_ClickEvents_C.LMBDownIsTarget"));
		
		UBPI_ClickEvents_C_LMBDownIsTarget_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BPI_ClickEvents.BPI_ClickEvents_C.RMBDownIsTarget"));
		
		UBPI_ClickEvents_C_RMBDownIsTarget_Params params {};
		params.Component = Component;
		params.CarryingItem = CarryingItem;
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BPI_ClickEvents.BPI_ClickEvents_C.RMBDownWhileCarrying"));
		
		UBPI_ClickEvents_C_RMBDownWhileCarrying_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BPI_ClickEvents.BPI_ClickEvents_C.LMBDownWhileCarrying"));
		
		UBPI_ClickEvents_C_LMBDownWhileCarrying_Params params {};
		params.Controller = Controller;
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BPI_ClickEvents.BPI_ClickEvents_C.LMBUpWhileCarrying"));
		
		UBPI_ClickEvents_C_LMBUpWhileCarrying_Params params {};
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BPI_ClickEvents.BPI_ClickEvents_C"));
		return ptr;
	}
