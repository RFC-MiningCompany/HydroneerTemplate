...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_BuildStoneDoorway.BP_BuildStoneDoorway_C.LMBDownIsTarget"));
		
		ABP_BuildStoneDoorway_C_LMBDownIsTarget_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_BuildStoneDoorway.BP_BuildStoneDoorway_C.ExecuteUbergraph_BP_BuildStoneDoorway"));
		
		ABP_BuildStoneDoorway_C_ExecuteUbergraph_BP_BuildStoneDoorway_Params params {};
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_BuildStoneDoorway.BP_BuildStoneDoorway_C"));
		return ptr;
	}
