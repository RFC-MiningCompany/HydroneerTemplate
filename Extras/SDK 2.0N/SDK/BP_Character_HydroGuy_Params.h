...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_Character_HydroGuy.BP_Character_HydroGuy_C.ComponentsToSave
	 */
	struct ABP_Character_HydroGuy_C_ComponentsToSave_Params
	{
	public:
	...
	{
	public:
		TArray<E_MeshParts>                                        MeshParts;                                               // 0x0000(0x0010)  (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	...
	public:
		...
		E_ClothingSlots                                            Slot;                                                    // 0x0008(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		...
		TArray<E_MeshParts>                                        UnhideMeshParts;                                         // 0x0010(0x0010)  (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
		TArray<E_MeshParts>                                        HideMeshParts;                                           // 0x0020(0x0010)  (Parm, OutParm)
	};
	...
	{
	public:
		struct FS_CharacterStyle                                   Style;                                                   // 0x0000(0x004C)  (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
