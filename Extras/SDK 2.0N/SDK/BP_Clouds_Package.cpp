...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Clouds.BP_Clouds_C.UserConstructionScript"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_Clouds.BP_Clouds_C"));
		return ptr;
	}
