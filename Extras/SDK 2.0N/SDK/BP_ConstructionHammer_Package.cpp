...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ConstructionHammer.BP_ConstructionHammer_C.LMBDownWhileCarrying"));
		
		ABP_ConstructionHammer_C_LMBDownWhileCarrying_Params params {};
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ConstructionHammer.BP_ConstructionHammer_C"));
		return ptr;
	}
