...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_DirtResource.BP_DirtResource_C.Cooldown"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_DirtResource.BP_DirtResource_C.OverrideHit"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_DirtResource.BP_DirtResource_C.ReceiveBeginPlay"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_DirtResource.BP_DirtResource_C.ToggleSaveDirtChunksChanged"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_DirtResource.BP_DirtResource_C.ExecuteUbergraph_BP_DirtResource"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_DirtResource.BP_DirtResource_C"));
		return ptr;
	}
