...
namespace CG
{
	...
	void ABP_Dummy_HydroGuy_C::DummyHighlight(bool Highlight_)
	{
		...
		ABP_Dummy_HydroGuy_C_DummyHighlight_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Dummy_HydroGuy.BP_Dummy_HydroGuy_C.SetRenderTargetxxx"));
		
		ABP_Dummy_HydroGuy_C_SetRenderTargetxxx_Params params {};
	...
	void ABP_Dummy_HydroGuy_C::ToggleFrameCapture(bool Capture_Every_Frame)
	{
		...
		ABP_Dummy_HydroGuy_C_ToggleFrameCapture_Params params {};
	...
	void ABP_Dummy_HydroGuy_C::UserConstructionScript()
	{
		...
		ABP_Dummy_HydroGuy_C_UserConstructionScript_Params params {};
	...
	void ABP_Dummy_HydroGuy_C::ReceiveBeginPlay()
	{
		...
		ABP_Dummy_HydroGuy_C_ReceiveBeginPlay_Params params {};
	...
	void ABP_Dummy_HydroGuy_C::ReceiveTick(float DeltaSeconds)
	{
		...
		ABP_Dummy_HydroGuy_C_ReceiveTick_Params params {};
	...
	void ABP_Dummy_HydroGuy_C::ExecuteUbergraph_BP_Dummy_HydroGuy(int32_t EntryPoint)
	{
		...
		ABP_Dummy_HydroGuy_C_ExecuteUbergraph_BP_Dummy_HydroGuy_Params params {};
