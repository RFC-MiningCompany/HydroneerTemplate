...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_FlightCap.BP_FlightCap_C.OverrideHatOn"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_FlightCap.BP_FlightCap_C.OverrideHatOff"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_FlightCap.BP_FlightCap_C.ExecuteUbergraph_BP_FlightCap"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_FlightCap.BP_FlightCap_C"));
		return ptr;
	}
