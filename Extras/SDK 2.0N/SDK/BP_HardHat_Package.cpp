...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HardHat.BP_HardHat_C.OverrideHatOn"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HardHat.BP_HardHat_C.OverrideHatOff"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HardHat.BP_HardHat_C.ExecuteUbergraph_BP_HardHat"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_HardHat.BP_HardHat_C"));
		return ptr;
	}
