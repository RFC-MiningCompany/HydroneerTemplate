...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookGemPolisher.BP_HookGemPolisher_C.SpawnGem"));
		
		ABP_HookGemPolisher_C_SpawnGem_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookGemPolisher.BP_HookGemPolisher_C.PolishTimer"));
		
		ABP_HookGemPolisher_C_PolishTimer_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookGemPolisher.BP_HookGemPolisher_C.HookFunctionality"));
		
		ABP_HookGemPolisher_C_HookFunctionality_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookGemPolisher.BP_HookGemPolisher_C.OverridePickedup"));
		
		ABP_HookGemPolisher_C_OverridePickedup_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookGemPolisher.BP_HookGemPolisher_C.OverrideParentNoWater"));
		
		ABP_HookGemPolisher_C_OverrideParentNoWater_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookGemPolisher.BP_HookGemPolisher_C.BndEvt__ShredBox_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
		
		ABP_HookGemPolisher_C_BndEvt__ShredBox_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookGemPolisher.BP_HookGemPolisher_C.ExecuteUbergraph_BP_HookGemPolisher"));
		
		ABP_HookGemPolisher_C_ExecuteUbergraph_BP_HookGemPolisher_Params params {};
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_HookGemPolisher.BP_HookGemPolisher_C"));
		return ptr;
	}
