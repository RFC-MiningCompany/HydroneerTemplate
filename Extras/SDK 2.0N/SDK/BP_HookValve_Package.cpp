...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookValve.BP_HookValve_C.HookFunctionality"));
		
		ABP_HookValve_C_HookFunctionality_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookValve.BP_HookValve_C.LMBDownIsTarget"));
		
		ABP_HookValve_C_LMBDownIsTarget_Params params {};
		params.Component = Component;
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookValve.BP_HookValve_C.ActorLoaded"));
		
		ABP_HookValve_C_ActorLoaded_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HookValve.BP_HookValve_C.ExecuteUbergraph_BP_HookValve"));
		
		ABP_HookValve_C_ExecuteUbergraph_BP_HookValve_Params params {};
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_HookValve.BP_HookValve_C"));
		return ptr;
	}
