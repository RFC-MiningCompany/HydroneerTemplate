...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HydroTruck.BP_HydroTruck_C.SetStoredItemMass"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HydroTruck.BP_HydroTruck_C.BndEvt__BP_HydroTruck_AC_Storage_K2Node_ComponentBoundEvent_0_ItemAttached__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_HydroTruck.BP_HydroTruck_C.BndEvt__BP_HydroTruck_AC_Storage_K2Node_ComponentBoundEvent_1_ItemDetached__DelegateSignature"));
