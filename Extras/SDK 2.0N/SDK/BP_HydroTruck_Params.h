...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_HydroTruck.BP_HydroTruck_C.SetStoredItemMass
	 */
	struct ABP_HydroTruck_C_SetStoredItemMass_Params
	{
	public:
		...
		float                                                      MassInKg;                                                // 0x0008(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	...
	/**
	 * Function BP_HydroTruck.BP_HydroTruck_C.BndEvt__BP_HydroTruck_AC_Storage_K2Node_ComponentBoundEvent_0_ItemAttached__DelegateSignature
	 */
	struct ABP_HydroTruck_C_BndEvt__BP_HydroTruck_AC_Storage_K2Node_ComponentBoundEvent_0_ItemAttached__DelegateSignature_Params
	{	};

	/**
	 * Function BP_HydroTruck.BP_HydroTruck_C.BndEvt__BP_HydroTruck_AC_Storage_K2Node_ComponentBoundEvent_1_ItemDetached__DelegateSignature
	 */
	struct ABP_HydroTruck_C_BndEvt__BP_HydroTruck_AC_Storage_K2Node_ComponentBoundEvent_1_ItemDetached__DelegateSignature_Params
	{	};
