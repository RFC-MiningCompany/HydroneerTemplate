...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookDelay10.BP_LogicHookDelay10_C.HookFunctionality"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookDelay10.BP_LogicHookDelay10_C.WaitForDelay"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookDelay10.BP_LogicHookDelay10_C.ExecuteUbergraph_BP_LogicHookDelay10"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_LogicHookDelay10.BP_LogicHookDelay10_C"));
		return ptr;
	}
