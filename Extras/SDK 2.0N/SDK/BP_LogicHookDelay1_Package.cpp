...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookDelay1.BP_LogicHookDelay1_C.HookFunctionality"));
		
		ABP_LogicHookDelay1_C_HookFunctionality_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookDelay1.BP_LogicHookDelay1_C.WaitForDelay"));
		
		ABP_LogicHookDelay1_C_WaitForDelay_Params params {};
		params.Logic = Logic;
		params.Component = Component;
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookDelay1.BP_LogicHookDelay1_C.ExecuteUbergraph_BP_LogicHookDelay1"));
		
		ABP_LogicHookDelay1_C_ExecuteUbergraph_BP_LogicHookDelay1_Params params {};
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_LogicHookDelay1.BP_LogicHookDelay1_C"));
		return ptr;
	}
