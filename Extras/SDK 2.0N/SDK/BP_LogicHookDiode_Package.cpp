...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookDiode.BP_LogicHookDiode_C.HookFunctionality"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookDiode.BP_LogicHookDiode_C.OverridePartHooked"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookDiode.BP_LogicHookDiode_C.OverrideLoaded"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookDiode.BP_LogicHookDiode_C.ExecuteUbergraph_BP_LogicHookDiode"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_LogicHookDiode.BP_LogicHookDiode_C"));
		return ptr;
	}
