...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookDisplay.BP_LogicHookDisplay_C.HookFunctionality"));
		
		ABP_LogicHookDisplay_C_HookFunctionality_Params params {};
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_LogicHookDisplay.BP_LogicHookDisplay_C"));
		return ptr;
	}
