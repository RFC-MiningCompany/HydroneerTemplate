...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookValve.BP_LogicHookValve_C.HookFunctionality"));
		
		ABP_LogicHookValve_C_HookFunctionality_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookValve.BP_LogicHookValve_C.LMBDownIsTarget"));
		
		ABP_LogicHookValve_C_LMBDownIsTarget_Params params {};
		params.Component = Component;
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookValve.BP_LogicHookValve_C.OverrideLogicIn"));
		
		ABP_LogicHookValve_C_OverrideLogicIn_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookValve.BP_LogicHookValve_C.ActorLoaded"));
		
		ABP_LogicHookValve_C_ActorLoaded_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookValve.BP_LogicHookValve_C.ReceiveTick"));
		
		ABP_LogicHookValve_C_ReceiveTick_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicHookValve.BP_LogicHookValve_C.ExecuteUbergraph_BP_LogicHookValve"));
		
		ABP_LogicHookValve_C_ExecuteUbergraph_BP_LogicHookValve_Params params {};
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_LogicHookValve.BP_LogicHookValve_C"));
		return ptr;
	}
