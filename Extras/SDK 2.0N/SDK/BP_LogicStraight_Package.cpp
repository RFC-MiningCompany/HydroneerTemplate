...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicStraight.BP_LogicStraight_C.OverrideLogicIn"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_LogicStraight.BP_LogicStraight_C.ExecuteUbergraph_BP_LogicStraight"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_LogicStraight.BP_LogicStraight_C"));
		return ptr;
	}
