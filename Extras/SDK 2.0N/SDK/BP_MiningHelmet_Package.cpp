...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_MiningHelmet.BP_MiningHelmet_C.UserConstructionScript"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_MiningHelmet.BP_MiningHelmet_C.Timeline_0__FinishedFunc"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_MiningHelmet.BP_MiningHelmet_C.Timeline_0__UpdateFunc"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_MiningHelmet.BP_MiningHelmet_C.WaterParticleHit"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_MiningHelmet.BP_MiningHelmet_C.OverrideHatOn"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_MiningHelmet.BP_MiningHelmet_C.OverrideHatOff"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_MiningHelmet.BP_MiningHelmet_C.InWater"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_MiningHelmet.BP_MiningHelmet_C.ExecuteUbergraph_BP_MiningHelmet"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_MiningHelmet.BP_MiningHelmet_C"));
		return ptr;
	}
