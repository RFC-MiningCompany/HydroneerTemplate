...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBar.BP_ParentBar_C.UserConstructionScript"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBar.BP_ParentBar_C.HeatUpdated"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBar.BP_ParentBar_C.InFire"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBar.BP_ParentBar_C.OutOfFire"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBar.BP_ParentBar_C.FullHeat"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBar.BP_ParentBar_C.InWater"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBar.BP_ParentBar_C.WaterParticleHit"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBar.BP_ParentBar_C.SetCraftedSize"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBar.BP_ParentBar_C.SetResourceSize"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentBar.BP_ParentBar_C.ExecuteUbergraph_BP_ParentBar"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentBar.BP_ParentBar_C"));
		return ptr;
	}
