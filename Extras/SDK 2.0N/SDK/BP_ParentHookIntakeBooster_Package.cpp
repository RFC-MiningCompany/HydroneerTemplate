...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHookIntakeBooster.BP_ParentHookIntakeBooster_C.HookFunctionality"));
		
		ABP_ParentHookIntakeBooster_C_HookFunctionality_Params params {};
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentHookIntakeBooster.BP_ParentHookIntakeBooster_C"));
		return ptr;
	}
