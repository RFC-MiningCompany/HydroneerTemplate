...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHook.BP_ParentHook_C.HookFunctionality"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHook.BP_ParentHook_C.PartHooked"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHook.BP_ParentHook_C.Unhook from Parent"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHook.BP_ParentHook_C.TraceForParents"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHook.BP_ParentHook_C.OverridePlacedDown"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHook.BP_ParentHook_C.OverridePickedup"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHook.BP_ParentHook_C.OverrideParentNoWater"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHook.BP_ParentHook_C.OverridePartHooked"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHook.BP_ParentHook_C.OverrideLogicIn"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHook.BP_ParentHook_C.ActorLoaded"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHook.BP_ParentHook_C.OverrideHookCheckRot"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentHook.BP_ParentHook_C.ExecuteUbergraph_BP_ParentHook"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentHook.BP_ParentHook_C"));
		return ptr;
	}
