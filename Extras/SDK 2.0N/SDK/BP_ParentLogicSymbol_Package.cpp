...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentLogicSymbol.BP_ParentLogicSymbol_C.ChangeSymbol"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentLogicSymbol.BP_ParentLogicSymbol_C.LMBDownIsTarget"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentLogicSymbol.BP_ParentLogicSymbol_C.RMBDownIsTarget"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentLogicSymbol.BP_ParentLogicSymbol_C.ActorLoaded"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentLogicSymbol.BP_ParentLogicSymbol_C.ExecuteUbergraph_BP_ParentLogicSymbol"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentLogicSymbol.BP_ParentLogicSymbol_C"));
		return ptr;
	}
