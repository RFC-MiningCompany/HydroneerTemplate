...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_ParentPipeElbow.BP_ParentPipeElbow_C.OverrideWaterIn
	 */
	struct ABP_ParentPipeElbow_C_OverrideWaterIn_Params
	{
	public:
	...
	/**
	 * Function BP_ParentPipeElbow.BP_ParentPipeElbow_C.ExecuteUbergraph_BP_ParentPipeElbow
	 */
	struct ABP_ParentPipeElbow_C_ExecuteUbergraph_BP_ParentPipeElbow_Params
	{
	public:
