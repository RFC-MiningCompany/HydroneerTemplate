...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPipeStraight.BP_ParentPipeStraight_C.OverrideWaterIn"));
		
		ABP_ParentPipeStraight_C_OverrideWaterIn_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentPipeStraight.BP_ParentPipeStraight_C.ExecuteUbergraph_BP_ParentPipeStraight"));
		
		ABP_ParentPipeStraight_C_ExecuteUbergraph_BP_ParentPipeStraight_Params params {};
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentPipeStraight.BP_ParentPipeStraight_C"));
		return ptr;
	}
