...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_ParentPipe.BP_ParentPipe_C.Pressure Check
	 */
	struct ABP_ParentPipe_C_Pressure_Check_Params
	{
	public:
		class ABP_ParentPipe_C*                                    Pipe;                                                    // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		float                                                      PressureToPass;                                          // 0x0008(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		class USceneComponent*                                     WaterOut;                                                // 0x0010(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
