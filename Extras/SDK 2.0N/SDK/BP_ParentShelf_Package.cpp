...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShelf.BP_ParentShelf_C.ContainsSpecial?"));
		
		ABP_ParentShelf_C_ContainsSpecial__Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShelf.BP_ParentShelf_C.Attach Item"));
		
		ABP_ParentShelf_C_Attach_Item_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShelf.BP_ParentShelf_C.Shelf Trace"));
		
		ABP_ParentShelf_C_Shelf_Trace_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShelf.BP_ParentShelf_C.TraceForStoredItems"));
		
		ABP_ParentShelf_C_TraceForStoredItems_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShelf.BP_ParentShelf_C.CanStore?"));
		
		ABP_ParentShelf_C_CanStore__Params params {};
		params.Item = Item;
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShelf.BP_ParentShelf_C.OnCompleted_671D6CD54910B7E9A078748F04436CA4"));
		
		ABP_ParentShelf_C_OnCompleted_671D6CD54910B7E9A078748F04436CA4_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShelf.BP_ParentShelf_C.NewItemToShelf"));
		
		ABP_ParentShelf_C_NewItemToShelf_Params params {};
		params.Item = Item;
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShelf.BP_ParentShelf_C.ActorLoaded"));
		
		ABP_ParentShelf_C_ActorLoaded_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShelf.BP_ParentShelf_C.ActorPreSave"));
		
		ABP_ParentShelf_C_ActorPreSave_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShelf.BP_ParentShelf_C.LoadItemToShelf"));
		
		ABP_ParentShelf_C_LoadItemToShelf_Params params {};
		params.Item = Item;
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShelf.BP_ParentShelf_C.ExecuteUbergraph_BP_ParentShelf"));
		
		ABP_ParentShelf_C_ExecuteUbergraph_BP_ParentShelf_Params params {};
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentShelf.BP_ParentShelf_C"));
		return ptr;
	}
