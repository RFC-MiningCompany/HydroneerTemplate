...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShovel.BP_ParentShovel_C.LMBDownWhileCarrying"));
		
		ABP_ParentShovel_C_LMBDownWhileCarrying_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShovel.BP_ParentShovel_C.DirtFX"));
		
		ABP_ParentShovel_C_DirtFX_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShovel.BP_ParentShovel_C.HitActorItem"));
		
		ABP_ParentShovel_C_HitActorItem_Params params {};
		params.Controller = Controller;
		params.HitActor = HitActor;
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShovel.BP_ParentShovel_C.HitActorSpecialDig"));
		
		ABP_ParentShovel_C_HitActorSpecialDig_Params params {};
		params.Controller = Controller;
		params.HitActor = HitActor;
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShovel.BP_ParentShovel_C.CantMine"));
		
		ABP_ParentShovel_C_CantMine_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShovel.BP_ParentShovel_C.SetDirt"));
		
		ABP_ParentShovel_C_SetDirt_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ParentShovel.BP_ParentShovel_C.ExecuteUbergraph_BP_ParentShovel"));
		
		ABP_ParentShovel_C_ExecuteUbergraph_BP_ParentShovel_Params params {};
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ParentShovel.BP_ParentShovel_C"));
		return ptr;
	}
