...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ProjectileSpanner.BP_ProjectileSpanner_C.TryRepair"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ProjectileSpanner.BP_ProjectileSpanner_C.DoneRepair"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ProjectileSpanner.BP_ProjectileSpanner_C.FindDurability"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ProjectileSpanner.BP_ProjectileSpanner_C.ReturnDurability"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ProjectileSpanner.BP_ProjectileSpanner_C.BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ProjectileSpanner.BP_ProjectileSpanner_C.ReceiveBeginPlay"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ProjectileSpanner.BP_ProjectileSpanner_C.ExecuteUbergraph_BP_ProjectileSpanner"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ProjectileSpanner.BP_ProjectileSpanner_C"));
		return ptr;
	}
