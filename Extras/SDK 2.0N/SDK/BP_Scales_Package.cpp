...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Scales.BP_Scales_C.BndEvt__Sphere1_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Scales.BP_Scales_C.UpdatePrices"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Scales.BP_Scales_C.BndEvt__Sphere1_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Scales.BP_Scales_C.ActorLoaded"));
		
		ABP_Scales_C_ActorLoaded_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_Scales.BP_Scales_C.ExecuteUbergraph_BP_Scales"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_Scales.BP_Scales_C"));
		return ptr;
	}
