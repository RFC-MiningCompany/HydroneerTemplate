...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_ShelfPlinth.BP_ShelfPlinth_C.UserConstructionScript"));
		
		ABP_ShelfPlinth_C_UserConstructionScript_Params params {};
