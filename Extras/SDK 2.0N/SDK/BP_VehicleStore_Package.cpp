...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_VehicleStore.BP_VehicleStore_C.SpawnVehicle"));
		
		ABP_VehicleStore_C_SpawnVehicle_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_VehicleStore.BP_VehicleStore_C.UserConstructionScript"));
		
		ABP_VehicleStore_C_UserConstructionScript_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_VehicleStore.BP_VehicleStore_C.OverrideMouseClicked"));
		
		ABP_VehicleStore_C_OverrideMouseClicked_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_VehicleStore.BP_VehicleStore_C.BndEvt__Sphere_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
		
		ABP_VehicleStore_C_BndEvt__Sphere_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature_Params params {};
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_VehicleStore.BP_VehicleStore_C.BndEvt__Sphere_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature"));
		
		ABP_VehicleStore_C_BndEvt__Sphere_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature_Params params {};
		params.OverlappedComponent = OverlappedComponent;
		params.OtherActor = OtherActor;
		params.OtherComp = OtherComp;
		params.OtherBodyIndex = OtherBodyIndex;
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_VehicleStore.BP_VehicleStore_C.ExecuteUbergraph_BP_VehicleStore"));
		
		ABP_VehicleStore_C_ExecuteUbergraph_BP_VehicleStore_Params params {};
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_VehicleStore.BP_VehicleStore_C"));
		return ptr;
	}
