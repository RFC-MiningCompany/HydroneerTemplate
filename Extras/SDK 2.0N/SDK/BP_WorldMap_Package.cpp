...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_WorldMap.BP_WorldMap_C.OverridePickedup"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_WorldMap.BP_WorldMap_C.OverrideDroppedItem"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function BP_WorldMap.BP_WorldMap_C.ExecuteUbergraph_BP_WorldMap"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_WorldMap.BP_WorldMap_C"));
		return ptr;
	}
