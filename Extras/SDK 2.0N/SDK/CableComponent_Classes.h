...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_O333[0x3];                                   // 0x04C1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_K39Y[0x1C];                                  // 0x04E4(0x001C) MISSED OFFSET (PADDING)
