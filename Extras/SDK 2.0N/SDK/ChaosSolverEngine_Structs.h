...
namespace CG
{
	...
	{
		Chaos_PointImplicit                              = 0x0000000000000000,
		Chaos_DelaunayTriangulation                      = 0x0000000000000001,
		Chaos_MinimalSpanningSubsetDelaunayTriangulation = 0x0000000000000002,
		Chaos_PointImplicitAugmentedWithMinimalDelaunay  = 0x0000000000000003,
		Chaos_None                                       = 0x0000000000000004,
		Chaos_EClsuterCreationParameters_Max             = 0x0000000000000005,
	...
	{
	public:
		unsigned char                                              UnknownData_05Z9[0x8];                                   // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_CBNR[0x40];                                  // 0x0000(0x0040) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_U0MQ[0x4];                                   // 0x006C(0x0004) MISSED OFFSET (PADDING)
	};
