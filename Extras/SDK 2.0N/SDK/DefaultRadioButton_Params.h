...
namespace CG
{
	 ...
	 */
	struct UDefaultRadioButton_C_GetTextColor_Params
	{
	public:
	 ...
	 */
	struct UDefaultRadioButton_C_BndEvt__MainButton_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature_Params
	{	};

	/**
	 * Function DefaultRadioButton.DefaultRadioButton_C.ExecuteUbergraph_DefaultRadioButton
	 */
	struct UDefaultRadioButton_C_ExecuteUbergraph_DefaultRadioButton_Params
	{
	public:
	 ...
	 */
	struct UDefaultRadioButton_C_Clicked__DelegateSignature_Params
	{
	public:
