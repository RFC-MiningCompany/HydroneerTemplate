...
namespace CG
{
	...
	{
		SortNone           = 0x0000000000000000,
		SortByHighestMass  = 0x0000000000000001,
		SortByHighestSpeed = 0x0000000000000002,
		SortByNearestFirst = 0x0000000000000003,
	...
	enum class EChaosCollisionSortMethod : uint8_t
	{
		...
		SortByHighestMass    = 0x0000000000000001,
		SortByHighestSpeed   = 0x0000000000000002,
		SortByHighestImpulse = 0x0000000000000003,
		SortByNearestFirst   = 0x0000000000000004,
	...
	{
		HideNone            = 0x0000000000000000,
		HideWithCollision   = 0x0000000000000001,
		HideSelected        = 0x0000000000000002,
		HideWholeCollection = 0x0000000000000003,
		HideAll             = 0x0000000000000004,
		MAX                 = 0x0000000000000005
	};
	...
	{
		Chaos_Traansform = 0x0000000000000000,
		Chaos_Max        = 0x0000000000000001
	};
	...
	{
		Chaos_Active         = 0x0000000000000000,
		Chaos_DynamicState   = 0x0000000000000001,
		Chaos_CollisionGroup = 0x0000000000000002,
		Chaos_Max            = 0x0000000000000003
	};
	...
	public:
		...
		unsigned char                                              UnknownData_M0EC[0x3];                                   // 0x0015(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_8OXU[0x3];                                   // 0x0015(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_R156[0x3];                                   // 0x0015(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_45MQ[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PGG7[0x2];                                   // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_B9RW[0x3];                                   // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_XBPD[0x2];                                   // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_9O83[0x3];                                   // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_J5BU[0x2];                                   // 0x003E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_U8ZH[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_2BQK[0x18];                                  // 0x0000(0x0018) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_7OQZ[0x1];                                   // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_EW6L[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_G8QP[0x8];                                   // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_59AX[0x2];                                   // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_2RSS[0x14];                                  // 0x0044(0x0014) MISSED OFFSET (PADDING)
	};
