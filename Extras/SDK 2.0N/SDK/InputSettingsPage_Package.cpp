...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function InputSettingsPage.InputSettingsPage_C.Construct"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function InputSettingsPage.InputSettingsPage_C.BndEvt__PresetSelector_K2Node_ComponentBoundEvent_0_RadioSelectedSignature__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function InputSettingsPage.InputSettingsPage_C.ExecuteUbergraph_InputSettingsPage"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass InputSettingsPage.InputSettingsPage_C"));
		return ptr;
	}
