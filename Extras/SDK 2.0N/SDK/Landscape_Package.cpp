...
namespace CG
{
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Landscape.LandscapeLODStreamingProxy"));
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class Landscape.MaterialExpressionLandscapePhysicalMaterialOutput"));
		return ptr;
	}
