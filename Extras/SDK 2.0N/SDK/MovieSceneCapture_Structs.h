...
namespace CG
{
	...
	{
		HCGM_Rec709  = 0x0000000000000000,
		HCGM_P3DCI   = 0x0000000000000001,
		HCGM_Rec2020 = 0x0000000000000002,
		HCGM_ACES    = 0x0000000000000003,
		HCGM_ACEScg  = 0x0000000000000004,
		HCGM_Linear  = 0x0000000000000005,
		HCGM_MAX     = 0x0000000000000006
	};
	...
	enum class EMovieSceneCaptureProtocolState : uint8_t
	{
		...
		Capturing   = 0x0000000000000002,
		Finalizing  = 0x0000000000000003,
	...
	public:
		...
		unsigned char                                              UnknownData_EUHR[0x2];                                   // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_A4FD[0x3];                                   // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_RCAG[0x3];                                   // 0x004D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3ZJK[0x4];                                   // 0x006C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_GA85[0x10];                                  // 0x0000(0x0010) MISSED OFFSET (PADDING)
	};
