...
namespace CG
{
	...
	{
		SimpleAndComplex = 0x0000000000000000,
	...
	{
		LimitedSlip_4W         = 0x0000000000000000,
		LimitedSlip_FrontDrive = 0x0000000000000001,
		LimitedSlip_RearDrive  = 0x0000000000000002,
		Open_4W                = 0x0000000000000003,
		Open_FrontDrive        = 0x0000000000000004,
		Open_RearDrive         = 0x0000000000000005,
	...
	public:
		...
		unsigned char                                              UnknownData_PDWY[0x3];                                   // 0x001D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_4ER9[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_DUD7[0x4];                                   // 0x009C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_OSGA[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_NMMU[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_R9PO[0x4];                                   // 0x002C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_KDF8[0x18];                                  // 0x00C8(0x0018) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_8QK5[0x10];                                  // 0x0760(0x0010) MISSED OFFSET (PADDING)
	};
