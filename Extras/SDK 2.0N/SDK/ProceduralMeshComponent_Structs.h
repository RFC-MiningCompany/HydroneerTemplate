...
namespace CG
{
	...
	{
		NoCap                  = 0x0000000000000000,
		CreateNewSectionForCap = 0x0000000000000001,
		UseLastSectionForCap   = 0x0000000000000002,
	...
	public:
		...
		unsigned char                                              UnknownData_GC9V[0x3];                                   // 0x000D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_XATO[0x2];                                   // 0x003E(0x0002) MISSED OFFSET (PADDING)
	};
