...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_KPET[0x18];                                  // 0x0030(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_JSZS[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_8NHP[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_4W7H[0x4];                                   // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_W960[0x1E0];                                 // 0x0138(0x01E0) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnCallback;                                              // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_38UZ[0x30];                                  // 0x0048(0x0030) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_PJ92[0xE0];                                  // 0x00B8(0x00E0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_SQBM[0xA0];                                  // 0x0098(0x00A0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_SHDY[0x20];                                  // 0x0058(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_3YDM[0xC0];                                  // 0x00A8(0x00C0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_ZHAL[0x120];                                 // 0x00D8(0x0120) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_2PE4[0xE8];                                  // 0x0058(0x00E8) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnCallback;                                              // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_3YN7[0x90];                                  // 0x0048(0x0090) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnSuccess;                                               // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		class FScriptMulticastDelegate                             OnFailure;                                               // 0x0048(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_5N6X[0x20];                                  // 0x0058(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnCallback;                                              // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_KI9Z[0xE0];                                  // 0x0048(0x00E0) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_4EZC[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_FYF2[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_5XT2[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_M0C6[0xC0];                                  // 0x00A8(0x00C0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_3K8P[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_EXMO[0x80];                                  // 0x0088(0x0080) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_PJ5K[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_CBHG[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_M7JV[0x160];                                 // 0x00F8(0x0160) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_Z12O[0xA0];                                  // 0x0098(0x00A0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_GVBA[0xA0];                                  // 0x0098(0x00A0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_9O3J[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
