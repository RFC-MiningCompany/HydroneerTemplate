...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function StyledKeyLabelBold.StyledKeyLabelBold_C.GetIconBrush"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function StyledKeyLabelBold.StyledKeyLabelBold_C.GetDisplayNameUpper"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function StyledKeyLabelBold.StyledKeyLabelBold_C.UpdateKeyLabel"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function StyledKeyLabelBold.StyledKeyLabelBold_C.ExecuteUbergraph_StyledKeyLabelBold"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass StyledKeyLabelBold.StyledKeyLabelBold_C"));
		return ptr;
	}
