...
namespace CG
{
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TimeManagement.GenlockedCustomTimeStep"));
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class TimeManagement.GenlockedTimecodeProvider"));
		return ptr;
	}
