...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_Embargo.UI_Embargo_C.BndEvt__UI_Embargo_Exit_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_Embargo.UI_Embargo_C.BndEvt__UI_Embargo_Agree_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_Embargo.UI_Embargo_C.ExecuteUbergraph_UI_Embargo"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass UI_Embargo.UI_Embargo_C"));
		return ptr;
	}
