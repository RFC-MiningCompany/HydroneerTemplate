...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_StylePanel.UI_StylePanel_C.UpdateSelection"));
		
		UUI_StylePanel_C_UpdateSelection_Params params {};
