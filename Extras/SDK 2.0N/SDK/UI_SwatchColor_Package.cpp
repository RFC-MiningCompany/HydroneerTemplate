...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_SwatchColor.UI_SwatchColor_C.UpdateSelection"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_SwatchColor.UI_SwatchColor_C.OnSelect"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_SwatchColor.UI_SwatchColor_C.BndEvt__UI_ColorSwatch_Button_Swatch_K2Node_ComponentBoundEvent_1_OnButtonPressedEvent__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_SwatchColor.UI_SwatchColor_C.BndEvt__UI_ColorSwatch_Button_Swatch_K2Node_ComponentBoundEvent_0_OnButtonHoverEvent__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_SwatchColor.UI_SwatchColor_C.BndEvt__UI_SwatchColor_Button_Swatch_K2Node_ComponentBoundEvent_2_OnButtonHoverEvent__DelegateSignature"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_SwatchColor.UI_SwatchColor_C.PreConstruct"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_SwatchColor.UI_SwatchColor_C.ExecuteUbergraph_UI_SwatchColor"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_SwatchColor.UI_SwatchColor_C.OnSelected__DelegateSignature"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass UI_SwatchColor.UI_SwatchColor_C"));
		return ptr;
	}
