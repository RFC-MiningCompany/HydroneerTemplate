...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_WorldMap.UI_WorldMap_C.UpdateSelection"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_WorldMap.UI_WorldMap_C.Loop"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_WorldMap.UI_WorldMap_C.Activate"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_WorldMap.UI_WorldMap_C.Deactivate"));
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function UI_WorldMap.UI_WorldMap_C.ExecuteUbergraph_UI_WorldMap"));
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass UI_WorldMap.UI_WorldMap_C"));
		return ptr;
	}
