...
namespace CG
{
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class UMG.MovieScene2DTransformPropertySystem"));
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class UMG.UMGSequenceTickManager"));
		return ptr;
	}
