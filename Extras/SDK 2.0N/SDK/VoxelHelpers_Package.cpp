...
namespace CG
{
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class VoxelHelpers.MaterialExpressionBlendMaterialAttributesBarycentric"));
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class VoxelHelpers.MaterialExpressionPack"));
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class VoxelHelpers.MaterialExpressionUnpack"));
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class VoxelHelpers.VoxelColorWheel"));
		return ptr;
	}
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>(_xor_("Function VoxelHelpers.VoxelHelpersLibrary.CreateProcMeshPlane"));
		
		UVoxelHelpersLibrary_CreateProcMeshPlane_Params params {};
		params.Mesh = Mesh;
		params.SizeX = SizeX;
		params.SizeY = SizeY;
		params.Step = Step;
	...
	{
		static UClass* ptr = UObject::FindClass(_xor_("Class VoxelHelpers.VoxelHelpersLibrary"));
		return ptr;
	}
