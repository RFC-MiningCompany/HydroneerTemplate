...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BPFL_Item.BPFL_Item_C.SetHighlight
	 */
	struct UBPFL_Item_C_SetHighlight_Params
	{
	public:
	...
	/**
	 * Function BPFL_Item.BPFL_Item_C.ForceStopHighlight
	 */
	struct UBPFL_Item_C_ForceStopHighlight_Params
	{
	public:
		class ABP_GameController_C*                                Controller;                                              // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		class AActor*                                              Target;                                                  // 0x0008(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	/**
	 * Function BPFL_Item.BPFL_Item_C.ToggleHighlightSpecific
	 */
	struct UBPFL_Item_C_ToggleHighlightSpecific_Params
	{
	public:
		bool                                                       Highlight_;                                              // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		int32_t                                                    StencilValue;                                            // 0x0004(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	/**
	 * Function BPFL_Item.BPFL_Item_C.ToggleHighlightPlayer
	 */
	struct UBPFL_Item_C_ToggleHighlightPlayer_Params
	{
	public:
		bool                                                       Highlight_;                                              // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		class ABP_GameController_C*                                Controller;                                              // 0x0008(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
