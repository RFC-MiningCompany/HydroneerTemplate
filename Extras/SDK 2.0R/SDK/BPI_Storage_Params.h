...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BPI_Storage.BPI_Storage_C.StoredItemPickedUp
	 */
	struct UBPI_Storage_C_StoredItemPickedUp_Params
	{
	public:
	...
	/**
	 * Function BPI_Storage.BPI_Storage_C.ItemStored
	 */
	struct UBPI_Storage_C_ItemStored_Params
	{
	public:
