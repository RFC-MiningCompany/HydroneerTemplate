...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_GameInstance.BP_GameInstance_C.RemoveSessionID
	 */
	struct UBP_GameInstance_C_RemoveSessionID_Params
	{
	public:
	...
	/**
	 * Function BP_GameInstance.BP_GameInstance_C.AddSessionID
	 */
	struct UBP_GameInstance_C_AddSessionID_Params
	{
	public:
		...
		bool                                                       Remote_;                                                 // 0x0004(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	};
	...
	/**
	 * Function BP_GameInstance.BP_GameInstance_C.SetDLSSMode
	 */
	struct UBP_GameInstance_C_SetDLSSMode_Params
	{
	public:
