...
namespace CG
{
	...
	/**
	 * Function BP_GameState.BP_GameState_C.GetPlayerLocations
	 */
	struct ABP_GameState_C_GetPlayerLocations_Params
	{	};

	/**
	 * Function BP_GameState.BP_GameState_C.TrackPlayerMap
	 */
	struct ABP_GameState_C_TrackPlayerMap_Params
	{	};

	/**
	 * Function BP_GameState.BP_GameState_C.InitTrackPlayerMap
	 */
	struct ABP_GameState_C_InitTrackPlayerMap_Params
	{	};
	...
	{
	public:
		E_Stocks                                                   Stock;                                                   // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
