...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_HookValve.BP_HookValve_C.HookFunctionality
	 */
	struct ABP_HookValve_C_HookFunctionality_Params
	{
	public:
	...
	/**
	 * Function BP_HookValve.BP_HookValve_C.LMBDownIsTarget
	 */
	struct ABP_HookValve_C_LMBDownIsTarget_Params
	{
	public:
	...
	/**
	 * Function BP_HookValve.BP_HookValve_C.ActorLoaded
	 */
	struct ABP_HookValve_C_ActorLoaded_Params
	{	};

	/**
	 * Function BP_HookValve.BP_HookValve_C.ExecuteUbergraph_BP_HookValve
	 */
	struct ABP_HookValve_C_ExecuteUbergraph_BP_HookValve_Params
	{
	public:
