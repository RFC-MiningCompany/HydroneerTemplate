...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_LogicSmelter.BP_LogicSmelter_C.ComponentsToSave
	 */
	struct ABP_LogicSmelter_C_ComponentsToSave_Params
	{
	public:
	...
	{
	public:
		E_MetalType                                                InputPin;                                                // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	...
	public:
		...
		E_MetalType                                                Type;                                                    // 0x0008(0x0001)  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
