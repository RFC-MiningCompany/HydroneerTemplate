...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_ParentConveyor.BP_ParentConveyor_C.FindBeltSpeed
	 */
	struct ABP_ParentConveyor_C_FindBeltSpeed_Params
	{
	public:
		...
		struct FVector                                             DeltaLocationToAdd;                                      // 0x0008(0x000C)  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};

	/**
	 * Function BP_ParentConveyor.BP_ParentConveyor_C.CanMoveItem?
	 */
	struct ABP_ParentConveyor_C_CanMoveItem__Params
	{
	public:
		class AActor*                                              Actor;                                                   // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		TArray<class ABP_ParentItem_C*>                            CurrentlyMovingItems;                                    // 0x0008(0x0010)  (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
		bool                                                       CanMove_;                                                // 0x0018(0x0001)  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
		class ABP_ParentResource_C*                                ResourceRef;                                             // 0x0020(0x0008)  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	...
	/**
	 * Function BP_ParentConveyor.BP_ParentConveyor_C.OverrideHookCheckRot
	 */
	struct ABP_ParentConveyor_C_OverrideHookCheckRot_Params
	{	};
