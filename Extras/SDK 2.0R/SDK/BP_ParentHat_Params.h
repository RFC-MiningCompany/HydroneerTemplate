...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_ParentHat.BP_ParentHat_C.CreateProxyHat
	 */
	struct ABP_ParentHat_C_CreateProxyHat_Params
	{	};

	/**
	 * Function BP_ParentHat.BP_ParentHat_C.ToggleProxyHat
	 */
	struct ABP_ParentHat_C_ToggleProxyHat_Params
	{
	public:
	...
	/**
	 * Function BP_ParentHat.BP_ParentHat_C.ReceiveDestroyed
	 */
	struct ABP_ParentHat_C_ReceiveDestroyed_Params
	{	};
