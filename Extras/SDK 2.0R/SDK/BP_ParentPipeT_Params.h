...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_ParentPipeT.BP_ParentPipeT_C.OverrideWaterIn
	 */
	struct ABP_ParentPipeT_C_OverrideWaterIn_Params
	{
	public:
	...
	/**
	 * Function BP_ParentPipeT.BP_ParentPipeT_C.ExecuteUbergraph_BP_ParentPipeT
	 */
	struct ABP_ParentPipeT_C_ExecuteUbergraph_BP_ParentPipeT_Params
	{
	public:
