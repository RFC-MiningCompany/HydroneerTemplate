...
namespace CG
{
	...
	/**
	 * Function BP_Rod.BP_Rod_C.SetUpRod
	 */
	struct ABP_Rod_C_SetUpRod_Params
	{	};
	...
	/**
	 * Function BP_Rod.BP_Rod_C.ActorLoaded
	 */
	struct ABP_Rod_C_ActorLoaded_Params
	{	};

	/**
	 * Function BP_Rod.BP_Rod_C.StartCasting
	 */
	struct ABP_Rod_C_StartCasting_Params
	{
	public:
		class ABP_GameController_C*                                Controller;                                              // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
