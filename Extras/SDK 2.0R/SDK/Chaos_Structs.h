...
namespace CG
{
	...
	{
		PointImplicit                              = 0x0000000000000000,
		DelaunayTriangulation                      = 0x0000000000000001,
		MinimalSpanningSubsetDelaunayTriangulation = 0x0000000000000002,
		PointImplicitAugmentedWithMinimalDelaunay  = 0x0000000000000003,
	...
	{
		Field_RadialIntMask       = 0x0000000000000000,
		Field_RadialFalloff       = 0x0000000000000001,
		Field_UniformVector       = 0x0000000000000002,
		Field_RadialVector        = 0x0000000000000003,
		Field_RadialVectorFalloff = 0x0000000000000004,
		Field_Max                 = 0x0000000000000005,
		Field_MAX                 = 0x0000000000000006
	};
	...
	{
		Field_None                  = 0x0000000000000000,
		Field_DynamicState          = 0x0000000000000001,
		Field_LinearForce           = 0x0000000000000002,
		Field_ExternalClusterStrain = 0x0000000000000003,
		Field_Kill                  = 0x0000000000000004,
		Field_LinearVelocity        = 0x0000000000000005,
		Field_AngularVelociy        = 0x0000000000000006,
		Field_AngularTorque         = 0x0000000000000007,
		Field_InternalClusterStrain = 0x0000000000000008,
		Field_DisableThreshold      = 0x0000000000000009,
		Field_SleepingThreshold     = 0x000000000000000A,
		Field_PositionStatic        = 0x000000000000000B,
		Field_PositionAnimated      = 0x000000000000000C,
		Field_PositionTarget        = 0x000000000000000D,
		Field_DynamicConstraint     = 0x000000000000000E,
		Field_CollisionGroup        = 0x000000000000000F,
		Field_ActivateDisabled      = 0x0000000000000010,
		Field_PhysicsType_Max       = 0x0000000000000011
	};
	...
	{
		Field_FallOff_None        = 0x0000000000000000,
		Field_Falloff_Linear      = 0x0000000000000001,
		Field_Falloff_Inverse     = 0x0000000000000002,
		Field_Falloff_Squared     = 0x0000000000000003,
		Field_Falloff_Logarithmic = 0x0000000000000004,
		Field_Falloff_Max         = 0x0000000000000005
	};
	...
	{
		Field_Resolution_Minimal         = 0x0000000000000000,
		Field_Resolution_DisabledParents = 0x0000000000000001,
		Field_Resolution_Maximum         = 0x0000000000000002,
		Field_Resolution_Max             = 0x0000000000000003
	};
	...
	{
		Field_Culling_Inside        = 0x0000000000000000,
		Field_Culling_Outside       = 0x0000000000000001,
		Field_Culling_Operation_Max = 0x0000000000000002,
		Field_Culling_MAX           = 0x0000000000000003
	};
	...
	{
		Field_Multiply      = 0x0000000000000000,
		Field_Divide        = 0x0000000000000001,
		Field_Add           = 0x0000000000000002,
		Field_Substract     = 0x0000000000000003,
		Field_Operation_Max = 0x0000000000000004
	};
	...
	{
		Field_Set_Always           = 0x0000000000000000,
		Field_Set_IFF_NOT_Interior = 0x0000000000000001,
		Field_Set_IFF_NOT_Exterior = 0x0000000000000002,
		Field_MaskCondition_Max    = 0x0000000000000003
	};
	...
	{
		Chaos_Emission_Pattern_First_Frame = 0x0000000000000000,
		Chaos_Emission_Pattern_On_Demand   = 0x0000000000000001,
		Chaos_Max                          = 0x0000000000000002
	};
	...
	{
		Chaos_Initial_Velocity_User_Defined = 0x0000000000000000,
		Chaos_Initial_Velocity_None         = 0x0000000000000001,
		Chaos_Max                           = 0x0000000000000002
	};
	...
	{
		Chaos_AngularVelocity        = 0x0000000000000000,
		Chaos_DynamicState           = 0x0000000000000001,
		Chaos_LinearVelocity         = 0x0000000000000002,
		Chaos_InitialAngularVelocity = 0x0000000000000003,
		Chaos_InitialLinearVelocity  = 0x0000000000000004,
		Chaos_CollisionGroup         = 0x0000000000000005,
		Chaos_LinearForce            = 0x0000000000000006,
		Chaos_AngularTorque          = 0x0000000000000007,
		Chaos_Max                    = 0x0000000000000008
	};
	...
	{
		Chaos_NONE               = 0x0000000000000000,
		Chaos_Object_Sleeping    = 0x0000000000000001,
		Chaos_Object_Kinematic   = 0x0000000000000002,
		Chaos_Object_Static      = 0x0000000000000003,
		Chaos_Object_Dynamic     = 0x0000000000000004,
		Chaos_Object_UserDefined = 0x0000000000000005,
		Chaos_Max                = 0x0000000000000006
	};
	...
	{
		Chaos_Implicit_Box      = 0x0000000000000000,
		Chaos_Implicit_Sphere   = 0x0000000000000001,
		Chaos_Implicit_Capsule  = 0x0000000000000002,
		Chaos_Implicit_LevelSet = 0x0000000000000003,
		Chaos_Implicit_None     = 0x0000000000000004,
		Chaos_Max               = 0x0000000000000005
	};
	...
	{
		Chaos_Volumetric         = 0x0000000000000000,
		Chaos_Surface_Volumetric = 0x0000000000000001,
		Chaos_Max                = 0x0000000000000002
	};
	...
	{
		DedicatedThread = 0x0000000000000000,
		TaskGraph       = 0x0000000000000001,
		SingleThread    = 0x0000000000000002,
	...
	enum class EChaosSolverTickMode : uint8_t
	{
		...
		Variable                 = 0x0000000000000001,
		VariableCapped           = 0x0000000000000002,
		VariableCappedWithTarget = 0x0000000000000003,
		MAX                      = 0x0000000000000004
	};
	...
	enum class EGeometryCollectionCacheType : uint8_t
	{
		...
		Play          = 0x0000000000000002,
		RecordAndPlay = 0x0000000000000003,
		MAX           = 0x0000000000000004
	};
	...
	public:
		...
		unsigned char                                              UnknownData_9L7L[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		bool                                                       FilterEnabled;                                           // 0x0000(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_LXYC[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		float                                                      MinMass;                                                 // 0x0004(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		float                                                      MinSpeed;                                                // 0x0008(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
	...
	public:
		bool                                                       FilterEnabled;                                           // 0x0000(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_AO3P[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		float                                                      MinMass;                                                 // 0x0004(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		float                                                      MinSpeed;                                                // 0x0008(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		float                                                      MinVolume;                                               // 0x000C(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
	};
	...
	public:
		...
		unsigned char                                              UnknownData_P4UD[0x2];                                   // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_4SIK[0x3];                                   // 0x003D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_FBU9[0x3];                                   // 0x0051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_S7K1[0x3];                                   // 0x0065(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_WMQM[0x4];                                   // 0x00B4(0x0004) MISSED OFFSET (PADDING)
	};
