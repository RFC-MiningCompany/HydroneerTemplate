...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_9H5Q[0x90];                                  // 0x0000(0x0090) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_YSJQ[0x68];                                  // 0x0000(0x0068) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_UPGX[0x30];                                  // 0x0000(0x0030) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_KIE7[0x38];                                  // 0x0000(0x0038) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_0GLM[0x28];                                  // 0x0000(0x0028) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_7IUI[0x80];                                  // 0x0000(0x0080) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_36I9[0x20];                                  // 0x0000(0x0020) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_STV6[0x50];                                  // 0x0000(0x0050) MISSED OFFSET (PADDING)
	};
