...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function GM_Hydroneer.GM_Hydroneer_C.CanAddPlayer?
	 */
	struct AGM_Hydroneer_C_CanAddPlayer__Params
	{
	public:
	...
	/**
	 * Function GM_Hydroneer.GM_Hydroneer_C.RemoveLocalPlayer
	 */
	struct AGM_Hydroneer_C_RemoveLocalPlayer_Params
	{	};

	/**
	 * Function GM_Hydroneer.GM_Hydroneer_C.AddLocalPlayer
	 */
	struct AGM_Hydroneer_C_AddLocalPlayer_Params
	{	};

	/**
	 * Function GM_Hydroneer.GM_Hydroneer_C.AddRemotePlayer
	 */
	struct AGM_Hydroneer_C_AddRemotePlayer_Params
	{
	public:
	...
	public:
		struct FSteamRemotePlaySessionConnected                    Data;                                                    // 0x0000(0x0004)  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor)
		bool                                                       isRemote;                                                // 0x0004(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		class ABP_GameController_C*                                PlayerController;                                        // 0x0008(0x0008)  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	};
	...
	/**
	 * Function GM_Hydroneer.GM_Hydroneer_C.OnPlayerRemoved__DelegateSignature
	 */
	struct AGM_Hydroneer_C_OnPlayerRemoved__DelegateSignature_Params
	{	};

	/**
	 * Function GM_Hydroneer.GM_Hydroneer_C.OnPlayerAdded__DelegateSignature
	 */
	struct AGM_Hydroneer_C_OnPlayerAdded__DelegateSignature_Params
	{	};
