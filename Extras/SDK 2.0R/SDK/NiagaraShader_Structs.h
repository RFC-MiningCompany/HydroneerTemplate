...
namespace CG
{
	...
	{
		FNiagaraCompileEventSeverity__Log                              = 0x0000000000000000,
		FNiagaraCompileEventSeverity__Warning                          = 0x0000000000000001,
		FNiagaraCompileEventSeverity__Error                            = 0x0000000000000002,
		FNiagaraCompileEventSeverity__FNiagaraCompileEventSeverity_MAX = 0x0000000000000003
	};
	...
	public:
		...
		unsigned char                                              UnknownData_8API[0x7];                                   // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_93RQ[0x28];                                  // 0x0000(0x0028) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_D89C[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
