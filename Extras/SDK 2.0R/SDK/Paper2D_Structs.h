...
namespace CG
{
	...
	{
		NoCollision         = 0x0000000000000000,
		FirstFrameCollision = 0x0000000000000001,
		EachFrameCollision  = 0x0000000000000002,
	...
	{
		DilateBorder = 0x0000000000000000,
		PadWithZero  = 0x0000000000000001,
	...
	{
		Orthogonal         = 0x0000000000000000,
		IsometricDiamond   = 0x0000000000000001,
		IsometricStaggered = 0x0000000000000002,
		HexagonalStaggered = 0x0000000000000003,
	...
	{
		Top_Left      = 0x0000000000000000,
		Top_Center    = 0x0000000000000001,
		Top_Right     = 0x0000000000000002,
		Center_Left   = 0x0000000000000003,
		Center_Center = 0x0000000000000004,
		Center_Right  = 0x0000000000000005,
		Bottom_Left   = 0x0000000000000006,
		Bottom_Center = 0x0000000000000007,
		Bottom_Right  = 0x0000000000000008,
	...
	{
		SourceBoundingBox = 0x0000000000000000,
		TightBoundingBox  = 0x0000000000000001,
		ShrinkWrapped     = 0x0000000000000002,
		FullyCustom       = 0x0000000000000003,
		Diced             = 0x0000000000000004,
	...
	enum class ESpriteCollisionMode : uint8_t
	{
		...
		Use2DPhysics = 0x0000000000000001,
		Use3DPhysics = 0x0000000000000002,
		MAX          = 0x0000000000000003
	};
	...
	public:
		...
		unsigned char                                              UnknownData_PEG2[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_23XA[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_IA8Y[0x3];                                   // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_J5U3[0x4];                                   // 0x0034(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_WFN6[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_6QV7[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_A6AP[0x3];                                   // 0x002D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_T5WQ[0x3];                                   // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_L8LU[0x3];                                   // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SLK7[0x4];                                   // 0x002C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_N08D[0x4];                                   // 0x003C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_CH6U[0x4];                                   // 0x0014(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_KSA7[0x4];                                   // 0x003C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_AWCO[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_BXQZ[0x30];                                  // 0x0018(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_929X[0x84];                                  // 0x004C(0x0084) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_NLFI[0x40];                                  // 0x0000(0x0040) MISSED OFFSET (PADDING)
	};
