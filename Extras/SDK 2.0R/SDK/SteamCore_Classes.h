...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_OGY0[0x18];                                  // 0x0030(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_W511[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_02BU[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_9PFJ[0x4];                                   // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_ITUN[0x1E0];                                 // 0x0138(0x01E0) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnCallback;                                              // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_SH3E[0x30];                                  // 0x0048(0x0030) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_0T6L[0xE0];                                  // 0x00B8(0x00E0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_TRTK[0xA0];                                  // 0x0098(0x00A0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_6XYH[0x20];                                  // 0x0058(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_6623[0xC0];                                  // 0x00A8(0x00C0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_694T[0x120];                                 // 0x00D8(0x0120) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_7SW2[0xE8];                                  // 0x0058(0x00E8) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnCallback;                                              // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_SCWV[0x90];                                  // 0x0048(0x0090) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnSuccess;                                               // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		class FScriptMulticastDelegate                             OnFailure;                                               // 0x0048(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_FDA2[0x20];                                  // 0x0058(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnCallback;                                              // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_I3X2[0xE0];                                  // 0x0048(0x00E0) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_A8N0[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_VG3M[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_4U1N[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_7OHK[0xC0];                                  // 0x00A8(0x00C0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_IBQ3[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_3DZ4[0x80];                                  // 0x0088(0x0080) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_J3EZ[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_FT15[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_RFI0[0x160];                                 // 0x00F8(0x0160) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_5MNN[0xA0];                                  // 0x0098(0x00A0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_YSW1[0xA0];                                  // 0x0098(0x00A0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_R6QK[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
