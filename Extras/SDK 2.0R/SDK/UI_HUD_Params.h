...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function UI_HUD.UI_HUD_C.SetShowPlayerName
	 */
	struct UUI_HUD_C_SetShowPlayerName_Params
	{	};
	...
	{
	public:
		TArray<E_Badges>                                           Badges;                                                  // 0x0000(0x0010)  (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	...
	public:
		...
		TArray<E_Badges>                                           Badges;                                                  // 0x0030(0x0010)  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	};
	...
	{
	public:
		E_Crosshairs                                               Type;                                                    // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
