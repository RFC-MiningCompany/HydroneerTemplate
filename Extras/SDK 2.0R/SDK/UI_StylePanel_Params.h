...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function UI_StylePanel.UI_StylePanel_C.UpdateSelection
	 */
	struct UUI_StylePanel_C_UpdateSelection_Params
	{
	public:
		class UObject*                                             SelectedWidget;                                          // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	...
	public:
		...
		int32_t                                                    SelectedOptionIndex;                                     // 0x0010(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
