...
namespace CG
{
	...
	{
		NotAccessible = 0x0000000000000000,
		Auto          = 0x0000000000000001,
		Summary       = 0x0000000000000002,
		Custom        = 0x0000000000000003,
		ToolTip       = 0x0000000000000004,
	...
	enum class ESlateVisibility : uint8_t
	{
		...
		Collapsed            = 0x0000000000000001,
		Hidden               = 0x0000000000000002,
		HitTestInvisible     = 0x0000000000000003,
		SelfHitTestInvisible = 0x0000000000000004,
		MAX                  = 0x0000000000000005
	};
	...
	enum class EVirtualKeyboardType : uint8_t
	{
		...
		Web          = 0x0000000000000002,
		Email        = 0x0000000000000003,
		Password     = 0x0000000000000004,
		AlphaNumeric = 0x0000000000000005,
	...
	enum class EDragPivot : uint8_t
	{
		...
		TopCenter    = 0x0000000000000002,
		TopRight     = 0x0000000000000003,
		CenterLeft   = 0x0000000000000004,
		CenterCenter = 0x0000000000000005,
		CenterRight  = 0x0000000000000006,
		BottomLeft   = 0x0000000000000007,
		BottomCenter = 0x0000000000000008,
		BottomRight  = 0x0000000000000009,
	...
	enum class EDynamicBoxType : uint8_t
	{
		...
		VerticalWrap = 0x0000000000000003,
		Radial       = 0x0000000000000004,
		Overlay      = 0x0000000000000005,
		MAX          = 0x0000000000000006
	};
	...
	enum class EWidgetDesignFlags : uint8_t
	{
		...
		Designing           = 0x0000000000000001,
		ShowOutline         = 0x0000000000000002,
		ExecutePreConstruct = 0x0000000000000003,
	...
	{
		Visible              = 0x0000000000000000,
		SelfHitTestInvisible = 0x0000000000000001,
		MAX                  = 0x0000000000000002
	};
	...
	enum class EWidgetBlendMode : uint8_t
	{
		...
		Transparent = 0x0000000000000002,
		MAX         = 0x0000000000000003
	};
	...
	enum class EWidgetInteractionSource : uint8_t
	{
		...
		CenterScreen = 0x0000000000000002,
		Custom       = 0x0000000000000003,
		MAX          = 0x0000000000000004
	};
	...
	public:
		...
		unsigned char                                              UnknownData_2WZ8[0x3];                                   // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_0Q2B[0x4];                                   // 0x0024(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_GJYD[0x3];                                   // 0x0005(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_QKXM[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_YE7J[0x60];                                  // 0x0020(0x0060) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_HQBM[0x3];                                   // 0x0021(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_460O[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_M1ED[0x7];                                   // 0x0049(0x0007) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_FEQ2[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_MA29[0xB8];                                  // 0x0000(0x00B8) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_4VPV[0x30];                                  // 0x0000(0x0030) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_DQWP[0x7];                                   // 0x02B9(0x0007) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_VBBW[0x10];                                  // 0x00B8(0x0010) MISSED OFFSET (PADDING)
	};
