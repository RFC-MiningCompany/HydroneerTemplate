...
namespace CG
{
	...
	enum class EPropertyValueCategory : uint8_t
	{
		...
		Generic          = 0x0000000000000001,
		RelativeLocation = 0x0000000000000002,
		RelativeRotation = 0x0000000000000003,
		RelativeScale3D  = 0x0000000000000004,
		Visibility       = 0x0000000000000005,
		Material         = 0x0000000000000006,
		Color            = 0x0000000000000007,
		Option           = 0x0000000000000008,
	...
	public:
		...
		unsigned char                                              UnknownData_RIU2[0x4];                                   // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_LRWR[0x7];                                   // 0x0051(0x0007) MISSED OFFSET (PADDING)
	};
