...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_BuildCottageDoorway.BP_BuildCottageDoorway_C.LMBDownIsTarget
	 */
	struct ABP_BuildCottageDoorway_C_LMBDownIsTarget_Params
	{
	public:
	...
	/**
	 * Function BP_BuildCottageDoorway.BP_BuildCottageDoorway_C.ExecuteUbergraph_BP_BuildCottageDoorway
	 */
	struct ABP_BuildCottageDoorway_C_ExecuteUbergraph_BP_BuildCottageDoorway_Params
	{
	public:
