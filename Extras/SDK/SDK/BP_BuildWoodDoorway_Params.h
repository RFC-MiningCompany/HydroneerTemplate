...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_BuildWoodDoorway.BP_BuildWoodDoorway_C.LMBDownIsTarget
	 */
	struct ABP_BuildWoodDoorway_C_LMBDownIsTarget_Params
	{
	public:
	...
	/**
	 * Function BP_BuildWoodDoorway.BP_BuildWoodDoorway_C.ExecuteUbergraph_BP_BuildWoodDoorway
	 */
	struct ABP_BuildWoodDoorway_C_ExecuteUbergraph_BP_BuildWoodDoorway_Params
	{
	public:
