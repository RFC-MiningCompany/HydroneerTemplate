...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BP_ConstructionHammer.BP_ConstructionHammer_C.LMBDownWhileCarrying");
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_ConstructionHammer.BP_ConstructionHammer_C");
		return ptr;
	}
