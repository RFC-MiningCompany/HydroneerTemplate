...
namespace CG
{
	 ...
	 * Size -> 0x0080 (FullSize[0x0468] - InheritedSize[0x03E8])
	 */
	...
	public:
		...
		struct FVector                                             SplitDelta;                                              // 0x0450(0x000C) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		struct FVector                                             StraightDelta;                                           // 0x045C(0x000C) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
