...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_ZV9R[0x3];                                   // 0x057D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_LJZB[0x7];                                   // 0x0591(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_FS4T[0x7];                                   // 0x05B1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PMNX[0x4];                                   // 0x05D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_P11D[0x3];                                   // 0x0659(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_2904[0x4];                                   // 0x066C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_91K1[0x7];                                   // 0x0679(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NOMR[0xC];                                   // 0x06A4(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_DQZD[0x8];                                   // 0x0738(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_47KW[0x6];                                   // 0x07EA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		bool                                                       HardHatMode_;                                            // 0x0801(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
	...
	public:
		...
		void InpActEvt_Rotate_K2Node_InputActionEvent_14(const struct FKey& Key);
		void InpActEvt_Rotate2_K2Node_InputActionEvent_13(const struct FKey& Key);
		void InpActEvt_Pickup_K2Node_InputActionEvent_12(const struct FKey& Key);
		void InpActEvt_Pickup_K2Node_InputActionEvent_11(const struct FKey& Key);
		void InpActEvt_VehicleKey_K2Node_InputActionEvent_10(const struct FKey& Key);
		void InpActEvt_Rotate3_K2Node_InputActionEvent_9(const struct FKey& Key);
		void InpActEvt_Wiki_K2Node_InputActionEvent_8(const struct FKey& Key);
		void InpActEvt_RMB_K2Node_InputActionEvent_7(const struct FKey& Key);
		void InpActEvt_RMB_K2Node_InputActionEvent_6(const struct FKey& Key);
		void OnCompleted_9EE0ABC14602C7545F03D1AF77EC46FC();
		void InpActEvt_LMB_K2Node_InputActionEvent_5(const struct FKey& Key);
		void InpActEvt_LMB_K2Node_InputActionEvent_4(const struct FKey& Key);
		void InpActEvt_AnyKey_K2Node_InputKeyEvent_1(const struct FKey& Key);
		void InpActEvt_EscMenu_K2Node_InputActionEvent_3(const struct FKey& Key);
		void InpActEvt_RotationMod_K2Node_InputActionEvent_2(const struct FKey& Key);
		void InpActEvt_RotationMod_K2Node_InputActionEvent_1(const struct FKey& Key);
