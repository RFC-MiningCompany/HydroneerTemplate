...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BP_ParentHookIntakeBooster.BP_ParentHookIntakeBooster_C.HookFunctionality");
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_ParentHookIntakeBooster.BP_ParentHookIntakeBooster_C");
		return ptr;
	}
