...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function BP_ParentPickaxe.BP_ParentPickaxe_C.Animate
	 */
	struct ABP_ParentPickaxe_C_Animate_Params
	{
	};

	/**
	 * Function BP_ParentPickaxe.BP_ParentPickaxe_C.LMBDownWhileCarrying
	 */
	struct ABP_ParentPickaxe_C_LMBDownWhileCarrying_Params
	{
	public:
	...
	/**
	 * Function BP_ParentPickaxe.BP_ParentPickaxe_C.ExecuteUbergraph_BP_ParentPickaxe
	 */
	struct ABP_ParentPickaxe_C_ExecuteUbergraph_BP_ParentPickaxe_Params
	{
	public:
