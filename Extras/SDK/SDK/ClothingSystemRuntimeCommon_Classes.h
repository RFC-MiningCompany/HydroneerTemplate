...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_U78V[0x4];                                   // 0x010C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_62OW[0x4];                                   // 0x01EC(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_K8GD[0x20];                                  // 0x0168(0x0020) MISSED OFFSET (PADDING)
