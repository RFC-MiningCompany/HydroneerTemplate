...
static TAutoConsoleVariable<bool> CVarNGXDLSSAdjustMipBiasOffsetEnable(
	TEXT("r.NGX.DLSS.AdjustMipBiasOffset.Enable"),
	1,
	TEXT("Allow DLSS to globally override the automatic view mip bias's offset (r.ViewTextureMipBias.Offset)"),
	ECVF_ReadOnly);
